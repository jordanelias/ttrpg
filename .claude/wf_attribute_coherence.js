...
const FAMILIES = [
  ...
  { key: 'GODOT', model: 'haiku', title: 'Godot port + typed export', focus: `godot/skeleton/engines/combat/resources/{combat_config.gd,weapon_resource.gd} (every exported field + its cited canon), any .tres files naming stats, references/engine_params/combat_engine_v1.json (the typed export — every key), tools/export_engine_params.py (what it covers and does NOT cover). Flag every value that exists in the port but has no prose head, and vice versa.` },

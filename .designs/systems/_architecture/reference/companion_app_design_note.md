...
> Original path: `systems/_architecture/reference/companion_app_design_note.md`
...
- Piety Track + Composure + Concentration tracking during social contests
...
4. Social contest tracker (Piety Track + strain + Composure/Concentration)

...
> Original path: `systems/_architecture/reference/complete_systems_reference.md`
...
**Arcs:** A (Reformer: Truth → 0-1, Löwenritter Autonomy = Loyal, publicly acknowledges Thread), B (Fortress: Stability ≤ 2, Truth ≥ 3, Order doubles down), C (Overthrown: Löwenritter Autonomy = Autonomous, exile). <!-- per ED-781 Graduated Autonomy track -->
...
**Unvalidated:** Accord+Political Stability+battle compound (ED-538). CI reform+TCV+Seizure Accord compound (ED-539). Accord-aware AI vs Hafenmark collapse. Dynastic Proclamation. <!-- Cultural Reformation removed CR-STRIKE-2026-04-19 -->

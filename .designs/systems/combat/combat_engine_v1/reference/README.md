...
> Original path: `systems/combat/combat_engine_v1/reference/README.md`
...
Godot port: shaped into the module architecture at godot/skeleton/engines/combat/ + references/module_contracts.yaml

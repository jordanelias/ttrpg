...
> Original path: `systems/combat/combat_engine_v1/reference/phase4_5_plan_v1.md`
...
armour/use-mode re-baseline (filed as ED-1080, status pending — see `designs/audit/2026-06-30-combat-grounding/`)
followed an equivalent adversarial-grounding discipline ad hoc via 4 independent grounding workflows (see the

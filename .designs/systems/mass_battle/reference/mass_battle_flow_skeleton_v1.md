...
> Original path: `systems/mass_battle/reference/mass_battle_flow_skeleton_v1.md`
...
|---|---|---|---|
| up | `engine/mc_v18.py` (campaign driver) | `run_campaign` → `run_season(action_callback=_faction_actions_callback)` | `engine/mc_v18.py:239 run_campaign`, `:267 run_season` |

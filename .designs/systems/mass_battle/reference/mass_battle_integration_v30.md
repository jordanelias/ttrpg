...
> Original path: `systems/mass_battle/reference/mass_battle_integration_v30.md`
...
- `systems/combat/reference/combat_reference_v1.md` §9 (Mass Combat TTRPG-scale)
- `systems/combat/reference/combat_reference_v1.md` §11 (Faction Unit Rosters)

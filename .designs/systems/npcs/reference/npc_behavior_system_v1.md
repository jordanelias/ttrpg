...
> Original path: `systems/npcs/reference/npc_behavior_system_v1.md`
...
| Attribute | Value | Notes |
|---|---|---|
| Primary Conviction | Precedent | Constitutional procedure IS justice. What has been established governs what comes next. (ED-531 resolved: Precedent approved. Supersedes stage6 "Order" — stage6 is stale compilation. Distinguishes Baralta from Almud.) |
...
| Attribute | Value | Notes |
|---|---|---|
| Primary Conviction | Blank (contested) | Starts with no primary Conviction. First faction to achieve Loyalty ≥ 5 sets his Conviction to match that faction leader's primary Conviction. If no faction reaches Loyalty 5 by Year-End of Year 2, Torben defaults to Autonomy (survival instinct from a life of being traded as political asset). (ED-525 resolved) |
...
|---|---|---|
| ED-515 | Confirm Conviction taxonomy: 7 values (Faith, Order, Reason, Equity, Precedent, Autonomy, Continuity). Sufficient? | P2 |
...
| canon/editorial_ledger.yaml | ED-515 through ED-530 |

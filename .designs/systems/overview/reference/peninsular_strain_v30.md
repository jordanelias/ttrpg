...
> Original path: `systems/overview/reference/peninsular_strain_v30.md`
...
|-----------|---------|------------|
| Post-Calamity Era | MS = 0 at Accounting | Substrate tears. Faction acquisition suspended 3 seasons. Mending doubled. Recovery: MS to 20 within 10 seasons. **Leading warning:** the MS≤12 approach to this tip carries a diegetic early-warning trend (ms_trajectory_v1 §5.1, PST-1) — Post-Calamity does not fire without prior signal. |

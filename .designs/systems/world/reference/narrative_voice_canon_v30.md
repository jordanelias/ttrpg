...
> Original path: `systems/world/reference/narrative_voice_canon_v30.md`
...
## §1 — Omniscient Chronicle Voice

*Extracted verbatim from `designs/articulation/articulation_layer_v30.md` §4.2 (2026-06-09).*
...
*The following voice canon is extracted verbatim from the prose-writer skill (`skills/prose-writer/SKILL.md`), 2026-06-09. The skill now references this home and retains only the writing procedure (weighting, focalization, splicing, synthesis).*

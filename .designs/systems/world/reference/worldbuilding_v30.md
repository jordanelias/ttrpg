...
> Original path: `systems/world/reference/worldbuilding_v30.md`
...
**Card: Ehrenwall Split** *(formerly Card: Ehrenwall Coup — renamed post-Session-B to reflect Löwenritter graduated autonomy replacing the binary Coup Counter; fires when Autonomy track reaches Split stage, not on a single count-threshold trigger. See systems/_architecture/reference/conflict_architecture_proposal.md.)*

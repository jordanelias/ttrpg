...
- [ ] **Green locally:** `python tools/valoria_local.py --staged` and `python -m pytest tests/valoria -q -n auto` pass. (`-n auto` is what CI runs — same tests, parallel. Run the full suite ONCE, at the close: `CLAUDE.md` §0.4.)

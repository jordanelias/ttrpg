# Propagation Map Archive — Batch 2026-05-01 (a)
# Moved from references/propagation_map.md to maintain size limits.
# Older entries; cross-references in active map updated when needed.

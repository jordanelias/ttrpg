...
**Primary mechanics:** Excommunication unique action (§8.3) · Baralta Church Influence suppression condition (Mandate ≥ 5) · Church Influence +4 on Baralta excommunication · Church territorial seizure at Church Influence 60 · Martyr effect (failure = Church Mandate −1, target +1) · Grand Debate reversal (5 exchanges)
...
An Overwhelming Church victory is one of the most structurally significant single events in the game. It removes Baralta's Church Influence suppression, immediately spikes Church Influence by 4, triggers the seizure procedure at whatever Church Influence currently sits plus 4, and begins stripping Hafenmark's political capacity at the moment when the players most need it. The Church does not have to do anything else that season. The accounting machinery does it for them.
...
Baralta's Mandate was at 7. It drops to 6. Church Influence suppression threshold is Mandate ≥ 5 — still active, but damaged. The Reputation −1 fires across all factions. Players who had been working through Baralta lose one degree of social access to every Non-Player Character she intermediated.
...
Standard Excommunication success: Mandate −1 (from 7 to 6), Church-loyal command barred, Circles with Church contacts lost. Church Influence +4 immediate. Baralta's Mandate 6 is still above 5 — suppression technically active, but barely. One more Mandate hit removes it.

The Church Influence +4 is the structural damage. If Church Influence was at 35 entering this season, it is now at 39. If it was at 40, it is at 44. If it was at 50, it is now at 54 — six points from triggering the territorial seizure cascade. The seizure procedure requires Church Mandate vs territory owner Mandate ÷ 2 each season. With Church Mandate at 5 and territory owners averaging Mandate 4–5, the Church is winning most of these rolls. Major territories seized: Church Influence +3 each. Capital or institutional sites: Church Influence +5.

Valorsplatz (Territory 1, Prosperity 6, Church Influence +5 on seizure) becomes a realistic Church target within two seasons.

### Branch C — Church Fails the Excommunication Roll

Failure: Church Mandate −1 (from 5 to 4). Baralta gains Mandate +1 (sympathy martyr) — she is now at Mandate 8, capped at 7 in the 1–7 stat system. Church Influence suppression is now rock solid. The attempt exposed Olafsson's overreach.

Baralta holds circumstantial evidence of the Olafsson-Niflhel connection. The failed excommunication is the political opening she needed to act on it. Domain Action: Mandate 7 + Reach 5 + player evidence bonus vs Church Stability Ob 3. If it succeeds: Church Stability −2, Church Influence −3, Olafsson's Inquisitor operations suspended. The campaign's political geometry has inverted. The Church is defending.
...
**Why this arc is emergent:** The Excommunication roll is a 5-die pool versus Ob 7. The outcome probabilities are genuinely variable — all three branches are mechanically plausible. Baralta's Church Influence suppression, the martyr mechanic, and the seizure cascade are all designed-in consequences. No player engineered the divergence.

**Arc shape:** 2-season file-building. 1 session roll. Immediate Church Influence/Mandate consequences. Branch A/B: 2–4 season seizure cascade or Grand Debate recovery. Branch C: 1–2 season Baralta counter-offensive, possible Church collapse event.
...
**Primary mechanics:** Ceiral Ritual (§6.5) · Degree table (Overwhelming/Success/Partial/Failure) · Thread Tension/Mending Stability consequences · Mode 3 monstrous entity on Failure · Lead practitioner incapacitation · Southernmost territory development (Overwhelming only) · Expedition prerequisite cascade
...
Maret Uln is Incapacitated. The Ceiral Ritual cannot be re-attempted by Maret — he is the lead practitioner who failed; the rule is that a new lead is required. Vaynard has lost his most valuable Thread asset on the most consequential roll of the campaign. The Mode 3 entity requires resolution: Dissolution (Ob 4+, risks second Gap, acute Mending Stability damage), Pulling to weaken then conventional combat, communication (possible — threadcut beings may have comprehensible goals), or outlasting its De-Actualisation if it is accumulating Rendering Strain.

Thread Tension +8 means the Mending Stability tracker has moved significantly. If Mending Stability was already Fragile (59–40), it may now enter Fractured (39–20): Gaps open spontaneously, 1d10 per season on 1–2 in the lowest-Prosperity territory. Sudwald (Territory 12) has a Thread Wound that fires threshold events 10 Thread Tension points earlier than elsewhere — it is already generating pressure. Thread Tension +8 into a Fractured world means two independent spontaneous Gap sources active simultaneously next season.
...
| Ceiral Ritual fails (Thread Tension +8) in the same season as Parliamentary Tie (Church Influence +1, Mending Stability −1) | 22 + 18 | Mending Stability −9 total this season (Thread Tension +8 + Mending Stability −1 from tie) — may cross from Fragile directly to Critical | EXTREME: Mending Stability Critical in one season; all Thread operations now +1 Ob worldwide; spontaneous Gaps double; faction Stability checks at Ob 1 minimum fire for every faction |
| Ehrenwall killed in the same season Torben surrendered (Branch A) with Loyalty clock at 3 | 23 + 20 | Coup Counter extinguished by her death, but Torben at Loyalty 3 has already triggered Mandate −2 on Crown; Ehrenwall's institutional check on Church is gone; Church moves into the vacuum her death created | EXTREME: Crown at Mandate 3 (−2 from Torben), Löwenritter without direction, Church at Church Influence 50+ — full dominance arc now has no mechanical resistance except Baralta alone |
| Excommunication Overwhelming (Branch A) fires in the same season as Ceiral Ritual Overwhelming (Branch B) | 21 + 22 | Church Influence +4 from Baralta excommunication + Church Influence +3 from Vaynard TK 5 advance post-Ritual = Church Influence +7 in one season; simultaneously Mending Stability stabilises permanently and Axis 9 resolves | EXTREME: The season the world is saved is the season the Church achieves peak institutional power; the Ritual's success is politically catastrophic; Valoria has a healed substrate and a theocratic government |

---

*All arcs compliant with arc generator protocol. No Niflhel Thread harvesting. Seasonal cap (±2 per stat) applied throughout — Church Influence +4 from Excommunication is an immediate one-time consequence (unique action), not a seasonal stat change, and is therefore not subject to the cap.*

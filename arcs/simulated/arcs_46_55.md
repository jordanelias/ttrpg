...
**Mechanical seed:** Wound penalty (+0.15 Ob per wound, cumulative) propagates from TTRPG personal combat to faction Domain Action rolls via faction leader's personal pool [SUPERSEDED FRAMING, ED-PC-0005/ED-PC-0006, 2026-07-08: the original −1D-per-wound pool cut (PP-716, now struck) is replaced by a fractional Ob added to the roll, never a pool cut — value reuses ED-1041's combat "attacking" magnitude, the active-roller case]

**Systems in play:** Wound penalty +0.15 Ob per wound, cumulative (ED-PC-0005/ED-PC-0006; supersedes PP-232/PP-716's −1D) · Domain Action pool formula (NPC factions: relevant stat as d10 pool, TN 7) · Failed Domain Action Stability cost (PP-403)

---

### Narrative

Vaynard leads Varfell. He participates in TTRPG scenes and in Season 4 took two wounds in a physical confrontation. Recovery was not prioritised. At seasonal accounting, Vaynard's Domain Action pool for Varfell runs on his stat line — two wounds means +0.30 Ob on the roll. The harder roll fails. Varfell takes −1 Stability.
...
Vaynard takes 2 wounds in TTRPG scene combat (Season 4)
    ...
    └─ Seasonal Accounting: Varfell Domain Action (Vaynard leading)
        ...
        Assuming propagation confirmed:
            │
            ▼
        Pool = Military stat, Ob +0.30 (wound penalty, ED-PC-0005/ED-PC-0006; supersedes PP-232's −2D framing)
            │

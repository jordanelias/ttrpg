...
**Nodes:** 46 (27 module · 19 quantity)  ·  **Edges:** 135 (8 notional)
**Edge types:** emits_consumes=90, derives=15, produces=15, reads=15
...
## Highest change-impact nodes (by total degree — a change here ripples furthest)
- **npc_behavior** (module) — downstream 6 · upstream 31
- **faction_state** (module) — downstream 3 · upstream 28
- **settlement_layer** (module) — downstream 13 · upstream 14
...
- npc_behavior --emits_consumes[Key::da.antinomian_action]--> domain_actions (module)
...
- npc_behavior --emits_consumes[Key::scene.dialogue]--> scene_slate (module)
...
- **Pure sinks** (consumed by nothing — candidate terminal outputs or dead ends): 11
  Garrison Strength, Health, Local Economy, Public Order, audit, faction Mandate (cross-module → faction_state), faction Treasury income (cross-module → faction_state), npc_memory, province Accord, scene_timer, settlement_economy

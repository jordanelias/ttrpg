...
| FA-2 | **ED-FA-0002 domain_actions home** (M1 workplan next-action) | ledger "RATIFIED 2026-07-05" (PR #81); rescoped by ED-FA-0006 | flip `domain_actions` off `doc:null`; add per-verb `da.*` tag column; rule 3 bucket forks | **NOT DONE** | `references/module_contracts.yaml:593` no tag column; `HANDOFF_FA.md:95` "ED-FA-0002 (open)" |

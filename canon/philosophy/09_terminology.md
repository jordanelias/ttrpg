...
| **Rendering** | The always-already occurring interpretation of things *as* something. Not an activity undertaken and not a configuring: **spooling configures, rendering takes-as**, and being taken-as is a determination on the intelligibility axis. **Positional**: what is given to a being follows from how it is imbricated, and acting alters imbrication. Has an active stratum (takes-as as world) and a passive stratum (registers without composing an object). |
...
| **Coherence** | The structural integrity of layer-two self-rendering. Everyone has it; practitioners are distinguished by spending it. Two facings: reflexive (self-positing as a worldly human) and outward (apprehended by others — itself a disposition plus an occurrent holding). Tridimensional by construction. Orthogonal to Thread Sensitivity. |
| **Drift** | Progressive decoupling of a configuration from the equilibrium proper to being human, indexed by Coherence, manifesting across all three moments. Past a threshold of irreversibility the human equilibrium is no longer where the configuration tends: the being *became other*. **Amoral in the strict sense**: being moral requires being human, so drift departs from the register in which moral predicates apply rather than failing within it. Not evil, no corruption, no fall — though catastrophic for the drifting being and for those knotted to them, who lose a moral interlocutor. It radically is as it is. Past the threshold the being retains preferences and attachments, held from a post-human sensibility alien to its prior self and not boundable by human language. |

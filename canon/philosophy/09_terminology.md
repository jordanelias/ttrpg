...
| **Drift** | Progressive decoupling of a configuration from the equilibrium proper to being human, indexed by Coherence, manifesting across all three moments. Past a threshold of irreversibility the human equilibrium is no longer where the configuration tends: the being *became other*. **Amoral in the strict sense**: being moral requires being human, so drift departs from the register in which moral predicates apply rather than failing within it. Not evil, no corruption, no fall — though catastrophic for the drifting being and for those knotted to them, who lose a moral interlocutor. It radically is as it is. |

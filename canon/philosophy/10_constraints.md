...
| **P-04** | **Monstrosity is ontological, not moral.** Monstrous beings exceed what the rendering can hold; they are not villains. The ground of this is that **being moral requires being human** (§7.1) — a non-human being is outside the moral register, not exempted within it. | §5.1, §5.2, §7.1 | Does any rule assign moral valence to a monstrous entity as such? → FAIL. Does any rule treat a non-human being as *failing* a moral standard, rather than as outside the register? → FAIL |
...
| **P-11** | **Temporal Disjunction is universal across operations.** Every operation produces some. | §2.7 | Does any operation produce zero temporal consequence? → FAIL *(Ruled 2026-09-07, D-6: layer-two self-rendering is **not** an operation, and there is no baseline in ordinary life. Scope: a restorative operation restarts a becoming rather than pulling anything out of one, so on §2.7's own definition it produces none — the universality claim holds of manipulative and destructive operations.)* |

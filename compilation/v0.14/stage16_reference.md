...
- Leap: Attunement + relevant History bonus + Thread Pool Score (Thread Pool Score = Thread Sensitivity ÷ 10, round down)
- Weaving: Spirit + relevant History bonus + Thread Pool Score
- Pulling: Spirit + relevant History bonus + Thread Pool Score
- Past-Oriented Pulling: Spirit + relevant History bonus (no Thread Pool Score)
- FR (Locking/Snapping): Spirit + relevant History bonus (no Thread Pool Score)

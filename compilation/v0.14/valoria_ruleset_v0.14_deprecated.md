...
GMs: read all parts before Session Zero. Keep Part Fourteen (Game Master Tools) and the Game Sheet at hand during play.
...
|------|------------|------------|-----------|-----------|
| 8D (Thread Sensitivity 30) | 53% | 35% | 15% | 9% |
| 12D (Thread Sensitivity 50) | 73% | 58% | 27% | 18% |
| 15D (Thread Sensitivity 70) | 84% | 70% | 32% | 18% |
...
| 0 | Rendering Crisis | Reality as commonly rendered is no longer accessible. Character becomes Non-Player Character unless resolved narratively. |
...
- Certain Einhir techniques (Game Master discretion, late-campaign): +1–2 Coherence
...
A character with Thread Sensitivity 30+ may undertake Approach Training as a downtime arc: one full campaign season devoted to learning how to initiate and sustain contact. During this season the character is unavailable for Domain Actions and military service but may participate in scenes.
...
**TN:** 7
**Ob:** Thread Sensitivity 30–49 = 2 · Thread Sensitivity 50+ = 1 · −1D per Wound

Pre-calculate the Leap pool on the character sheet as a named entry separate from History pools.

| Degree | Outcome |
|---|---|
| Overwhelming | Clean contact. Next Operation's Ob reduced by 1 (minimum 1). Practitioner gains 1 Thread Sensitivity. |
...
**Overwhelming cascade:** The Ob reduction applies only to the immediately following operation. If the operation is already at Ob 1, the reduction has no further mechanical effect but the Thread Sensitivity gain still fires. This cascade is exclusive to Thread operations.

### The First Leap (Event Scene)

The first time a character attempts the Leap, it is run as a full event scene rather than a standard roll. The Game Master describes the approach and the perceptual limit phenomenologically. On success: Thread Sensitivity score is revealed to the player; Practitioner designation granted. On failure: **Dissociation** — the character is present in the world and can participate in scenes for one season, but cannot attempt Thread operations and their Thread Sensitivity is frozen. They may attempt again next season.
...
**Concealing from Thread Sensitivity 30+ observers:** Roll Cognition only (no History), TN 7, Ob = observer's Thread Sensitivity ÷ 30 (round up). Success: reads as ambient Thread background. Failure: observer identifies the practitioner as source and operation type.

**Combat Endurance note:** An active Thread operation performed *on* an observer counts as +2 Combat Endurance — the most intense form of exposure.
...
Spend one contact round sensing a target's thread configuration. **No roll** — this is a structured Game Master exchange.
...
The practitioner states what they are sensing. The Game Master describes:
...
**Requirements:** Thread Sensitivity 30+ · Approach Training tag
...
A practitioner below the required Thread Sensitivity cannot attempt that scale — they cannot individuate those configurations as distinct threads.

| Degree | Outcome |
|---|---|
| Overwhelming | Full effect. Thread Tension −1 (Relational scale or above only). Practitioner gains 1 Thread Sensitivity. The effect exceeds the stated goal — a wound closes without scarring; a bound agreement develops genuine trust beyond its terms. |
| Success | Full effect. Thread Tension unchanged. |
| Partial | Partial effect (Game Master sets scope). Thread Tension +1. ThS −1. |
| Failure | Weave collapses. Thread Tension +2. ThS −1. At Thread Tension ≥ 60: Shifting Object forms. At Thread Tension ≥ 80: Gap opens. |
...
**Temporal Weaving (Thread Sensitivity 50+):** When healing, the practitioner may foreground the temporal dimension — accelerating the wound's natural healing rather than altering its configuration. The healed state is more stable and persistent than natural healing would produce.

**Overweaving:** Each Weaving after the first in the same scene: +1 Ob (cumulative). A collapsed overweaved configuration: Thread Tension +3 and a local Shifting Object may form. For Overweaving purposes, "same scene" means the same dramatic unit — from scene establishment to conclusion. A Register Shift does not reset the Overweaving counter.
...
**Requirements:** Thread Sensitivity 30+
**Pool:** Spirit + relevant History bonus
**TN:** 7

Pre-calculate the Pulling pool on the character sheet.

**Ob by actualization level (Thread Sensitivity minimum required):**
...
**Natural expiry:** When a Pull's duration expires, the thread re-actualises without consequence — no Thread Tension change, no Wound, no notification. The effect simply ends.

**Uncontrolled snap-back** (from Failure or contact loss during Pull): 1 Wound (armour does not apply) + Thread Tension +2.

| Degree | Outcome |
|---|---|
| Overwhelming | Full effect. Extended duration. Thread Tension unchanged. |
| Success | Full effect. Standard duration. Thread Tension unchanged. |
| Partial | Partial effect or reduced duration. Thread Tension +1. ThS −1. |
| Failure | Snap-back. 1 Wound (no armour). Thread Tension +2. ThS −1. |
...
**Requirements:** Thread Sensitivity 70+ · Thread Tension ≥ 40 · Diagnosis mandatory
**Pool:** Spirit + relevant History bonus
**TN:** 7
...
**Thread Tension:** +3 minimum regardless of degree.
**ThS:** Automatic +3 additional (on top of any other ThS costs).

**Co-Movement:** Past-Oriented Pulling produces secondary consequences in *both* remaining dimensions. The Game Master determines consequences for the actual and epistemic dimensions — not just one.
...
**Requirements:** Thread Sensitivity 50+ · Diagnosis immediately preceding (mandatory)
**Pool:** Spirit + relevant History bonus
**TN:** 7
...
**Ob by scale (Thread Sensitivity 50+ required for all FR):**
...
**Thread Sensitivity 70+ Tier Reduction:** Sensitive and Resonant practitioners reduce all FR Thread Tension costs by 1 (minimum 1). This does not apply to ThS costs.

### Lock Results

| Degree | Outcome |
|---|---|
| Overwhelming | Target permanently locked. Thread Tension +2. Practitioner gains 1 Thread Sensitivity. |
| Success | Target locked. Thread Tension +2. |
| Partial | Partial lock (Game Master sets scope). Thread Tension +3. ThS −2. |
| Failure | Collapse onto practitioner. Take 2 Wounds (armour does not apply). Thread Tension +4. ThS −2. |

### Dissolution Results

| Degree | Outcome |
|---|---|
| Overwhelming | Target dissolves cleanly. Thread Tension +3. Micro-Gap forms and closes within the scene. |
| Success | Target dissolves. Thread Tension +5. Gap forms, lasts one scene, closes. |
| Partial | Target becomes a Shifting Object. Thread Tension +6. Gap does not close without Weaving. ThS −2. |
| Failure | Full Gap tears open. Thread Tension +8. Monstrous Incursion occurs immediately. Practitioner is Incapacitated. ThS −2. |
...
- Partial results on any Thread operation produce involuntary micro-Gaps (Thread Tension +1 each)
...
Every Thread operation produces consequences across all three dimensions simultaneously. This is not optional — it is the inseparability principle expressed mechanically. The Game Master does not choose whether co-movement fires; it fires on every operation, every time.
...
|---|---|
| Weaving (any degree) | ThS −1. The target's temporal axis compresses — the present contains a healed or stabilised version earlier than natural. Observers with Thread Sensitivity 10+ perceive the target as "clearer" or "more vivid" for 1 scene. |
...
|---|---|
| Weaving (Success/Overwhelming) | Target becomes MORE intelligible — partially clarified. Observers with Thread Sensitivity 10+ perceive the target as clearer for 1 scene. Non-sensitives may notice something but cannot articulate it. |
...
The Game Master rolls d6 on every operation. This is the one random element in the co-movement system.
...
| 5 | Environmental texture shifts (temperature, light, sound — detectable by Thread Sensitivity 10+) |
| 6 | Delayed manifestation (1d3 scenes later) |

### History Resonance (R37)

When a Thread operation's temporal co-movement fires, the Game Master checks whether the practitioner has a History relevant to the operation's context. If yes: the History **resonates**.
...
When a practitioner uses a Flashback (Inspiration spend to declare a retroactive scene), their Thread sensitivity means the retroactive declaration partially actualises the past scene. If the Flashback involves Thread-relevant content — locations with Thread history, people with Thread Sensitivity 30+, Originary Locks, dissolution residue — the Game Master may rule: **ThS −1**.

This cost applies **only to practitioners**, not to non-practitioner Flashbacks. It is Game Master discretion, not automatic — mundane Flashbacks are unaffected.
...
| Practitioner Flashback anchoring | +1 (Game Master discretion; Thread-relevant content only) |
...
| 15–11 | Fragmented | Configuration unreliable. −1D to all Memory-based rolls. Game Master may present the character's recollection differently from what others remember. Roll Fragmented Fallout on entering this band. |
...
| Coherence | Effect |
|---|---|
| 7–9 | +1D to Thread operations. Other practitioners with Thread Sensitivity 50+ in the same scene sense the instability. Knot strain begins (+1 per 3 sessions per Knot). |
| 4–6 | +2D to Thread operations. −1D to social rolls. Rendering contingency increasingly perceptible. Distinctions between the intelligible and unintelligible soften. Game Master recontextualises one Knot to clinical "configuration" language. Knot strain pace increases to +1 per 2 sessions. |
...
| 0 | Monstrous configuration. Character becomes Non-Player Character under Game Master control. All Knots receive final pulse of rendering strain. |

### Belief Co-Authorship (Coherence 7+)

Game Master presents the transformed perspective as the character's internal voice. Player must rewrite each Belief to reflect this perspective. Game Master veto: rewrites that do not authentically reflect the transformation. Player veto: rewrites that eliminate all character intentionality.
...
Mode 1 dissolution (1 unit). Mode 2 dissolution (1d3 units). Entrenched Shifting Object edges (trace; Thread Sensitivity 30+ passive at touch distance). Niflhel Southernmost operations. Failed FR sites.

### Handling

Non-practitioners: Combat Endurance +1 per extended handling session. Practitioners: immediate passive perception of orientation (Thread Sensitivity 30+).

### Using Residue as Power Source

A practitioner may draw on dissolution residue to power a Thread operation. Add bonus dice equal to the residue's Potency rating (1–5, Game Master-determined) to the operation pool. These bonus dice explode on **9–10** rather than 10 only — the compressed potential is volatile.
...
Detection: Thread Sensitivity 30+ passive at arm's reach. Inquisitors with Combat Endurance 2+: feel wrongness near residue even without Thread Sensitivity.
...
**Investigating an Intentional Lock (Thread Sensitivity 50+, one full scene):** Diagnosis reveals the approximate Thread Sensitivity of the creating practitioner (±10), whether the Lock was placed under duress or calmly, and a rough sense of when it was made (within a decade). This is practitioner forensics.

**Resistance to Pulling:** Ob = creating practitioner's Thread Sensitivity ÷ 10 (round up). A Lock made by a Thread Sensitivity 62 practitioner resists at Ob 7.
...
**Trigger:** An object in a territory where multiple Thread operations have been performed, or where Thread Tension has been above 40 for 2+ seasons.
...
**Seasonal escalation:** Every season a Gap remains open: Thread Tension +4.
...
**Thread Tension consequences when a Gap opens:**

| Thread Tension at Time of Gap | Consequence |
|---|---|
...
- Weaving (Thread Sensitivity 60+, Ob 4): destroys entity AND partially closes Gap (Thread Tension −2).
...
**Anchor:** Highest Thread Sensitivity practitioner. Rolls their full operation pool.
...
A character with Thread Sensitivity 30+ who reads a primary Einhir text: **+5 Thread Sensitivity** (once per text). This also triggers Thread Tension +1 (dormant patterns activate in the area) and grants immediate Leap eligibility if Approach Training is already complete.
...
- Practitioner Flashback this scene? (Thread-relevant content → ThS −1, Game Master discretion)
...
**Thread phenomenon** (any zone): A practitioner must identify and navigate a live Thread configuration. Weaving or Pulling check; Ob by zone (Border 2, Inner 3, Core 4). On Partial or Failure: ThS −1 for lead practitioner; Thread Tension +1.
...
- **Partial**: Thread Tension −1 (partial reduction). Practitioner: ThS −1. May continue next season.
- **Failure**: No progress. Thread Tension +1 (disturbing the wound without completing the work). ThS −2 for practitioner.
...
**Thread Tension is public.** Displayed permanently on the table dashboard.

**Thread Tension rises from specific causes only.** Ordinary action — political manoeuvring, military operations without Thread involvement, social scenes — does not strain the substrate.

### Thread Tension Rise Sources

| Source | Thread Tension Change |
|---|---|
| Partial Weaving | +1 |
| Failed Weaving | +2 |
| Partial Pulling | +1 |
...
### Thread Tension Decrease Sources
...
### Thread Tension Thresholds

| Thread Tension | State | World Symptoms | Mechanical Effects |
|---|---|---|---|
...
### Thread Tension Threshold Events

When Thread Tension crosses a threshold, the Game Master determines a narratively appropriate consequence from the current situation. No event deck is used. The current political, social, and thread-level state of the world generates the threshold consequence organically.

*Example: Thread Tension crossing 40 (into Wakening) while the Church has an active Inquisitor investigation produces a different threshold event than Thread Tension 40 crossing during a period of factional cooperation. The threshold is the trigger; the event is the current world state colliding with that trigger.*

---

## 7.2 The Theocracy Clock (Theocracy Counter) — 0 to 100
...
| Thread Tension > 45 (Thread events read as divine warning requiring Church leadership) | +1/season |
| Thread Tension > 60 (Thread crisis provides theological justification for authority expansion) | +2/season (total, not additive to above) |
...
| Baralta's Mandate drops below 5 (primary secular Theocracy Counter brake removed) | +1/season |
| Institutional Pressure > 45 (Church offers Altonian theological mediation as Crown alternative) | +1/season |

### Theocracy Counter Decrease Sources
...
**Church Stability brake:** When Church Stability falls to 3 or below at seasonal accounting, Mandate-based Theocracy Counter generation ceases that season. Rendering Stability-driven cross-clock Theocracy Counter increase is not suppressed — substrate decay continues regardless of Church internal crisis. Cardinals competing publicly suppresses institutional momentum. (M-6, PP-158)

**Seasonal Theocracy Counter movement cap (PP-157):** Theocracy Counter may not move more than ±5 in a single season from all faction Domain Actions, Domain Echoes, and event-driven modifiers combined. Apply actions in resolution order (PP-005 sequencing); stop when cap is reached. Cross-clock passive drift (Rendering Stability-driven Theocracy Counter gain) is structural and applies after the cap.

### Theocracy Counter Thresholds

| Theocracy Counter | State | World Symptoms |
|---|---|---|
...
**Theocracy Counter 80 — Church Territorial Seizure:** At Theocracy Counter 80, the Church may attempt to seize territories through institutional claim rather than military force. Per-territory roll vs variable Ob. Counter-play options available. (See Faction section for full procedure.)

---

## 7.3 Altonian Pressure (Institutional Pressure) — 0 to 100

**Starting value:** 20 (Dormant).

**Institutional Pressure is public.** Displayed alongside Thread Tension and Theocracy Counter.

Institutional Pressure measures the threat of Altonian military and political intervention. Altonia is not a monolithic actor — three internal factions shape its policy toward Valoria and they are not in agreement. Players discover this through play.

### Institutional Pressure Thresholds

| Institutional Pressure Range | State | Effect |
|---|---|---|
...
| 45–59 | Hostile | Border skirmishes. Vassalage demands made through diplomatic channels. Tutoring Demand for Prince Torben triggers at Institutional Pressure 30+. |
...
The following specific events cause immediate Institutional Pressure changes outside the cross-clock linkage system:

| Trigger | Institutional Pressure Change |
|---|---|
...
*Note: A comprehensive standalone Institutional Pressure rise/fall table is not fully specified in current design documents. The linkage table below covers the primary Institutional Pressure drivers. Additional direct triggers should be developed as play reveals further cases. [GAP: Institutional Pressure direct rise/fall table incomplete — register for Phase 3 attention.]*

### Institutional Pressure Decrease Sources

Institutional Pressure decreases primarily through diplomatic and political actions that reduce Altonia's strategic incentive to intervene:

- Valoria presenting a **unified diplomatic front** (all major factions at cooperative disposition or better): Institutional Pressure passive drift halts for that season
- **Schoenland trade alliance** secured: −2 Institutional Pressure/year, and Altonian Merchant Consortium's political cover is removed
- **Grand Diplomatic Scene** victory (endgame; requires faction dominance + Church Mandate > 5 + Thread Tension < 50): Institutional Pressure frozen, peace treaty possible
...
| Condition | Effect |
|---|---|
| Thread Tension > 45 | Theocracy Counter +1/season; Institutional Pressure +1/season |
| Thread Tension > 60 | Theocracy Counter +2/season (total); Institutional Pressure +2/season (total) |
| Theocracy Counter > 40 and Institutional Pressure > 45 | Institutional Pressure +1/season (Church offers theological mediation; Almaic Kyriakos rejects but gives Merchant Consortium political cover) |
| Theocracy Counter > 60 | Institutional Pressure +2/season (Altonia interprets Church dominance as violating Secession Wars' religious exclusivity clauses) |
| Theocracy Counter > 60 and Institutional Pressure > 45 simultaneously | Institutional Pressure +2/season; Almaic Kyriakos begins formal documentation of Church expansion for the Altonian Emperor |
| Thread Tension > 60 and Theocracy Counter > 60 simultaneously | Both clocks accelerate at maximum rate |
| All three clocks above their midpoints simultaneously | Campaign enters endgame phase |
| Thread Tension > 45 and Theocracy Counter > 40 simultaneously | Theocracy Counter +1/season (compounding; both conditions must persist each season) |

**Note on (total) entries:** When Thread Tension > 60, the Theocracy Counter and Institutional Pressure costs are +2/season total — not +1 (from Thread Tension > 45) + 1 (from Thread Tension > 60) = +2. The higher threshold replaces, not adds to, the lower threshold's contribution.

### Structural Tension Summary

Thread Tension and Theocracy Counter are in positive feedback. Rising Thread Tension produces Thread events the Church interprets as theological warrant for expanded authority. Theocracy Counter pressure produces internal instability that allows Thread Tension to rise faster. Institutional Pressure is the external constraint — it accelerates when internal conditions are worst.

Players have access to the only tools that can directly address Thread Tension (thread operations reducing configurational stress) and the only investigative capacity that can address Theocracy Counter's hidden structural driver (the Church-Niflhel connection). They are structurally positioned as the campaign's repair mechanism.
...
|---|---|---|
| Thread Tension | +1 per 4 seasons (i.e., +1 per campaign year) | Always |
| Theocracy Counter | +1 per season | When Church Mandate ≥ 7 at accounting |
| Institutional Pressure | +1 per season | Baseline; Altonian Martial Senate monitoring |

Passive drift represents background pressure that players must actively counteract. A campaign in which players do nothing deteriorates: Thread Tension +1/year, Theocracy Counter +1/year (Church steady pressure), Institutional Pressure +1/year (Martial Senate baseline). The world deteriorates at a rate the players can observe but did not choose.
...
- Thread Tension and Theocracy Counter advance triggers fire at **seasonal accounting** (Phase 5), not continuously. Clocks do not advance mid-round. (R18, R19)
- **Theocracy Counter threshold override**: When Theocracy Counter threshold events would override a player's planned Domain Action, only player-chosen Domain Actions are deferred. Reactive checks (Stability checks, Non-Player Character responses) still fire immediately. (R19)
- All three clocks are player-visible at all times. No hidden tracking.
- Board tracks: Thread Tension on shared track, Theocracy Counter on shared track, Institutional Pressure on shared track. Threshold markers placed at 20/40/60/80/100.
...
**Non-Player Character personal pools** (used in social scenes and investigations) are separate from faction stats. Named NPCs use the canonical 10-attribute set. Faction stats represent institutional capacity; Non-Player Character attributes represent personal capability.
...
**Coup Threshold:** Grandmaster Ehrenwall is keeping count of Almud's compromises. When the Löwenritter's internal assessment of the Crown's institutional integrity drops to a threshold (tracked as a private Game Master counter), a coup trigger is possible. See NPCs section for full Ehrenwall mechanics.

**Coup Counter succession (PP-156):** On Ehrenwall's death, the Counter transfers to the most senior Löwenritter officer by institutional rank at its current value. The successor's personal pool is Coherence Rating 3 (not Ehrenwall's Coherence Rating 5). Exception: if the successor holds primary loyalty outside the Löwenritter (externally appointed, cross-faction allegiance, Altonian-affiliated), the Counter terminates — it does not transfer.
...
Player sets their own critical success range (up to 11–20); the critical failure range expands by the same amount. A result in neither zone: Partial, with a Game Master-assigned complication. Stunts are a player tool — the Game Master does not impose them.
...
- **Brutal** requires Cohesion 4+ (troops must be disciplined enough to commit atrocities on command). Brutal against a civilian population: automatic Theocracy Counter +1 if Church observes.
- **Flank manoeuvre** requires 2+ friendly units in the same engagement (one pins, one flanks).

### Unit Attachments (Optional Layer)

Attachments add one modifier per attachment without creating a sub-system. Game Master may omit this layer for minor engagements.
...
| Practitioner attached | +1D Cohesion near Thread events; may perform Thread ops during battle | Thread Sensitivity 30+ officer assigned |
...
**Contested Figures**: A named Non-Player Character rendered non-threatening through a personal action (Disarmed, Tripped) but not yet incapacitated becomes a Contested Figure. Both sides have a claim. Fate resolves as a scene after the mass combat round concludes.
...
Thread Tension multiplier for mass combat Thread operations: ×3 flat (replaces scale-based multiplier). Thread Tension gain from any single mass combat Thread operation is **capped at +15** regardless of calculation. Excess converts to narrative consequence (regional site destabilisation, Locked zone expansion) at Game Master discretion.
...
| Thread bombardment | Practitioner Weaving, Relational+ scale | Ob = Fortification level. Thread Tension +2 regardless. Success: garrison Cohesion −2. Overwhelming: Fortification −1. Failure: practitioner Thread Depth +3 |
...
Einhir site within the fortification: +1 additional Thread Tension per siege season.
...
- The character reveals something true — the player declares it, the Game Master confirms it is not already public.
...
Dispositions are qualitative relationship descriptors between two characters or between a character and an audience. They are **not modifiers** — they inform the Game Master's Ob-setting but do not add or subtract dice.
...
Dispositions shift through play outcomes. An Overwhelming social success causes the Game Master to name a one- or two-step improvement in the target's disposition toward the speaker.
...
Each named Non-Player Character has one resonant tag (Evidence, Character, or Consequence) that reflects their dominant mode of reasoning. Addressing that Non-Player Character using their resonant style earns +1D.
...
| Degree | Result |
|---|---|
| Overwhelming | Game Master describes opponent's emotional state, tells, and assessment confidence in detail. +1D on the first two formal Exchanges in the same scene. |
| Success | Game Master describes opponent's emotional state and one tell. +1D on the first formal Exchange in the same scene. |
| Partial | Game Master describes surface affect only (calm, nervous, defensive). No Exchange bonus. |
...
**Ob**: Set by the audience's resistance (use Disposition table in §9.2 as the primary guide; Game Master adjusts for situation).

| Degree | Result |
|---|---|
| Overwhelming | Audience persuaded; disposition improves one step; Game Master names one additional consequence in the speaker's favour |
...
Characters advance through two parallel systems: **Test Track** (automatic from play) and **Character Points (CP)** (awarded by the Game Master for Beliefs and domain-level achievements, spent on a structured menu). A third long-arc indicator, **Renown**, tracks cumulative dramatic achievement and unlocks narrative permissions without granting mechanical bonuses.
...
The Game Master awards CP at seasonal accounting and at significant scene conclusions. CP is awarded for Beliefs — never for session attendance or routine success.
...
Belief-revised awards (4–5 CP) require genuine revision — a character who held a Belief and was forced by events to change it in a way that costs them something. The Game Master judges this standard; players do not self-award.
...
**Contested Beliefs**: If a Belief's pursuit creates a genuine tension with another character's Belief (player or named Non-Player Character), the Game Master may mark the Belief **Contested**. It cannot be pursued for CP until a scene makes the tension explicit and one character chooses a position. This is not a penalty — it is narrative pressure.


### Domain Action Awards

At seasonal accounting, the Game Master reviews Domain Actions and personal goals pursued during the season. No fixed amount — Game Master judgment. Guideline: 1–2 CP for a season of active engagement with faction goals; 3–4 CP for a season that genuinely altered the political situation.

---

## 10.3 CP Spending Menu

All purchases have narrative requirements. CP alone is insufficient — every purchase must be grounded in play. The Game Master confirms that the narrative requirements are met before the purchase takes effect.
...
**No CP purchase for**: Thread Sensitivity growth, Intelligibility recovery, Certainty recovery, Thread Stability recovery. These are play-driven; they cannot be purchased.
...
1. Player declares intent and names the focus.
2. Two scenes where the character actively engages with the focus (Game Master confirms engagement is genuine, not incidental).
3. After each scene: Spirit check TN 7, Ob 1.
   - Both succeed: Inspiration established at 1 point.
   - One succeeds, one fails: Inspiration established at 1 point with a **Complication Tag** (Game Master assigns a narrative condition — e.g., *"only while in Valorsplatz"* or *"contingent on Lenneth's survival"*).
...
**CP conversion**: Completing a Belief converts it to an Inspiration at 1 point without cost. An Non-Player Character whose relationship with the character reaches significant depth (Game Master discretion) may become an Inspiration focus.
...
- A named Non-Player Character with faction standing publicly acknowledges the character's role in an event.
...
2. Award CP (Game Master): Belief events this season, Domain Action recognition.
...
| Scale | Example | Base Ob | Thread Tension Multiplier (Thread operations) |
|---|---|---|---|
...
Base Ob applies when a Thread operation targets configurations at that scale. Thread Tension multiplier applies to Thread Tension gain from the operation.
...
| Thread → Faction transitions | Standard handoff rule (Thread pool, faction-scale Ob) | Faction-card Thread orders (Weave/Investigate/Harvest) | Personal Phase: TTRPG. Strategic Phase: board game. Both count toward seasonal Thread Tension. |
...
4. Set clocks: Thread Tension 28, Theocracy Counter 15, Institutional Pressure 20.
...
**Shared loss condition (all modes):** Thread Tension reaches 100. The Rupture. No faction wins.
...
**Quiet season:** Game Master may compress to Strategic + Cascade only (~30 min) when no TTRPG scenes are dramatically necessary.

**Extended season:** Game Master may split one season across 2 sessions when TTRPG scene volume demands it. Strategic Phase defers to session 2.

### Pacing Controls

**Zoom In is player-initiated.** Any board order that resolves entirely between NPCs does not generate a TTRPG scene. The Game Master narrates the outcome so players have the information before their next scene.
...
- A clock threshold is crossed as a direct result and a Player Character is present in the affected territory

**Non-Player Character-order sequencing.** Within the Strategic Phase, Non-Player Character-only orders resolve first. Their outcomes are narrated before player-involved scenes begin. This ensures player scenes impacted by prior Non-Player Character action occur in the correct narrative order.
...
**Default:** All TTRPG personal-scene consequences batch to the Cascade Phase. Game Master tracks on a ledger during Personal Phase and applies in bulk. An inline exception is permitted for single-stat changes with no threshold risk — Game Master discretion only, not a player option.

**Thread operations in hybrid:** Personal-scale Thread operations during the Personal Phase resolve as TTRPG narrative consequences. Clock and tracker effects (Thread Tension, ThS, Coherence, co-movement) are noted by the Game Master and batched to Cascade. A faction-scale Thread order (Weave/Investigate/Harvest on the board) represents a collective premeditated operation — it resolves under board game rules and generates a Co-Movement Card draw, not personal co-movement effects. The two tracks are parallel.
...
**Resources/Wealth interaction.** When a Player Character spends Resources during a TTRPG scene, evaluate at Cascade:
...
2. **Mechanical trigger** — a named Non-Player Character's mass battle unit attacks a Player Character's mass battle unit. Generates a mandatory Zoom In.
...
If another Player Character can proxy: that Player Character executes faction orders during the Strategic Phase for the expedition duration. The absent Player Character retains faction leadership narratively.

If no Player Character can proxy: the faction runs on Non-Player Character artificial intelligence logic. The absent faction leader may send one Belief-level directive per season, which the artificial intelligence prioritises unless it conflicts with faction survival logic.

The expedition Player Character continues Personal Phase scenes normally throughout.

### Cascade Phase — Full Procedure

The Cascade Phase is Game Master-controlled. Players do not take actions. Work through in order:
...
3. **Clock checks** — check Thread Tension, Theocracy Counter, Institutional Pressure against thresholds. Fire threshold events in order: Thread Tension first, Theocracy Counter second, Institutional Pressure third. Queue institutional responses for next Personal Phase.
...
5. **Board state update** — Game Master updates the board to reflect all of the above. This is the final state visible at the start of the next Strategic Phase.
...
All three clocks (Thread Tension, Theocracy Counter, Institutional Pressure) advance only in the Cascade Phase. No clock advances mid-Personal Phase or mid-Strategic Phase. All clock changes batch to Cascade step 3.

### Hybrid Endgame

Victory requires satisfying both personal and strategic conditions simultaneously.

**Hybrid victory:** A faction achieves its board game primary victory condition AND the faction leader Player Character has resolved their central Belief arc in a way that supports the victory. If the board game condition is met but the Player Character's Belief arc contradicts it, the victory is **hollow**.
...
**Hybrid loss:** Thread Tension 100, or faction collapse with no personal resolution.
...
| Rule | TTRPG | Board Game | Hybrid |
|---|---|---|---|
| Thread operations | Personal-scale (Weaving, Pulling, Leaps) with full narrative | Faction-scale (Weave/Investigate/Harvest orders) with Co-Movement Card | Personal Phase: TTRPG Thread ops. Strategic Phase: board game Thread orders. Both count toward seasonal Thread Tension. |
...
| Rule | TTRPG | Board Game | Hybrid |
|---|---|---|---|
| Thread Tension/Theocracy Counter/Institutional Pressure advance | At seasonal accounting | At Accounting | At Accounting (Cascade Phase) — identical |
...
When Thread Tension crosses a threshold, the Game Master determines a narratively appropriate consequence from the current situation. No event deck. The current political, social, and thread-level state of the world should generate the threshold consequence organically.

---

## 12.7 The Thread Depth Track as Campaign Arc
...
| Thread Depth | Stage | Character experience |
|---|---|---|
...
### Player Character Death and Faction Succession

On Player Character death: the faction enters **Crisis** (−1 to all faction stats for one season; no floor during Crisis).

Player chooses one of three succession options — resolved within the same Cascade Phase:

1. **Take over an existing faction-loyal Non-Player Character.** That Non-Player Character becomes a full Player Character with their existing stat block. No newly generated characters.
2. **Designate another Player Character as successor** (requires that player's agreement). The dying player then begins a new personal character unaffiliated with the faction.
3. **Faction passes to a named Non-Player Character** (Game Master-controlled). Dying player begins a new personal character unaffiliated with that faction.

If no option is chosen within the Cascade Phase, option 3 defaults automatically.

### Faction Collapse and Personal Characters

A Player Character whose faction collapses continues as a personal character. They lose all dice bonuses derived from that faction (Circles dice tied to the faction, any faction-stat-derived pool modifiers). Personal attributes, Histories, Knots, Inspirations, and Beliefs are unaffected. Founding or joining a successor faction is a narrative path available through play.
...
Board game successes generate CP and personal advancement. The character performed those actions; zoom level does not affect whether the experience counts. CP awards use the same criteria as TTRPG play (Belief engagement, significant Domain Action). Game Master adjudicates at Cascade Phase seasonal accounting.

### Knot and Inspiration Consequences from Board Events

Mechanical consequences to Knots and Inspirations from board events are **gated by information**. They do not apply until the Player Character learns about the event in a TTRPG scene.

**Exception:** If the very next TTRPG scene after the board event is directly and immediately connected to that event (Player Character witnesses the death, or the scene opens in the immediate aftermath), the consequence applies at scene open. Time has not passed; the gating condition is met by the scene itself.
...
**Thread Sensitivity at the table.** In scenes with Thread-significant objects or practitioners at Coherence 7 or below, the Game Master may privately note that Almud experiences an impression he cannot name. Thread Sensitivity 30+ practitioners who succeed on a passive perception check notice the King's threads register faint sensitivity. He does not know they see it.
...
**Thread Sensitivity:** 50 (Attuned; unknown to anyone including Klapp himself).

**Combat Endurance track:** 8. Trajectory B (Fracture) confirmed. Coherence: 9 (Dissonant band). **Certainty: 3** (starting value = Spirit score 3; current = 3). One successful Leap drops Certainty to 0, triggering Rendering Crisis.
...
At Combat Endurance 3+: qualifies for Thread Sensitivity growth check (Cognition TN 7, Ob 1) on the next confrontation event.
...
At Combat Endurance 3: Thread Sensitivity growth check — Cognition TN 7, Ob 2 (essentialist formation raises the Ob). Success: develops Thread Sensitivity toward Dormant. This is a **crisis of faith event**, not a benefit.
...
For the co-movement procedure and the Co-Movement Prompt Table, see §5.17. For Thread Hard Moves, see §5.3. For the Thread Depth track as campaign arc, see §12.7. For the Rendering Engine procedure, see §12.6.
...
- [ ] Set opening clock values: Thread Tension 28, Theocracy Counter 15, Institutional Pressure 20, Parliament Integrity 7
- [ ] Write 1–2 Impression Tracks for the first NPCs players will meet
- [ ] Establish which clocks each Player Character is best positioned to address — and in which direction
...
Answer these collectively before first play. These are not rules — they are the table's shared fiction decisions. Answers shape tone, Non-Player Character behavior, and which dramatic questions are live.
...
4. Is the Thread visible, audible, felt, or something else entirely to practitioners at this table? How does the Game Master describe it without overdescribing it?
5. When a practitioner fails and Thread Tension rises, does the world deteriorate visibly and immediately, or does it accumulate silently? Which kind of horror fits the table?
...
14. Is there a named Non-Player Character who the table wants to protect, and one they want to destroy?
...
All difficulty in Valoria is expressed through Ob. This guide gives the Game Master a reference framework for setting Ob across the five action categories. The goal is consistency: the same quality of opposition should produce the same Ob regardless of scene type.
...
The Non-Player Character's Resonant Style applies: using the style earns +1D, not a lower Ob. The difficulty reflects their actual position; the Style bonus reflects the quality of the approach.
...
Domain Ob can also be set directly from the opposing faction's relevant attribute (stat score ÷ 2, round up). This is the default for Domain Echoes where the Game Master needs a fast Ob without deliberation.
...
When a player rolls a Failure, the Game Master makes a Hard Move. Roll d12 or choose the most appropriate for the current fiction.
...
| 12 | **The worst thing** — Game Master makes the most narratively appropriate severe consequence |
...
**The loop:**
- Rising Thread Tension produces Thread events the Church reads as theological warrant for authority → Theocracy Counter rises.
- Theocracy Counter pressure produces political instability → factions conflict → battles → Thread Tension rises further.
...
When a character with Thread Sensitivity 10–39 is present during a Thread operation of sufficient intensity, the Game Master may call a Discovery Event.
...
**Procedure:**
Private Spirit check (TN 7, Ob 1). Success: Thread Sensitivity advances per the standard growth table (see §5). Failure: character is *primed* — the next Discovery Event of equal or lesser intensity triggers automatically without a check.

**Presenting Discovery Events.** A Discovery Event is not dramatic by default. The Game Master should describe it as a perceptual intrusion that doesn't fit the rendering: a moment where the world seems to hold still, where distance collapses, where a sensation arrives with no source. What the character interprets this as (spiritual intimation, madness, a trick of the light) is their own business. The Game Master does not announce that Thread Sensitivity is changing.
...
- [ ] Advance Non-Player Character Combat Endurance tracks; resolve Thread Sensitivity growth checks for any Non-Player Character at Combat Endurance 3+
...
- [ ] Thread Tension passive drift: +1 per four seasons (i.e., once per full year, at Winter accounting)
- [ ] Apply Thread Tension-lowering events (Overwhelming Weavings at Relational+; preserved Einhir sites; sustained community Weaving; Ceiral Ritual)
...
- [ ] Theocracy Counter threshold conditions: Theocracy Counter Mandate-based generation pauses if Church Stability ≤ 3 this season. Rendering Stability cross-clock Theocracy Counter gain still applies. Cross-faction Mandate average ≥ 6: Theocracy Counter −1 this season.
...
- [ ] Orphaned configuration deterioration: each orphaned configuration makes an Endurance check (TN 7, Ob 1) at accounting. Failure: configuration fragments (Thread Tension +1; perceptible wrongness at Thread Sensitivity 30+).
- [ ] Season marker advances. At Winter: year-end accounting (Thread Tension annual drift, annual events).
- [ ] Check TTRPG endgame indicators if applicable (see §12.1). If board game or hybrid: check victory conditions.

---

## 14.8 Game Master Game Sheet Reference

The following tracks require active Game Master management throughout the campaign. Keep these visible.
...
| Theocracy Clock (Theocracy Counter) | 15 | 20 (Ecclesiastical), 40 (Ultimatum), 60 (Schism), 80 (Seizure), 100 (Holy State) |
| Altonian Pressure (Institutional Pressure) | 20 | 30 (Aggressive), 45 (Hostile), 60 (Warlike), 75 (Imminent), 100 (Invasion) |
| Parliament Integrity | 7 | 7–10 (Normal), 5–6 (+1 Ob all Votes), 3–4 (Supermajority required), 1–2 (Recess), 0 (Dissolved) |

**Non-Player Character Tracking (starting values):**

| Non-Player Character | Thread Sensitivity | Combat Endurance | TK | Notes |
|---|---|---|---|---|
| Baralta | 0 | — | — | Devout foreclosed; Theocracy Counter suppressor |
...
**Thread Tension penalties to Thread operations (all operations):**
- Thread Tension 60–79: +1 Ob
- Thread Tension 80–99: +2 Ob
- Thread Tension 100: campaign event
...
| Code | Name | Scale | Ob | Min Thread Sensitivity | Description |
|---|---|---|---|---|---|
...
| W-04 | Territorial Calm | Territorial | 5 | 60 | Regional thread-configuration stabilised. All Thread operations in the territory at −1 Ob for one season. Thread Tension −1 on Overwhelming. |
...
| W-06 | Dissolving a Monstrous Configuration | Variable | 3–5 | 60 | Entity destroyed; Gap partially closed (Thread Tension −2 on Success; −4 on Overwhelming). Ob varies with entity's configuration depth. |
...
| W-09 | Stabilising a Gap | Territorial | 4 | 60 | Gap stops widening for one season. Does not close it. Requires sustained contact (full scene). Thread Sensitivity growth: +4 on success. |
...
| P-06 | Memory Displacement | Personal (firm) | 3–4 | 60 | Specific memory loosened toward potential; content becomes uncertain or inaccessible for duration. Absence detectable by Thread Sensitivity 30+ Diagnosis. |
| P-07 | Thinning the Veil | Relational | 3 | 60 | Rendering surface thinned in an area; non-sensitive characters experience minor rendering failures; Thread-locked objects briefly visible to Thread Sensitivity 10+. |
| P-08 | Temporal Shimmer | Object (Past-Oriented) | 3 | 80 | Burned letter readable; broken object briefly whole; glimpse of the object's prior state. Duration: one round. Produces Thread Depth +1. |
...
All FR operations require Thread Sensitivity 50+. All FR operations add Thread Depth. Diagnosis mandatory before any FR; skipping adds Ob +2 and risks auto-Gap on failure.

| Code | Name | Type | Scale | Ob | Min Thread Sensitivity | Description |
|---|---|---|---|---|---|---|
...
| FR-L-02 | Sealing a Mind | Lock | Personal | 5 | 60 | Thread Sensitivity sealed at current value; one Belief made permanently unrevised-able; specific injury effect made permanent. Non-consensual: Certainty −2 practitioner. |
...
| FR-D-04 | Unmaking | Dissolution | Territorial | 7 | 80 | Territory loses configurational coherence. Fraying Bane risk to practitioner (§5.7). Thread Tension +6 minimum regardless of outcome. |

---

## 15.4 Operation Scale Reference

| Scale | Ob | Thread Tension Multiplier | Min Thread Sensitivity |
|---|---|---|---|
| Object | 1 | ×1 | 40 |
| Personal | 2 | ×1 | 40 |
| Relational | 3 | ×2 | 60 |
...
**Mass combat Thread operations:** Replace scale Thread Tension multiplier with flat ×3. Total Thread Tension gain from any single mass combat Thread operation capped at +15. Excess converts to narrative consequence (regional site destabilisation, Locked zone expansion) at Game Master discretion.
...
| **Combat Endurance** | Confrontation Exposure. Per-Non-Player Character 0–5 track. At Combat Endurance 3, triggers a Thread Sensitivity growth check — a crisis, not a benefit. |
...
| **Devout Constraint** | Essentialist theological formation that forecloses Thread Sensitivity development. Cannot be overcome through confrontation alone — requires sustained doctrinal rupture. |
| **Diagnosis** | Step 2 of Thread operation. No roll; structured Game Master exchange. Mandatory before Forced Resolution. |
| **Domain Action** | A personal roll that the Game Master recognises as having faction-level scope. The personal Ob resolves the personal outcome; a second Ob resolves the faction-level consequence. |
| **Domain Echo** | When a personal success automatically produces faction-level effects without a second roll. Fires on Game Master recognition of scope; players do not declare it. |
...
| **Epistemic Seduction** | The process by which increasing Thread Sensitivity dissolves the normative categories that would motivate a transforming practitioner to seek correction. The rendering shifts; what once seemed monstrous seems clarified. |
...
| **FR** | Forced Resolution. Advanced Thread operation collapsing a configuration permanently to Lock (fully actualised) or Dissolution (ceases to exist). Requires Thread Sensitivity 50+. |
...
| **Impression Track** | 0–5 relationship scale with a named Non-Player Character. Advances through meaningful scenes; at 5, triggers a significant Non-Player Character action on the character's behalf. |
| **Inert Knowledge** | Information a non-sensitive character can recite but cannot act on with Thread-level precision. Marked on the sheet; unlocks mechanically when Thread Sensitivity develops. |
...
| **Institutional Pressure** | Altonian Pressure. A 0–100 track measuring the Altonian Empire's aggression toward Valoria. Hidden from players; expressed through events. |
...
| **Practitioner** | A character with Approach Training and Thread Sensitivity 40+. Can perform active Thread operations. |
| **Providence Event** | When the Ein Sof's fullness arrives in a form the rendering can hold — briefly and perfectly. Cannot be triggered. A consequence of perfect alignment at mortal risk at Thread Tension ≤ 20. |
...
| **TK** | Thread Knowledge. Per-Non-Player Character 0–5 track for characters who understand Thread metaphysics intellectually (not experientially). |
| **TN** | Target Number. The minimum a die must show to count as a success. Standard TN is 7. |
| **Thread Tension** | Thread Tension. A 0–100 track measuring cumulative strain on the rendered world's configurational substrate. Default start: 28. |
...
- Thread Sensitivity (Game Master tracks; not shown to player)
...
**Impression Tracks**
- Non-Player Character name, 0–5 track, Dormant checkbox
...
**Faction collapse (Stability 0):** All attributes freeze; Mandate drops to 0; Game Master determines collapse within one season; reconstitution requires Circles Ob 4 + Stability rebuilt above 2.
...
**Thread Tension penalties to all Thread operations:**
- Thread Tension 60–79: +1 Ob
- Thread Tension 80–99: +2 Ob
...
| History +1 | 3 |
| New Boon | 3–8 (Game Master and player agree) |
...
| Stage 17-P2 | Canon Guard | §5.10 Taint Track → Coherence Track; individual track inverted 10→0 (10=fully coherent, 0=monstrous Non-Player Character); all Taint/taint references updated |
| Stage 17-P3 | Canon Guard | Heart attribute removed: Leap pool → Attunement + History; Contact Duration → Focus; all Thread operation rolls → Spirit + History; Inspiration checks → Spirit; Discovery Event and Originary Lock checks → Spirit; Combat Endurance-triggered Thread Sensitivity growth checks → Cognition |
| Stage 17-P4 | Canon Guard | Poise removed; Composure = Presence + 6 everywhere; Debate pool → Cognition; Non-Player Character Composure values recalculated against Presence + 6 |
...
| Varfell Private Collection transfer | Player Character takeover scenario — transfer conditions |
| Niflhel primus inter pares | Leadership structure decision |
| Revolution named elder Non-Player Character | Optional contact for Revolution faction |
...
| Niflhel named Non-Player Character stat blocks | Rolf Dunmark, Solvind Brak |
| Revolution named Non-Player Character stat blocks | Edith Varn |

# Propagation Map Archive (entries archived 2026-05-10)

Archived from `references/propagation_map.md` 2026-05-10 to keep working file under 15k-token CI limit.
Each entry below was a propagation note for a patch or editorial item; consult full canonical state in `canon/patch_register_active.yaml` and the corresponding design doc for current values.

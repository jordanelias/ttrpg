...
> Phase 1 design briefs (Batch D). Absorbed into params files. Superseded.
> Do not use as a canonical source.

---

# Phase 1 — Batch D: Faction Identity Packages
## Date: 2026-03-25 (Session 4)
## Status: Design briefs — EDITORIAL THROUGHOUT
## Covers: G-019 (ethical framework expression), G-020 (leader vs institution), G-032 (asymmetric powers)
## Plus: G-022 (nine political axes as gameplay generators)
...
# FACTION 1: THE CROWN (Monarchy)

## Ethical Framework: Virtue Ethics
The Crown's institutional logic evaluates actions by whether they demonstrate virtuous character — courage, justice, temperance, prudence. The institution rewards visible virtue and punishes visible vice, regardless of outcomes.

**Framework modifier:**
- Domain Actions that are publicly visible and demonstrate virtue (defending the weak, upholding law, honoring treaties): −1 Ob.
- Domain Actions that are covert, expedient, or morally ambiguous: +1 Ob.
...
Once per season, the Crown may issue a Royal Decree — a unilateral political act that bypasses normal Domain Action resolution.
- Roll: Mandate vs Ob 2.
- Success: one faction attribute change (any faction, ±1) takes effect immediately, not at seasonal accounting.
- Failure: Mandate −1 (decree perceived as overreach).
...
- Domain Actions that contradict doctrine or undermine Church authority: +1 Ob. The Church literally cannot efficiently act against its own stated principles — the institution resists.
...
- Failure: Church Mandate −1 (overreach visible). Target gains Mandate +1 (sympathy martyr).
...
# FACTION 3: HAFENMARK (Duchy)

## Ethical Framework: Categorical Imperative
Hafenmark's institutional logic evaluates actions by whether they could be universalized — would this action remain coherent if every actor in this position did the same? The institution values consistency, precedent, and rule of law above outcomes.

**Framework modifier:**
- Domain Actions based on legal precedent, constitutional authority, or established procedure: −1 Ob.
- Domain Actions that are ad hoc, situational, or precedent-breaking: +1 Ob.
- Consequence: Hafenmark excels at procedural power (parliamentary maneuvers, legal challenges, constitutional arguments) and struggles with improvisation.

**Institutional Tendency:**
Maintain constitutional order. Defend ducal prerogative. Resist Church encroachment through legal means. Follow established procedure. The institution does not innovate — it conserves.

**Leadership Deviation:**
Baralta acting against institutional tendency (e.g., extralegal action, breaking with Parliament, allying with Niflhel): Stability check Ob 1. Hafenmark's institution is tightly aligned with its leader — Baralta IS the institution. Deviation costs are low because her personal authority is so thoroughly embedded. This is her advantage.
...
# FACTION 4: VARFELL (Duchy)

## Ethical Framework: Consequentialist Pragmatism
Varfell's institutional logic evaluates actions purely by their outcomes. The means are irrelevant if the ends are achieved. The institution is amoral at the structural level — it does not reward virtue or punish vice, only success and failure.

**Framework modifier:**
- Domain Actions where the outcome can be measured within one season (concrete, verifiable results): −1 Ob.
- Domain Actions with uncertain or long-term payoff (ideological campaigns, relationship-building, cultural investment): +1 Ob.
- Consequence: Varfell is strongest in short-term tactical play and weakest in long-term institution-building. They win battles and lose peace.

**Institutional Tendency:**
Maximize information advantage. Acquire resources (including Thread-related materials). Avoid public commitments. Keep options open. The institution defaults to intelligence operations and economic positioning over military or social action.

**Leadership Deviation:**
Vaynard acting against institutional tendency (e.g., public ideological commitment, supporting the Restoration openly, military aggression without intelligence preparation): Stability check Ob 2. The institution expects its leader to be clever, not bold.

**Unique Action — The Private Collection:**
Vaynard maintains a collection of Einhir artifacts and Thread-locked objects. Once per season, he may deploy an item from the collection for a specific purpose.
- Roll: Intelligence vs Ob 2.
- Success: one of the following effects (player choice):
...
# FACTION 5: THE GUILDS

## Ethical Framework: Moral Relativism
The Guilds' institutional logic does not recognize universal moral principles. Each guild evaluates actions by the standards of its own craft, community, and economic interest. What is right for the Weavers' Guild may be wrong for the Smiths'. The institution is inherently pluralistic.

**Framework modifier:**
- Domain Actions that benefit trade, economic stability, or guild autonomy: −1 Ob.
- Domain Actions that require moral consistency across contexts (enforcing a single law, demanding uniform behavior, ideological campaigns): +1 Ob.
- Consequence: the Guilds cannot effectively project unified political will. They are powerful as an economic bloc and weak as a political actor.

**Institutional Tendency:**
Protect commerce. Maintain guild autonomy. Avoid military entanglements. Resist taxation. The institution defaults to economic self-interest in every territory independently.

**Leadership Deviation:**
The Guilds have no single leader — they are governed by a rotating Guildmaster Council. Deviation from institutional tendency requires convincing the Council (Influence Ob 3 as a Domain Action to redirect Guild policy). This means the Guilds are slow to change course but resistant to disruption from the top.

**Unique Action — Economic Leverage:**
The Guilds may apply economic pressure to any faction present in a territory where Guild Favour is 5+.
- Roll: Wealth vs target faction's Wealth.
- Success: target faction loses 1 Wealth for 1 season (trade disruption, supply price increases, labor withdrawal).
...
# FACTION 6: NIFLHEL (Shadow Network)

## Ethical Framework: Amoral Consequentialism
Niflhel has no moral framework. Actions are evaluated by operational effectiveness. There is no institutional ethics — only operational logic. This is not consequentialism with a utilitarian goal; it is pure instrumentality.

**Framework modifier:**
- Covert Domain Actions (intelligence, sabotage, assassination, smuggling): −1 Ob.
- Public Domain Actions (anything that requires Niflhel to act openly or claim credit): +2 Ob. Niflhel structurally cannot operate in the open. Public exposure is their existential threat.
- Consequence: Niflhel is the strongest covert actor and the weakest public one. They cannot build Mandate because they cannot be seen.

**Partial faction sheet:** No Mandate. No Military (they have operatives, not armies). Influence, Wealth, Intelligence, Stability.

**Institutional Tendency:**
Acquire resources. Sell services. Avoid exposure. The institution defaults to intelligence operations, smuggling, and opportunistic service provision. It does not pursue political goals — it pursues survival and profit.

**Leadership Deviation:**
Niflhel's structure is decentralized (four arms: Dockworkers, Reckoners, Burned, Quiet). No single leader can deviate from institutional tendency without the other arms' consent. Attempting to redirect Niflhel toward a political goal requires a Domain Action (Influence Ob 3 within Niflhel) to convince the relevant arm. Failure: the arm acts independently, potentially against the redirecting leader's interests.
...
# FACTION 7: THE PEOPLE'S REVOLUTION (Restoration Movement)

## Ethical Framework: Rawlsian Social Contract
The Revolution's institutional logic evaluates actions by whether they would be chosen from behind a veil of ignorance — whether the action benefits the least advantaged members of society. The institution values equity, access, and the dismantling of unjust privilege.

**Framework modifier:**
- Domain Actions that demonstrably benefit the common population (reducing taxation, expanding access, challenging noble privilege, protecting Einhir cultural practice): −1 Ob.
- Domain Actions that concentrate power, benefit elites, or suppress popular expression: +1 Ob.
- Consequence: the Revolution is strongest when it acts for the people and weakest when it tries to build institutional power for itself. It is structurally self-limiting — the moment it becomes an establishment, its own framework turns against it.

**Partial faction sheet:** No Mandate (they reject the legitimacy of the system that confers Mandate). No Military (they are a movement, not an army). No Wealth (they operate through informal economies). Influence, Stability, Intelligence only.

**Institutional Tendency:**
Spread pamphlets. Undermine elite Mandate. Protect practitioners. Recover Einhir cultural knowledge. The institution defaults to information warfare and cultural advocacy.
...
# G-022: NINE POLITICAL AXES AS GAMEPLAY GENERATORS

### Problem
The design document references nine political axes but they've never been enumerated or given mechanical expression.
...
| 8. External threat | Accommodation of Altonia | Resistance to Altonia | Crown (split) vs all |
...
- P-14 (all modes express inseparability): Axis 9 (ontological) is the Thread axis — it connects to every other axis because Thread reality underlies the political world.
...
|-----|--------|----------------|
| G-019 | Designed (integrated into faction cards) | None — frameworks are modifiers, not separate systems |
| G-020 | Designed (integrated into faction cards) | None |
| G-032 | Designed (one Unique Action per faction) | 2 flags below |
| G-022 | Designed | None |
...
**Phase 1 running total: 25 of 51 design gaps resolved (Batches A+B+C+D).**
**Remaining: Batch E (14 board game gaps), Batch F (3 hybrid+endgame gaps), plus 9 hybrid handoff gaps (G2+G3 from gap register).**

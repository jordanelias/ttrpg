<!-- DEPRECATED: 2026-04-09 — SUPERSEDED BY Claude Project Instructions (current version in project settings). Do not use as a mechanical reference. Retained for audit trail only. -->

...
INSERT INTO "npcs" VALUES('NPC-021','Arne','Himlensendt','Church','Confessor (Church Leader)','canonical','Confessor',NULL,NULL,'T9 (Himmelenger)',NULL,NULL,NULL,NULL,0.0,'ecclesiastical',NULL,'faction_canon_v30 §Church','Canonical per engine/params/bg/core.md L233. Agent in Crown Inner Circle via Father Gustav Linder.');

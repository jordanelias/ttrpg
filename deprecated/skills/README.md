...
- **valoria-combat-simulator** (retired 2026-07-12, ED-IN-0039) — the standalone personal-combat
  ...
  40-weapon, Wilson-CI-validated instrument (weapon/attribute/tradition/armour sweeps) that reuses
  the canonical `fight()` resolver directly instead of a hand-maintained parallel model. The skill's
  own `## Input Validation` also pointed at `params/combat.md`, deprecated since 2026-06-04. Combat

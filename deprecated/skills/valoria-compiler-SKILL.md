<!-- DEPRECATED: 2026-04-09 — SUPERSEDED BY skills/valoria-compiler/SKILL.md (dir-based version). Do not use as a mechanical reference. Retained for audit trail only. -->

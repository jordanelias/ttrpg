...
Reads systems/world/adjacency_map.jsx, extracts 17 territory (x, y) coordinates
...
def emit_yaml_stub(coords: dict, edges: list, out_path: Path) -> None:
    ...
    lines.append(f"# Source: systems/world/adjacency_map.jsx ({JSX_W}×{JSX_H} canvas)")
...
def main() -> int:
    ...
    parser.add_argument(
        '--jsx',
        default='systems/world/adjacency_map.jsx',
        help='Path to adjacency_map.jsx (default: systems/world/adjacency_map.jsx)',
    )
    parser.add_argument(
        '--out',

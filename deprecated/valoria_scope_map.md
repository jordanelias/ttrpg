<!-- DEPRECATED: 2026-04-09 — SUPERSEDED BY references/canonical_sources.yaml + references/file_index.md. Do not use as a mechanical reference. Retained for audit trail only. -->

...
Almud yields. Institutional Pressure stays at base pace. Torben departs. The loyalty clock begins: −1/season, floor at 1. Covert contact by the Crown's intelligence apparatus can hold the decay — but Intelligence vs Ob 3 each season, and failure doesn't just stop the contact, it may expose it (Institutional Pressure +1 if detected).
...
**Primary mechanics:** Excommunication unique action (§8.3) · Baralta Theocracy Counter suppression condition (Mandate ≥ 5) · Theocracy Counter +4 on Baralta excommunication · Church territorial seizure at Theocracy Counter 60 · Martyr effect (failure = Church Mandate −1, target +1) · Grand Debate reversal (5 exchanges)
...
An Overwhelming Church victory is one of the most structurally significant single events in the game. It removes Baralta's Theocracy Counter suppression, immediately spikes Theocracy Counter by 4, triggers the seizure procedure at whatever Theocracy Counter currently sits plus 4, and begins stripping Hafenmark's political capacity at the moment when the players most need it. The Church does not have to do anything else that season. The accounting machinery does it for them.

A failed Excommunication is the mirror image. The Church loses Mandate. Baralta gains it. The institution that just tried to destroy her emerges weaker and she emerges with a sympathy mandate that functionally fortifies her position for two to three seasons. Every Non-Player Character in the kingdom who was watching — and they all were — recalibrates. Olafsson does not get a second attempt without rebuilding the file.
...
Baralta's Mandate was at 7. It drops to 6. Theocracy Counter suppression threshold is Mandate ≥ 5 — still active, but damaged. The Reputation −1 fires across all factions. Players who had been working through Baralta lose one degree of social access to every Non-Player Character she intermediated.
...
Standard Excommunication success: Mandate −1 (from 7 to 6), Church-loyal command barred, Circles with Church contacts lost. Theocracy Counter +4 immediate. Baralta's Mandate 6 is still above 5 — suppression technically active, but barely. One more Mandate hit removes it.

The Theocracy Counter +4 is the structural damage. If Theocracy Counter was at 35 entering this season, it is now at 39. If it was at 40, it is at 44. If it was at 50, it is now at 54 — six points from triggering the territorial seizure cascade. The seizure procedure requires Church Mandate vs territory owner Mandate ÷ 2 each season. With Church Mandate at 5 and territory owners averaging Mandate 4–5, the Church is winning most of these rolls. Major territories seized: Theocracy Counter +3 each. Capital or institutional sites: Theocracy Counter +5.

Valorsplatz (Territory 1, Prosperity 6, Theocracy Counter +5 on seizure) becomes a realistic Church target within two seasons.

### Branch C — Church Fails the Excommunication Roll

Failure: Church Mandate −1 (from 5 to 4). Baralta gains Mandate +1 (sympathy martyr) — she is now at Mandate 8, capped at 7 in the 1–7 stat system. Theocracy Counter suppression is now rock solid. The attempt exposed Olafsson's overreach.

Baralta holds circumstantial evidence of the Olafsson-Niflhel connection. The failed excommunication is the political opening she needed to act on it. Domain Action: Mandate 7 + Reach 5 + player evidence bonus vs Church Stability Ob 3. If it succeeds: Church Stability −2, Theocracy Counter −3, Olafsson's Inquisitor operations suspended. The campaign's political geometry has inverted. The Church is defending.
...
**Why this arc is emergent:** The Excommunication roll is a 5-die pool versus Ob 7. The outcome probabilities are genuinely variable — all three branches are mechanically plausible. Baralta's Theocracy Counter suppression, the martyr mechanic, and the seizure cascade are all designed-in consequences. No player engineered the divergence.

**Arc shape:** 2-season file-building. 1 session roll. Immediate Theocracy Counter/Mandate consequences. Branch A/B: 2–4 season seizure cascade or Grand Debate recovery. Branch C: 1–2 season Baralta counter-offensive, possible Church collapse event.
...
**Primary mechanics:** Ceiral Ritual (§6.5) · Degree table (Overwhelming/Success/Partial/Failure) · Thread Tension/Rendering Stability consequences · Mode 3 monstrous entity on Failure · Lead practitioner incapacitation · Southernmost territory development (Overwhelming only) · Expedition prerequisite cascade
...
The roll is Maret's Weaving pool, Ob 5, plus up to +4D from Thread Sensitivity 20+ participants. A maximum pool with full participant support is rolling roughly 8–12 dice against Ob 5 with TN 7. The outcomes range across the complete degree table. In no direction is the result moderate.

### Branch A — Overwhelming (net ≥ 10)

The wound stabilises permanently. Thread Tension −10. The Southernmost becomes settleable — territory 13 (Askeheim) may be developed and inhabited. This is a campaign-level transformation. Every Rendering Stability recovery calculation changes. The spontaneous Gap formation that has been draining the substrate ceases. The Forgetting mechanism weakens — the Southernmost is no longer incomprehensible to non-sensitives.

Vaynard's TK immediately advances to 5 if a practitioner explains what just happened and what Solmund structurally was — this was always the knowledge he was pursuing, and the successful Ritual makes the explanation undeniable. Theocracy Counter +3 from TK 5 (cumulative with existing advances). He seeks capability, not further knowledge. The conversation after the Ritual, in a world where the wound is closed and the question is what to do with that, is the most consequential social scene of the campaign.

Cardinal Klapp, if his Combat Endurance track has been advancing from archive work, is now one Discovery Event away from his Thread Sensitivity growth check firing in a world where the Southernmost is no longer sealed. The Ritual produced observable Thread activity that Thread Sensitivity 30+ observers across the peninsula perceived. If Klapp is Thread Sensitivity 31 and was anywhere near Southernmost-related documents during this season: the check fires.

### Branch B — Failure (net ≤ 0)

The outer winding tears. Thread Tension +8. A Mode 3 monstrous entity — a threadcut being — emerges at the primary site. It is not hostile by nature, but it is present in the physical world, actively sustaining its own existence through continuous Thread work, and the practitioners who just disturbed the site are the closest available substrate.

Maret Uln is Incapacitated. The Ceiral Ritual cannot be re-attempted by Maret — he is the lead practitioner who failed; the rule is that a new lead is required. Vaynard has lost his most valuable Thread asset on the most consequential roll of the campaign. The Mode 3 entity requires resolution: Dissolution (Ob 4+, risks second Gap, acute Rendering Stability damage), Pulling to weaken then conventional combat, communication (possible — threadcut beings may have comprehensible goals), or outlasting its De-Actualisation if it is accumulating Rendering Strain.

Thread Tension +8 means the Rendering Stability tracker has moved significantly. If Rendering Stability was already Fragile (59–40), it may now enter Fractured (39–20): Gaps open spontaneously, 1d10 per season on 1–2 in the lowest-Prosperity territory. Sudwald (Territory 12) has a Thread Wound that fires threshold events 10 Thread Tension points earlier than elsewhere — it is already generating pressure. Thread Tension +8 into a Fractured world means two independent spontaneous Gap sources active simultaneously next season.
...
**Why this arc is emergent:** The Ritual requires converging five independent prerequisites across multiple campaign seasons. The outcome is fully determined by a single Weaving roll, but the consequences cascade differently across the political, Thread, and Non-Player Character systems depending on degree. No player can predict which degree fires.

**Arc shape:** 3–5 seasons of prerequisite assembly. 1 session Ritual attempt. Immediate Thread Tension consequences. Branch A: endgame arc (Axis 9 resolution, Vaynard capability, Klapp crisis). Branch B: 2–3 seasons of Mode 3 resolution + Mending before re-attempt possible.
...
**Primary mechanics:** General two-stage incapacitation (§8.9) · Stage 1 (incapacitated): Coherence Rating halved, Morale floor suspended · Stage 2 (killed): −2 Morale outside cap, Coherence Rating = 0, all units uncommanded · Rout contagion brake · Leader defeat capture mechanic (Agility vs net successes) · Faction Military stat consequences from battle outcome · Ehrenwall as specific Non-Player Character
...
The general is the battle. The rules say this plainly. Coherence Rating 5 versus Coherence Rating 2 is an asymmetric outcome before a die is rolled. But Coherence Rating does not protect the general from a weapon. The two-stage incapacitation rule exists because the game models what happens when the army watches its general fall.

The Medicine roll in Phase 5 is a single opportunity. Ob 2. A character with Medicine History rolls their pool against Ob 2 in the same phase where the Cascade fires — all the Cohesion checks, all the Morale triggers, all the damage applications happen first, and then, if the general is at Stage 1, one character may attempt stabilisation. If nobody has invested in Medicine History, nobody rolls. If the roll fails, Stage 2 fires at the start of the following turn's Phase 5. Not immediately. The army has one more turn to act under a half-Coherence Rating general with no Morale floor. Then the general dies.

Ehrenwall at Stage 2 is not a tactical setback. It is a campaign event. The Löwenritter's institutional effectiveness is structurally dependent on her. Without her, Coherence Rating = 0, every unit is uncommanded, the formations can only fight as Line at Cohesion floor 1. The force that she built over a career of service becomes, in mechanical terms, an ungoverned mass of soldiers who each individually roll against their own Morale thresholds while receiving no stabilising floor from the person who gave it meaning.
...
Ehrenwall is at Stage 1. Coherence Rating halved (5 → 3). Morale floor suspended — units can now route below 1 if triggers stack. She is alive, she is functional at reduced capacity, and the battle continues under a diminished command.
...
Recovery: Ehrenwall may be stabilised back to full capacity with a full-round out-of-combat Medical action (no roll required if Stage 1 is already stabilised — she needs time, not additional medicine). If the battle permits a Reform Phase where she is not engaged, she returns to Coherence Rating 5 next turn. The window was one turn of reduced Coherence Rating.

### Branch B — Medicine Roll Fails (Stage 2 fires next turn)

Stage 2: −2 Morale all units (outside the cap — this fires on top of whatever Cascade Phase cap has already applied). Coherence Rating = 0. All units uncommanded.
...
|---|---|---|---|
| Tutoring Demand Branch B (refusal → Institutional Pressure 75) fires in the same season as Excommunication fails (Church Mandate −1) | 20 + 21 | Altonian invasion arrives into a Church at Stability collapse — Church cannot deploy Templars to contest Border Pass because Jarnstal's Stability check is also failing this season | EXTREME: Altonia and Church fracture simultaneously; Valoria faces external invasion with no unified institutional defense |
| Ceiral Ritual fails (Thread Tension +8) in the same season as Parliamentary Tie (Theocracy Counter +1, Rendering Stability −1) | 22 + 18 | Rendering Stability −9 total this season (Thread Tension +8 + Rendering Stability −1 from tie) — may cross from Fragile directly to Critical | EXTREME: Rendering Stability Critical in one season; all Thread operations now +1 Ob worldwide; spontaneous Gaps double; faction Stability checks at Ob 1 minimum fire for every faction |
| Ehrenwall killed in the same season Torben surrendered (Branch A) with Loyalty clock at 3 | 23 + 20 | Coup Counter extinguished by her death, but Torben at Loyalty 3 has already triggered Mandate −2 on Crown; Ehrenwall's institutional check on Church is gone; Church moves into the vacuum her death created | EXTREME: Crown at Mandate 3 (−2 from Torben), Löwenritter without direction, Church at Theocracy Counter 50+ — full dominance arc now has no mechanical resistance except Baralta alone |
| Excommunication Overwhelming (Branch A) fires in the same season as Ceiral Ritual Overwhelming (Branch B) | 21 + 22 | Theocracy Counter +4 from Baralta excommunication + Theocracy Counter +3 from Vaynard TK 5 advance post-Ritual = Theocracy Counter +7 in one season; simultaneously Rendering Stability stabilises permanently and Axis 9 resolves | EXTREME: The season the world is saved is the season the Church achieves peak institutional power; the Ritual's success is politically catastrophic; Valoria has a healed substrate and a theocratic government |

---

*All arcs compliant with arc generator protocol. No Niflhel Thread harvesting. Seasonal cap (±2 per stat) applied throughout — Theocracy Counter +4 from Excommunication is an immediate one-time consequence (unique action), not a seasonal stat change, and is therefore not subject to the cap.*

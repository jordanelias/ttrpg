...
**Arc shape:** Single operation, single roll. Immediately divergent. Overwhelming: 1-scene success, Theocracy Counter +1, axis activation, 1-season political fallout. Success: 1-scene Gap, possible entity risk at Mending Stability ≤ 40. Partial: 1d3 season oscillation arc. Failure: immediate entity encounter + Mending Stability −8 cascade, full endgame acceleration if Mending Stability was already Fractured.

...
**Primary mechanics:** Theocracy Counter threshold (§7.2), Grand Debate (§9 / debate_system_redesign_v1), Löwenritter Löwenritter Autonomy (§8.9), intelligence broker covert Network (§8.7), Personal Combat (§8), Mass Battle (mass_battle_v3), Thread → Mass handoff (§11.3)
...
|---|---|---|---|
| Arc 31 (Quaestio of Baralta) | Arc 34 (Ehrenwall's Count) | Theocracy Counter level + Crown Mandate erosion | If Baralta loses Grand Debate → Theocracy Counter spike activates Löwenritter Autonomy condition 2 faster |

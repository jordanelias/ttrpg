...
**Primary mechanics:** Mending Stability (MS) baseline decay (−1/year, PP-255), Thread operations (cumulative MS cost), Theocracy Counter (TC) passive advance (+1/season, PP-402), Weaving scale escalation
...
| Arc 8 (Guilds Know) | Arc 5 (MS Spiral) | If Crown-Guild alliance (Resolution B) optimises Suppress timing, Church forced to Assert in sub-optimal seasons — but Weaving continues regardless | TC suppression buys time; MS drain is independent of TC |

...
The interdependence arises from three shared mechanical substrates: the Mending Stability (MS) track, the Theocracy Counter (TC), and the Guilds-Niflhel supply chain. Every arc touches at least two of these. The arcs are numbered 36–40 to continue the existing sequence.

...
# ARC 1: THE HUNTING ACCIDENT (~218 AG) — STRUCK (PP-TBD)

**[STRUCK — PP-TBD: entire Arc 1 backstory removed. The 218 AG hunting accident / assassination investigation is no longer pre-game canon. Replaced by Royal Crisis Tension Card (Session C) — forward-looking assassination fuse targeting current Royal family at S8+. All branch logic below is invalidated.]**

## What Is Established — STRUCK (PP-TBD, backstory strike)

**[STRUCK — PP-TBD]** ~~King Almud's father died ~218 AG in a hunting accident. The assassination investigation arc and E-01 perpetrator question are removed from pre-game canon.~~
...
- *E-01: ~~Perpetrator of 218 AG assassination~~ — **STRUCK (PP-TBD)**. Replaced by Royal Crisis Tension Card (Session C).*

...
# ARC 1: THE HUNTING ACCIDENT (~218 AG) — STRUCK (PP-675)

**[STRUCK — PP-675: entire Arc 1 backstory removed. The 218 AG hunting accident / assassination investigation is no longer pre-game canon. Replaced by Royal Crisis Tension Card (Session C) — forward-looking assassination fuse targeting current Royal family at S8+. All branch logic below is invalidated.]**

## What Is Established — STRUCK (PP-675, backstory strike)

**[STRUCK — PP-675]** ~~King Almud's father died ~218 AG in a hunting accident. The assassination investigation arc and E-01 perpetrator question are removed from pre-game canon.~~

**Replacement:** Royal Crisis Tension Card (Session C) — one of the current Royal family members (Almud, Lenneth, or Torben) faces an assassination fuse that fires at S8+. The political dynamics previously driven by the 218 AG backstory will be generated by this forward-looking threat instead.

All downstream arc branches referencing E-01 assassination perpetrator, hunting accident evidence trails, and regicide accusations are invalidated by this strike. See Session C Tensions Deck for replacement mechanics.
---
...
- *E-01: ~~Perpetrator of 218 AG assassination~~ — **STRUCK (PP-675)**. Replaced by Royal Crisis Tension Card (Session C).*

...
| F3 (anti-death-spiral floor) | factions_personal §8.12: "Prevents immediate cascade; gives players a window to intervene." | Yes (Ob 4 cap at Stab ≤ 2) | **NO — safeguard mathematically inactive** at the very level it protects | **deliberate + safeguard inadequate → true finding** |

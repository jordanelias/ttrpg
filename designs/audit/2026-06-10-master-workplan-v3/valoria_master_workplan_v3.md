...
Contracts spine v1→v2 (`ebc3669`)→v2.1 (`4c474c5`)→**v3 schema-2** (`4eeabd8`; ED-1008) · module-adjudicator skill (`cdbd1b5`; ED-1005) + derived views (`53f27e1`) + **Stage-3 full-graph verdict** (`8d8a208`; ED-1009) · flatten wave maps: personal combat `6165471`, mass battle `bedbf41`/`43e33b1`, social contest `c8394f3`/`68ad7f6`, settlement `7cf5895`, faction `df48990`, fieldwork `a11e2fa`+`d10389b` · Descriptor Registry `b9d897c` (W1.13) · ecosystem reconciliation + R2 `241d96a` · session-consolidation master + handoff trio archived `59622c0`/`ebfdd10` · **Godot conversion strategy** `b42aa03` · W1.7-trim + D-3 mechanism **approved** `3da2d9a` · voice-canon extraction `d8eeab9`/`b25a08f` · mass-battle revamp scoping `46592eb` · OWN-5 cascade built `5a8a546` (ED-1000/1001) · R4/R7 hooks `26b5ece`/`0301d06` · victory corrections (GD-1 sole victory; ED-306/107 deprecated; MS=60) `5c1b8cf`/`de08065`/`2edf643` · 06-09 W-wave (W0.1, W0.3–0.5, W0.7–0.8, W1.4–1.5).

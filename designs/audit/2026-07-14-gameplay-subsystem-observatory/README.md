...
| **`remediation_plan_v1.md`** | **The resolution program (PROPOSED, ED-IN-0065, Fable-authored)** — 7 phases sequencing every finding to EXECUTED/RULED/CLASSIFIED: instrument hardening → decision docket D1–D14 (needs_jordan) → CTC sweep → flag-gated wiring → hub grounding → the Field/Gauge + convergence keystone → certification rerun. Merging ratified structure only; all rulings held back. |

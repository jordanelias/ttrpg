...
| **`remediation_plan_v1.md`** | **The resolution program (PROPOSED, ED-IN-0066 — renumbered off a #139 collision, Fable-authored)** — 7 phases sequencing every finding (incl. PR #139's) to EXECUTED/RULED/CLASSIFIED: instrument hardening → decision docket D1–D16 (needs_jordan) → CTC sweep → flag-gated wiring → hub grounding → the Field/Gauge + convergence keystone → certification rerun. Merging ratifies structure only; all rulings held back. |

...
```mermaid
flowchart TD
    A["Final operation: Coherence −1 → 0\nRendering expands past human epistemic limits\nVaynard's understanding of Thread reality: direct, constitutive\nHis goals, relationships, drives: intact\nThe version of them he now holds: beyond human reception\nHe is still Vaynard · He is also Other"] --> B["Immediate practical situation:\nTK 5 understanding now direct perception not structural theory\nSouthernmost access: he can see exactly what is needed\nSuccession leverage: he understands its Thread-configurational weight precisely\nCollection: originary Locks visible as what they actually are\nHe cannot fully convey any of this to anyone without TS near his register"]
    B --> C{Physical transformation choice}
    C -->|"Remains in human form"| D["Most capable intelligence asset in campaign\nOperates from epistemic position no interlocutor can audit\nEvery assessment: correct and unverifiable\nShapes communication to what each person can receive\n(knows exactly what each person can hold)\nPlayers must decide: act on his recommendations or not\nThere is no way to independently confirm them at human TS levels"]
    D --> E["Political function shifts:\nCannot testify effectively in Parliament\n(exceeds the epistemic context of the proceedings)\nCan brief individual practitioners who can receive part of what he says\nSocial rolls at impaired effectiveness (−1D per exchange where his full understanding would be relevant)\nbut this is legibility failure on the listeners' side, not his\nHe knows exactly what he is saying\nThey receive a fraction of it"]
    D --> F["Succession leverage: he holds it with complete understanding\nof what it actually means at the Thread-configurational level\nThis means he knows whether Torben's ratification\nactually accomplishes what it was supposed to accomplish\nor whether that goal was always a proxy for something larger\nThe players may get an answer to the succession question\nthat is correct and that they cannot fully interpret\n[EDITORIAL: what does Vaynard now understand the succession to actually mean?]"]
    C -->|"Works himself beyond human form\n(Thread-operational choice, full understanding)"| G["Physical form extends past human categories\nPresent at Eisengrund with the Collection\nNot threatening · not hostile\nOperating at a register that occupies the site\nthe way understanding occupies a mind\nThread-configurational influence on T9–T13 corridor:\nnot interference · expression\nOperations aligned with his Intentionality: assisted\nHe is still making consequentialist assessments\nThe consequences he is assessing now span registers humans cannot follow"]
    G --> H["Communication still possible:\nPractitioners who Leap into contact engage his Intentionality directly\nHe can convey what they can receive\nHe cannot convey what exceeds their epistemic limits\nHe is patient about this in a way he was never patient as a duke\nHe has time in a sense he did not have before\nThe urgency that drove him to this point is gone\nnot because the goals are accomplished\nbut because he can see the full configurational picture\nand urgency was always a human response to partial knowledge"]
    H --> I["EXTREME: Vaynard communicates to players what the Ceiral Ritual actually requires\nNot the procedural prerequisites (those are known)\nbut what it actually means at the Thread-configurational level\nwhat it is doing to the substrate\nwhat its completion produces that no human practitioner has been able to perceive\nThis information is accurate · partially receivable\nPlayers act on the fraction they can hold\nThe fraction is enough\nbecause he shaped it for exactly what they can receive"]
```
...
```mermaid
flowchart TD
    A["Coherence 0 — Almud's rendering expands past human epistemic limits\nHe can see the Thread-configurational structure\nof what governance, succession, and Einhir justice actually are\nHe still holds all three Beliefs\nBut the version of them he now holds is at a register\nno councillor, no Parliament, no Ehrenwall can follow"] --> B["Immediate situation:\nHe is physically present · recognisably the king\nConversations: responsive but not quite to the question asked\nHis attention rests on Thread-configurational space\nbehind the people he is addressing\nNon-practitioners: 'present and absent simultaneously'\nPractitioner PCs: perceive the full asymmetry immediately"]
    B --> C{Does Almud choose transformation}
    C -->|"Remains in human form"| D["Formal governance continues\nVirtue Ethics framework: intact (public, honourable actions −1 Ob)\nDecrees signed · Parliament attended\nEvery institutional act performed with awareness\nof its Thread-configurational implications at a register\nhis councillors cannot access\nHe is a king who sees what kingship is built on\nand continues building anyway because it still matters\njust differently than it mattered before"]
    D --> E["Torben's ratification:\nAlmud now understands what it means at substrate level\nHe ratifies with complete understanding\nCannot convey that understanding to Torben\nHe can be his father and know things about\nwhat his son represents in Valoria's Thread-configurational reality\nthat Torben will never know\nThe love is intact · The asymmetry is total · This is the arc"]
    D --> F["Ehrenwall: asks him directly whether the institution is failing\n(she always asks this, in her own way)\nAlmud's answer is the most complete answer she has ever received\nShe understands it as consequence-framed evidence\nbecause that is her resonance · she receives the fraction shaped for her\nShe stands down from coup readiness\nNot because she was persuaded · because she was answered\nThe answer was shaped for exactly what she could hold"]
    C -->|"Chooses Thread-operational transformation\n(with full understanding of what this means)"| G["Steps away from throne formally\n'Valoria requires a human king. I can be something more useful.'\nSuccession fires: Torben Loyalty Clock status determines path\nEhrenwall convenes Privy Council: constitutional, orderly\nAlmud present in Valorsplatz · working himself into a register\nthat occupies the city's institutional Thread-significance\nas understanding occupies the structures built on it"]
    G --> H["Players can reach him throughout the succession process\nEach contact: he conveys what they can receive\nPrecisely what they need · not more\nHe has shaped the communication for their epistemic limits\nwith complete knowledge of what those limits are\nand what they can do with what fits within them\nThe succession crisis, the Altonian question, the Einhir resolution —\nhe can see all of it\nHe gives them the map to the fraction of the terrain they can navigate"]
    H --> I["EXTREME:\nAlmud and Vaynard (if both transformed) are present in the same corridor\nTwo beings who now render at beyond-human registers\nwith Intentionalities that were always compatible\n(Order and Information were never opposed)\nThey can communicate with each other fully\nPlayers who Leap into contact with either one\nreceive communication shaped by two independent understandings\nof the same Thread-configurational reality\ncommunicated at exactly the epistemic limit of each player\nThis is the most accurate strategic picture any player has ever had\nand the least they have ever been able to independently verify"]
```
...
```mermaid
flowchart TD
    A["Coherence 0 in private\nRendering expands past human epistemic limits\nLenneth understands the Forgetting directly\nCan render what the Church has suppressed for 245 years\nLiberty Conviction intact · version of it now beyond human reception\nHidden networks: still active\nArchive document: in her possession · she now understands it from the inside"] --> B["Concealment cover:\nQueenship as surface · performance intact for non-practitioners\nPlayers interacting with her:\nFirst exchange: something they cannot name\nThird exchange: they know something has changed\nShe answers questions they have not asked\nShapes responses for exactly what each person can hold"]
    B --> C{"Is she discovered?"}
    C -->|"No immediate discovery\nConcealment holds"| D["Revolution funding: no longer strategic · expression\nDirected by perception of Thread-configurational needs\nScholars produce uncannily accurate research\naddressing exactly what Southernmost recovery requires\nThey do not know why their focus has become precise\nThe direction arrived with the funding"]
    D --> E["Players seek her out (or she finds them)\nShe knows they will need certain information\nShe has already shaped it for what they can hold\nAxis 2 (Knowledge: Thread truth accessible vs suppressed):\nLenneth is the most complete source of Thread-historical knowledge\nin the kingdom and she is still in the Royal Court\nstill the queen · still completely incomprehensible\nin ways that feel like understanding rather than confusion"]
    D --> F["Archive document:\nPractitioner in same room perceives configurational proximity\nbetween Lenneth and document — not co-extension\nbut the relationship of a practitioner to the text\nthat first opened their rendering\nnow at 245 years' depth\nShe is the continuation of that author's understanding\nThe document in her presence is the closest thing\nto the Einhir inner tradition that currently exists\nAnyone who wants to understand what the Southernmost is\nshould speak to her\nShe will tell them exactly as much as they can receive"]
    C -->|"Almud discovers"| G["Timing determines the shape of the scene\nAlmud pre-Coherence 0: receives the fraction she shapes for him\nAlmud post-Coherence 0: they communicate fully\nPlayers present: receive the fraction shaped for them"]
    G --> H{Almud's Coherence state}
    H -->|"Almud Fragmented or Intact"| I["He learns she found the path\nShe was right · she paid the price · she is still there\nCo-authored Beliefs (urgency not calculation):\nHe acts on what he learns\nHe stops calculating whether the action is affordable\nHe acts on the Einhir question\nThis is the political pivot that his second Belief\nwas always oriented toward\nHe does it because she showed him it was possible\nand he can still be the one who does it in human-legible form\nbecause he is still human enough to act in human-legible form\nShe is not · but he can be · and that is how the path completes"]
    H -->|"Almud also at Coherence 0"| J["Two beings who render past human limits\nThey can say everything to each other\nPlayers present receive the fraction shaped for them\nDeliberately · precisely · with full knowledge\nof what each person in the room can hold\nThe conversation between Almud and Lenneth at Coherence 0\nis the most complete exchange in the campaign\nand the least of it is receivable by anyone else\nWhat the players receive is what they need for the endgame\nShaped by two people who love them\nand can see exactly what they need\nand have not stopped being the people who would give it to them"]
    I --> K["EXTREME:\nAlmud acts on Einhir question (his second Belief, finally expressed)\nLenneth's networks provide the infrastructure\n(Revolution academic work · archive knowledge · practitioner contacts)\nHe acts in human-legible form · she provides what exceeds human legibility\nThe political act the campaign has been building toward\narises from two people acting together\none of whom is still human enough to be the one who acts\none of whom can see what the act means at a level\nno human political structure will ever formally record"]
```

...
*Process offline between sessions. Fill in order. Do not skip steps.*
*Season: _______ Year: _______ Date processed: _______*
...
|--------|------|---------|--------|
| Passive drift | +1 per 4 seasons | Y / N | _____ |
| Each active Gap | +4/season | × ___ gaps | _____ |
| Each active Lock (chronic drift) | −1 to −2/season | × ___ locks | _____ |
...
- Crossed 80 (Rupturing): All Thread ops +2 Ob — applies next session
- Crossed 100: Rupture — Campaign event

*Threshold event note (what does crossing look like in this world state?):*
...
|---------|------------------|--------|-----------|----------------|
| Crown | ___ | ___ | | _____ |
| Church | ___ | ___ | | _____ |
| Hafenmark | ___ | ___ | | _____ |
| Varfell | ___ | ___ | | _____ |
| Guilds | ___ | ___ | | _____ |
| Revolution | ___ | ___ | | _____ |

*Mandate 0 fail? → Faction Fracture. Note which faction:* _______

---

## STEP 6 — KNOT STRAIN INCREMENTS
*Advance strain for each practitioner's Knots based on current Coherence band.*

| Practitioner | Coherence Band | Strain Rate | Knots Affected | New Strain |
|-------------|---------------|-------------|----------------|------------|
| | Stable (10–8) | +0 | | |
| | Dissonant (7–5) | +1/3 sessions | | |
| | Fragmented (4–3) | +1/2 sessions | | |
| | Fractured (2) | +1/session | | |
| | Severed (1) | +2/session | | |

*Knots at breaking strain? Note for narrative scenes:* _______

---

## STEP 7 — COHERENCE RECOVERY
*Apply only if practitioner took no Thread ops in final session of this season.*

| Practitioner | Qualifying? | +1 Coherence | Anchoring Scene this season? | +1 Coherence |
|-------------|-------------|--------------|------------------------------|--------------|
| | Y / N | | Y / N (Bonds TN7 Ob2 rolled?) | |
...
## STEP 9 — DOMAIN ACTION RESOLUTIONS
*List any Domain Actions with delayed seasonal effects:*

| Action | Faction | Effect | Applies to which stat |
|--------|---------|--------|----------------------|
| | | | |
| | | | |
...
Notable events this accounting: _______________________________
Next session opening hook: ____________________________________

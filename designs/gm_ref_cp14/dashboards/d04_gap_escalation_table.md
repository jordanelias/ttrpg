...
## GAP ESCALATION BY AGE (seasons unaddressed)
...
## DISSOLUTION RESIDUE FROM GAPS

| Situation | Residue Formed |
|-----------|---------------|
...
## SHIFTING OBJECT STABILISATION

- **Weaving (Object scale, Ob 2):** arrests deterioration
- **Overwhelming:** restores full actualization
- **Certainty cost to non-practitioner witnesses:** −1 on first witnessing (Spirit TN 7 Ob 1 to resist)
- **Deterioration without intervention:** becomes Gap within 1d3 seasons; residue forms at edges each season it persists

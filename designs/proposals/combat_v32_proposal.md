...
A set bonus applies only while its equipped aspects are present; partial sets grant nothing (no graded partial bonus — a set is coherent or it is not, which keeps the build legible). Set-bonus magnitudes draft; sim-tunable Phase 14.

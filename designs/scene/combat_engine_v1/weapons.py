...
WEAPONS = {
 ...
 'dagger': dict(
   ...
   reach='short', wt='light', spd=3.0, percussion=1, pob_frac=0.07, hand='Forgiving'),   # PRIMITIVE-AUDIT [G]: pob_frac 0.25->0.07 — reproductions cluster 0.04-0.10; 0.25 overstated commit-cost / understated lunge
 'paired_short': dict(

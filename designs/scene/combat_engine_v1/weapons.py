...
WEAPONS = {
 ...
 'spear':    dict(reach='long', wt='light', hands=2, head='point',  spd=0.0, hand='Forgiving', gap=0.70, head_len=5.5, grip_len=1.2, hand_guard=0.10, blade_guard=0.20, clinch=2, percussion=1, mass=2.0, pob_frac=0.42),
 'staff':    dict(reach='long', wt='light', hands=2, head='blunt',  spd=0.0, hand='Forgiving', gap=0.20, head_len=2.8, grip_len=2.8, hand_guard=0.15, blade_guard=0.30, reach_adj=0.5, clinch=3, percussion=4, mass=1.5, pob_frac=0.05),

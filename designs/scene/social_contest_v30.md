...
The basic Wager resolution table covers Condition Met / Not Met / Partial. Three edge cases require explicit handling:
...
**Special case — PC death holding Wager Obligation:** If the PC dies while holding an outstanding Wager Obligation toward an NPC, the Obligation transfers to the PC's Heir per character_histories §Heir mechanism if a designated Heir exists. Without an Heir: Obligation discharges neutrally (no benefit, no penalty). The Wager-bound NPC's Disposition with the Heir starts at the Disposition value the deceased PC had with the NPC, capped at +2 (the Heir is not the same person and inherits the Obligation's institutional weight, not the personal relationship).

**Special case — PC death owing Wager Obligation:** If the PC dies while OWING a Wager Obligation toward an NPC (the PC was the loser of the Grand Contest who committed to a future condition), the Obligation discharges as **failure-by-incapacitation**. The NPC counterparty receives a one-time gain: their faction Mandate +1 (institutional benefit from the deceased PC's failure to deliver). No further consequences pursue the PC's Heir or estate.

...
<!-- [RECONCILED 2026-05-30, session 801b97c5: Intel column added per canonical 7-stat schema (ED-787; values from params/factions/stats_1_7_scale.md — Crown 3, Church 4, Hafenmark 3, Varfell 4, Löwenritter 3, Guilds 4). Gap-fill only; existing values untouched. RESOLVED (ED-869, Jordan 2026-05-31, one day after this note was written): Crown Military = 5/6 (fields the Löwenritter) — see params/factions/stats_1_7_scale.md's own inline note. This footnote corrected 2026-07-08 (ED-IN-0029 docket, OPT-AV-7) — it was stale relative to its own cited resolution, still reading "UNRESOLVED" a month after ED-869 closed. ] -->

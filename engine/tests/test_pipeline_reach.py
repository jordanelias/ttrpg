...
def test_direction7b_temporal_decay_is_a_declared_deferral():
    ...
    doc_path = os.path.join(_REPO_ROOT, ".designs", "systems", "_architecture", 'reference', "propagation_spec_v1.md")  # ED-IN-0231: quarantined; archive mirrors the tree. ONE LINE: anchors cite lines below.

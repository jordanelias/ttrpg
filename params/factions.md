...
<!-- [PP-686 v2 NOTE 2026-05-01] Faction architecture superseded by designs/provincial/faction_behavior_v30.md (Mission/Cascade/Public Expectation/Legitimacy+Popular Support 4-component model). Existing sub-file headings referencing "Ethical Framework Ob Modifiers" (params_factions_stats_1_7_scale.md heading L48 area) are SUPERSEDED per SUPERSESSION-PP686-001; replaced by triadic Ob decomposition in faction_behavior_v30 §3.7. Sub-file content updates pending Phase B per faction_behavior_v30 §6.2. -->

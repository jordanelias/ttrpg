...
|---|---|---|---|---|---|
| **`Container`** | `ARCH §2.1` | a rung of the containment tree | **pass** | **pass** | **ADOPTED.** `SUP:337` already writes *"Container (a rung)"*; `Node` was a third name **and** collides with Godot's scene-tree base class at `godot/scene_tree_architecture.md:15`, the port target |

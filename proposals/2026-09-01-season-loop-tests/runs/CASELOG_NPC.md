...
*person · 10 rows, 6 core · blockers: A32, P22*
...
| A single scene of investigation, discovery, or protection involving her must be able to permanently change a persistent fact about her (protected / exposed / arrested / dead) that carries fo | `P17` | **FORBIDDEN** | S22.4 |
...
| A prior personal relationship formed years earlier (guarding an archive for someone she has since stayed connected to) must be able to resurface and pull her into a scene later, creating a g | `P40` | PASS | S15 |
...
| His institutional loyalty and the effect of his actions must be able to diverge permanently without him ever consciously betraying or defecting from his employer. | `P17` | **FORBIDDEN** | S22.4 |
...
| A designated successor to a faction leader must exist as a real, trackable status -- with defined behavioral constraints relative to the current leader -- well before succession ever actuall | `F13` | **FORBIDDEN** | S3-L4 |
...
| The settlement's overall pressure must rise on its own when demands go unmet and fall when the governor resolves them, so that an ignored settlement escalates and a well-managed one still ke | `P17` | **FORBIDDEN** | S22.4 |
...
## NPC-071 — Torvi Heljason  ·  **BLOCKED**
*person · 6 rows, 2 core · blockers: P41*
...
| need | probe | verdict | § |
|---|---|---|---|
| **[core]** An advisor whose sole articulated commitment is precedent and consistency must have every persuasive approach toward her scored differently depending on whether it appeals to established rul | `P41` | **UNSPECIFIED** | S2 T7 |
...
| need | probe | verdict | § |
|---|---|---|---|
| **[core]** This person's confidentiality obligation to the council he sits on must be able to come into direct tension with his reporting obligation to his true master, such that honoring one at some p | `P40` | PASS | S15 |
| A third party must be able to discover which of his two loyalties actually governed a specific past action of his, and that discovery must damage his standing in the institution he was seen  | `F3` | **FORBIDDEN** | S3-L1 |
| This office-holder must be able to hold an automatic, standing hostile bias toward one category of person (Thread practitioners) that does not itself depend on which of his two loyalties is  | `W3` | **UNSPECIFIED** | S30 |
...
*realm · 11 rows, 5 core · blockers: F6*
...
| A future succession must be able to remain genuinely unsettled for the leader's whole reign, contested among parties with different bases of claim, none of which the leader can fully foreclo | `F13` | **FORBIDDEN** | S3-L4 |
...
| A person's capacity for a certain kind of perception must be able to be permanently foreclosed by their institutional belief system, reachable again only through a shock external to ordinary | `P17` | **FORBIDDEN** | S22.4 |
...
*faction · 8 rows, 3 core · blockers: P10, P14*
...
## NPC-052 — Magnus Vaynard  ·  **BLOCKED**
*faction · 8 rows, 3 core · blockers: F13*
...
| **[core]** If this leader is removed from play, the identity of his successor must be able to remain genuinely undetermined among several qualified claimants, with the outcome capable of splitting his  | `F13` | **FORBIDDEN** | S3-L4 |
...
| Even after the movement gains a formal seat, it must remain permanently excluded from a category of formal political action available to every incumbent institution, marking it as structural | `P17` | **FORBIDDEN** | S22.4 |
...
| Ascending to supreme authority through this path must be able to instantly and permanently redefine what the ruling institution stands for, flipping an ambient, privately-held policy uncerta | `P17` | **FORBIDDEN** | S22.4 |
...
## NPC-031 — Torben Almqvist  ·  **BLOCKED**
*realm · 8 rows, 3 core · blockers: P17*
...
| need | probe | verdict | § |
|---|---|---|---|
| **[core]** Once the heir's alignment locks in, whether through successful investment or through the window simply expiring, it must become permanently unresponsive to further investment or victories fr | `P17` | **FORBIDDEN** | S22.4 |
...
| need | probe | verdict | § |
|---|---|---|---|
| **[core]** A hostile foreign power must be able to hold a standing coercive threat over the home polity purely through possession of a person, without ever needing to act on the threat, and that threat | `F3` | **FORBIDDEN** | S3-L1 |
...
| A commitment made to her, once accepted and later fulfilled, must be able to permanently raise her tolerance for future provocation from that specific party, so the relationship is demonstra | `P17` | **FORBIDDEN** | S22.4 |
...
| need | probe | verdict | § |
|---|---|---|---|
| **[core]** A person holding a specific named Crown command post must be able to exist as more than an identity record -- the post itself must be able to affect what the Crown can materially do in a sea | `F4` | PASS | S11.1 |
...
| A person whose title marks her as keeper or transmitter of a people's oral history must be able to make that memory available to others -- recount precedent, confirm or deny a claimed lineag | `P41` | **UNSPECIFIED** | S2 T7 |
...
## NPC-081 — Uta Falkenrath  ·  **BLOCKED**
*faction · 8 rows, 2 core · blockers: F13*
...
| need | probe | verdict | § |
|---|---|---|---|
| **[core]** A polity's highest office must be able to become vacant through its sitting holder's fall (defeat, death, removal), triggering a competition among multiple named candidates for succession. | `F13` | **FORBIDDEN** | S3-L4 |
| **[core]** Among the paths available to win a succession contest, one path must be able to run specifically through broad popular support, distinct from and tracked separately from elite or institution | `F13` | **FORBIDDEN** | S3-L4 |
...
| A seat-holder's recorded convictions must be able to bias which side of a commune-versus-city dispute, or which succession candidate, she supports, in a way a third party can anticipate. | `F13` | **FORBIDDEN** | S3-L4 |
| A seat-holder marked as not-yet-canonical must already carry a specific succession-eligibility flag that persists and matters if the triggering condition is ever authored into play. | `F13` | **FORBIDDEN** | S3-L4 |
...
## NPC-085 — Nessa Grindvold  ·  **BLOCKED**
*faction · 7 rows, 2 core · blockers: P41*
...
| need | probe | verdict | § |
|---|---|---|---|
| **[core]** An advocate must be able to cite established precedent or a prior ruling to strengthen a present argument, with correctly-applicable precedent measurably improving her odds relative to argui | `P41` | **UNSPECIFIED** | S2 T7 |
...
## NPC-090 — Stephanos Doukas  ·  **DEGRADED**
*faction · 7 rows, 2 core · blockers: none*
*ends when:* never specified -- an ongoing regulatory-enforcement role with no authored end condition

| need | probe | verdict | § |
|---|---|---|---|
| **[core]** A trade relationship between two polities must be able to be governed by a specific pre-existing treaty whose terms constrain what either side's trade officials can unilaterally change, such | `F20` | PASS | S14 |
| **[core]** Two named officials from different polities must be able to interact directly and repeatedly over the same ongoing trade relationship, with each one's individual choices -- strict enforcemen | `P39` | PASS | S15 |
| A trade official's recorded conviction toward established precedent and order must be able to bias him toward strict, by-the-letter enforcement of old treaty terms even where a more flexible | `P41` | **UNSPECIFIED** | S2 T7 |
| The regulated trade interface must be able to generate a specific, resolvable dispute -- a violation, a disputed toll, a smuggling attempt, a request for an exception -- that the two counter | `F20` | PASS | S14 |

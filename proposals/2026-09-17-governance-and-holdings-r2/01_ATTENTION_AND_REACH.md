...
| *"`references/id_reservations.yaml:246` — `IN: { next_free: 233 }`"* | **`next_free: 236`.** The bump has already landed on the working tree: *"ED-IN-0236..0235 allocated 2026-09-17 … next_free 231->236"* (`:246`), and `SE` reads `next_free: 54` (`:257`) | a session re-allocates 233 and collides with this document. **The plan's §9 measurement was taken pre-bump; ED-IN-0233 is mine and is already reserved.** This file touches no ledger |

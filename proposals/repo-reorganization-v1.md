...
| 5 | `godot/` vs `godot/` | Same subsystem, two folders + a 3rd home (`godot/`) | Pure accretion — three homes for one port. |
...
2. **P1 — Promote easy primaries**: `workplans/`, `proposals/`, `arcs/`, `dashboard/`, `research/` (+`research/historical`), `infrastructure/` (`skills`+`tools`).

...
| `designs/board_game/faction_layer_v30.md` | `systems/factions/reference/faction_layer_v30.md` | PENDING |
| `designs/board_game/faction_layer_v30_infill.md` | `systems/factions/reference/faction_layer_v30_infill.md` | PENDING |
| `designs/board_game/faction_layer_v30_skeleton.md` | `designs/provincial/faction_layer_v30_skeleton.md` | PENDING |
| `designs/board_game/fail_forward_pp177_2026-04-02.md` | `systems/factions/reference/fail_forward_pp177.md` | PENDING |
...
| `designs/board_game/varfell_path_b_v30.md` | `systems/factions/reference/varfell_path_b_v30.md` | PENDING |
| `designs/board_game/varfell_path_b_v30_infill.md` | `systems/factions/reference/varfell_path_b_v30_infill.md` | PENDING |
...
| `designs/contest/social_contest_system_v2.md` | `systems/social_contest/reference/social_contest_system_v2.md` | PENDING |
| `designs/contest/social_contest_system_v2_skeleton.md` | `designs/scene/social_contest_system_v2_skeleton.md` | PENDING |
| `designs/contest/social_contest_v30.md` | `systems/social_contest/reference/social_contest_v30.md` | PENDING |
| `designs/contest/social_contest_v30_infill.md` | `systems/social_contest/reference/social_contest_v30_infill.md` | PENDING |
...
| `designs/fieldwork/fieldwork_bg_v30.md` | `systems/fieldwork/reference/fieldwork_bg_v30.md` | PENDING |
| `designs/fieldwork/fieldwork_bg_v30_infill.md` | `systems/fieldwork/reference/fieldwork_bg_v30_infill.md` | PENDING |
| `designs/fieldwork/fieldwork_editorial.md` | `systems/fieldwork/reference/fieldwork_editorial.md` | PENDING |
| `designs/fieldwork/fieldwork_exploration.md` | `systems/fieldwork/reference/fieldwork_exploration.md` | PENDING |
| `designs/fieldwork/fieldwork_exposure.md` | `systems/fieldwork/reference/fieldwork_exposure.md` | PENDING |
| `designs/fieldwork/fieldwork_godot.md` | `systems/fieldwork/reference/fieldwork_godot.md` | PENDING |
| `designs/fieldwork/fieldwork_hybrid_v30.md` | `systems/fieldwork/reference/fieldwork_hybrid_v30.md` | PENDING |
| `designs/fieldwork/fieldwork_hybrid_v30_infill.md` | `systems/fieldwork/reference/fieldwork_hybrid_v30_infill.md` | PENDING |
| `designs/fieldwork/fieldwork_investigation.md` | `systems/fieldwork/reference/fieldwork_investigation.md` | PENDING |
| `designs/fieldwork/fieldwork_rationale.md` | `systems/fieldwork/reference/fieldwork_rationale.md` | PENDING |
| `designs/fieldwork/fieldwork_socializing.md` | `systems/fieldwork/reference/fieldwork_socializing.md` | PENDING |
| `designs/fieldwork/fieldwork_summary.md` | `systems/fieldwork/reference/fieldwork_summary.md` | PENDING |
| `designs/fieldwork/fieldwork_v30.md` | `systems/fieldwork/reference/fieldwork_v30.md` | PENDING |
| `designs/fieldwork/fieldwork_v30_infill.md` | `systems/fieldwork/reference/fieldwork_v30_infill.md` | PENDING |
...
| `designs/hybrid/hybrid_gaps_v30.md` | `systems/_architecture/reference/hybrid_gaps_v30.md` | PENDING |
| `designs/hybrid/hybrid_gaps_v30_infill.md` | `systems/_architecture/reference/hybrid_gaps_v30_infill.md` | PENDING |
| `designs/hybrid/scale_transitions_v30.md` | `systems/_architecture/reference/scale_transitions_v30.md` | PENDING |
| `designs/hybrid/scale_transitions_v30_infill.md` | `systems/_architecture/reference/scale_transitions_v30_infill.md` | PENDING |
| `designs/hybrid/scale_transitions_v30_skeleton.md` | `systems/_architecture/scale_transitions_v30_skeleton.md` | PENDING |
| `designs/mass_combat/mass_battle_v30.md` | `systems/mass_battle/reference/mass_battle_v30.md` | PENDING |
| `designs/mass_combat/mass_battle_v30_infill.md` | `systems/mass_battle/reference/mass_battle_v30_infill.md` | PENDING |
| `designs/mass_combat/mass_battle_v30_skeleton.md` | `designs/provincial/mass_battle_v30_skeleton.md` | PENDING |
| `designs/mechanics/baralta_crown_claim_v30.md` | `systems/factions/reference/baralta_crown_claim_v30.md` | PENDING |
| `designs/mechanics/baralta_crown_claim_v30_infill.md` | `systems/factions/reference/baralta_crown_claim_v30_infill.md` | PENDING |
| `designs/setting/adjacency_map.jsx` | `systems/world/adjacency_map.jsx` | PENDING |
| `designs/setting/calamity_radiation_v30.md` | `systems/world/reference/calamity_radiation_v30.md` | PENDING |
| `designs/setting/calamity_radiation_v30_infill.md` | `systems/world/reference/calamity_radiation_v30_infill.md` | PENDING |
| `designs/setting/geography_v30.md` | `systems/world/reference/geography_v30.md` | PENDING |
| `designs/setting/geography_v30_infill.md` | `systems/world/reference/geography_v30_infill.md` | PENDING |
| `designs/setting/southernmost_v30.md` | `systems/world/reference/southernmost_v30.md` | PENDING |
| `designs/setting/southernmost_v30_infill.md` | `systems/world/reference/southernmost_v30_infill.md` | PENDING |
...
| `designs/systems/campaign_architecture_v1.md` | `systems/_architecture/reference/campaign_architecture_v30.md` | PENDING |
| `designs/systems/campaign_modes_v30.md` | `systems/_architecture/reference/campaign_modes_v30.md` | PENDING |
| `designs/systems/campaign_modes_v30_infill.md` | `systems/_architecture/reference/campaign_modes_v30_infill.md` | PENDING |
| `designs/systems/canonical_registry_r2_2026-04-15.md` | `systems/_architecture/reference/canonical_registry.md` | PENDING |
...
| `designs/systems/cogload_moderate_target.md` | `systems/_architecture/reference/cogload_moderate_target.md` | PENDING |
| `designs/systems/companion_app_design_note_2026-04-04.md` | `systems/_architecture/reference/companion_app_design_note.md` | PENDING |
| `designs/systems/companion_specification_v30.md` | `systems/npcs/reference/companion_specification_v30.md` | PENDING |
| `designs/systems/complete_systems_reference_r2_2026-04-15.md` | `systems/_architecture/reference/complete_systems_reference.md` | PENDING |
...
| `designs/systems/faction_politics_expanded_v1.md` | `systems/factions/reference/faction_politics_v30.md` | DONE (2026-07-08, ED-IN-0016 — file move already complete, old path long gone; citation-repointing half executed this pass across the live corpus) |
...
| `designs/systems/integration_proposal_2026-04-15.md` | `systems/_architecture/reference/integration_proposal_v30.md` | PENDING |
...
| `designs/systems/investigation_systems_proposal_2026-04-15.md` | `systems/fieldwork/reference/investigation_systems_v30.md` | PENDING |
...
| `designs/systems/military_layer_v30.md` | `systems/mass_battle/reference/military_layer_v30.md` | PENDING |
| `designs/systems/military_layer_v30_skeleton.md` | `designs/provincial/military_layer_v30_skeleton.md` | PENDING |
| `designs/systems/npc_behavior_system_v1.md` | `systems/npcs/reference/npc_behavior_system_v1.md` | PENDING |
| `designs/systems/npc_behavior_system_v1_skeleton.md` | `systems/npcs/npc_behavior_system_v1_skeleton.md` | PENDING |
| `designs/systems/npc_behavior_v30.md` | `systems/npcs/reference/npc_behavior_v30.md` | PENDING |
| `designs/systems/npc_behavior_v30_infill.md` | `systems/npcs/reference/npc_behavior_v30_infill.md` | PENDING |
| `designs/systems/npc_behavior_v30_skeleton.md` | `systems/npcs/npc_behavior_v30_skeleton.md` | PENDING |
| `designs/systems/player_agency_v30.md` | `systems/_architecture/reference/player_agency_v30.md` | PENDING |
| `designs/systems/player_agency_v30_skeleton.md` | `systems/_architecture/player_agency_v30_skeleton.md` | PENDING |
| `designs/systems/settlement_layer_v30.md` | `systems/settlements/reference/settlement_layer_v30.md` | PENDING |
...
| `designs/systems/thread_horizontal_integration_spec.md` | `systems/threadwork/reference/thread_horizontal_integration_spec.md` | PENDING |
...
| `designs/ttrpg/edeyja_npc.md` | `systems/npcs/reference/edeyja_npc.md` | PENDING |
| `designs/ttrpg/factions_ttrpg_v30.md` | `systems/factions/reference/factions_personal_v30.md` | PENDING |
| `designs/ttrpg/factions_ttrpg_v30_infill.md` | `systems/factions/reference/factions_personal_v30_infill.md` | PENDING |
| `designs/ttrpg/factions_ttrpg_v30_skeleton.md` | `designs/provincial/factions_personal_v30_skeleton.md` | PENDING |
| `designs/ttrpg/threadwork_philosophical_reference_v30.md` | `systems/threadwork/reference/threadwork_philosophical_reference_v30.md` | PENDING |
| `designs/ttrpg/threadwork_philosophical_reference_v30_infill.md` | `systems/threadwork/reference/threadwork_philosophical_reference_v30_infill.md` | PENDING |
| `designs/ttrpg/threadwork_redesign_v25.md` | `systems/threadwork/reference/threadwork_v25_historical.md` | PENDING |
| `designs/ttrpg/threadwork_redesign_v25_skeleton.md` | `systems/threadwork/threadwork_v25_historical_skeleton.md` | PENDING |
| `designs/ttrpg/threadwork_v30.md` | `systems/threadwork/reference/threadwork_v30.md` | PENDING |
| `designs/ttrpg/threadwork_v30_infill.md` | `systems/threadwork/reference/threadwork_v30_infill.md` | PENDING |
...
| `designs/worldbuilding/worldbuilding_canon_audit_v30.md` | `systems/world/reference/worldbuilding_canon_audit_v30.md` | PENDING |
| `designs/worldbuilding/worldbuilding_canon_audit_v30_infill.md` | `systems/world/reference/worldbuilding_canon_audit_v30_infill.md` | PENDING |
| `designs/worldbuilding/worldbuilding_v30.md` | `systems/world/reference/worldbuilding_v30.md` | PENDING |
| `designs/worldbuilding/worldbuilding_v30_infill.md` | `systems/world/reference/worldbuilding_v30_infill.md` | PENDING |
...
| `references/videogame_mode_spec.md` | `systems/_architecture/reference/videogame_mode_spec.md` | PENDING |
...
| old path | new path |
|---|---|
| `designs/scene/fieldwork_bg_v30.md` | `systems/fieldwork/reference/fieldwork_bg_v30.md` |
| `designs/scene/fieldwork_bg_v30_infill.md` | `systems/fieldwork/reference/fieldwork_bg_v30_infill.md` |
| `designs/scene/fieldwork_editorial.md` | `systems/fieldwork/reference/fieldwork_editorial.md` |
| `designs/scene/fieldwork_exploration.md` | `systems/fieldwork/reference/fieldwork_exploration.md` |
| `designs/scene/fieldwork_exposure.md` | `systems/fieldwork/reference/fieldwork_exposure.md` |
| `designs/scene/fieldwork_godot.md` | `systems/fieldwork/reference/fieldwork_godot.md` |
| `designs/scene/fieldwork_hybrid_v30.md` | `systems/fieldwork/reference/fieldwork_hybrid_v30.md` |
| `designs/scene/fieldwork_hybrid_v30_infill.md` | `systems/fieldwork/reference/fieldwork_hybrid_v30_infill.md` |
| `designs/scene/fieldwork_investigation.md` | `systems/fieldwork/reference/fieldwork_investigation.md` |
| `designs/scene/fieldwork_rationale.md` | `systems/fieldwork/reference/fieldwork_rationale.md` |
| `designs/scene/fieldwork_socializing.md` | `systems/fieldwork/reference/fieldwork_socializing.md` |
| `designs/scene/fieldwork_summary.md` | `systems/fieldwork/reference/fieldwork_summary.md` |
| `designs/scene/fieldwork_v30.md` | `systems/fieldwork/reference/fieldwork_v30.md` |
| `designs/scene/fieldwork_v30_index.md` | `systems/fieldwork/reference/fieldwork_v30_index.md` |
| `designs/scene/fieldwork_v30_infill.md` | `systems/fieldwork/reference/fieldwork_v30_infill.md` |
| `designs/scene/investigation_systems_v30.md` | `systems/fieldwork/reference/investigation_systems_v30.md` |
| `designs/scene/investigation_systems_v30_index.md` | `systems/fieldwork/reference/investigation_systems_v30_index.md` |
| `designs/personal/knots_v30.md` | `systems/fieldwork/reference/knots_v30.md` |
...
| old path | new path |
|---|---|
| `designs/scene/social_contest_system_v2.md` | `systems/social_contest/reference/social_contest_system_v2.md` |
| `designs/scene/social_contest_system_v2_index.md` | `systems/social_contest/reference/social_contest_system_v2_index.md` |
| `designs/scene/social_contest_v30.md` | `systems/social_contest/reference/social_contest_v30.md` |
| `designs/scene/social_contest_v30_index.md` | `systems/social_contest/reference/social_contest_v30_index.md` |
| `designs/scene/social_contest_v30_infill.md` | `systems/social_contest/reference/social_contest_v30_infill.md` |
...
| old path | new path |
|---|---|
| `designs/scene/combat_c4_draft_v0.md` | `systems/combat/reference/combat_c4_draft_v0.md` |
...
| old path | new path |
|---|---|
| `designs/provincial/mass_battle_integration_v30.md` | `systems/mass_battle/reference/mass_battle_integration_v30.md` |
| `designs/provincial/mass_battle_v30.md` | `systems/mass_battle/reference/mass_battle_v30.md` |
| `designs/provincial/mass_battle_v30_index.md` | `systems/mass_battle/reference/mass_battle_v30_index.md` |
| `designs/provincial/mass_battle_v30_infill.md` | `systems/mass_battle/reference/mass_battle_v30_infill.md` |
| `designs/provincial/military_layer_v30.md` | `systems/mass_battle/reference/military_layer_v30.md` |
| `designs/provincial/military_layer_v30_index.md` | `systems/mass_battle/reference/military_layer_v30_index.md` |
...
| old path | new path |
|---|---|
| `designs/provincial/baralta_crown_claim_v30.md` | `systems/factions/reference/baralta_crown_claim_v30.md` |
| `designs/provincial/baralta_crown_claim_v30_infill.md` | `systems/factions/reference/baralta_crown_claim_v30_infill.md` |
| `designs/provincial/ci_political_v30.md` | `systems/factions/reference/ci_political_v30.md` |
| `designs/provincial/ci_political_v30_index.md` | `systems/factions/reference/ci_political_v30_index.md` |
| `designs/provincial/faction_behavior_v30.md` | `systems/factions/reference/faction_behavior_v30.md` |
| `designs/provincial/faction_canon_v30.md` | `systems/factions/reference/faction_canon_v30.md` |
| `designs/provincial/faction_layer_v30.md` | `systems/factions/reference/faction_layer_v30.md` |
| `designs/provincial/faction_layer_v30_index.md` | `systems/factions/reference/faction_layer_v30_index.md` |
| `designs/provincial/faction_layer_v30_infill.md` | `systems/factions/reference/faction_layer_v30_infill.md` |
| `designs/provincial/faction_politics_v30.md` | `systems/factions/reference/faction_politics_v30.md` |
| `designs/provincial/faction_politics_v30_index.md` | `systems/factions/reference/faction_politics_v30_index.md` |
| `designs/provincial/faction_state_authoring_v30.md` | `systems/factions/reference/faction_state_authoring_v30.md` |
| `designs/provincial/faction_succession_split_v30.md` | `systems/factions/reference/faction_succession_split_v30.md` |
| `designs/provincial/faction_succession_split_v30_index.md` | `systems/factions/reference/faction_succession_split_v30_index.md` |
| `designs/factions/faction_systems_overview_v30.md` | `systems/factions/reference/faction_systems_overview_v30.md` |
| `designs/provincial/factions_personal_v30.md` | `systems/factions/reference/factions_personal_v30.md` |
| `designs/provincial/factions_personal_v30_index.md` | `systems/factions/reference/factions_personal_v30_index.md` |
| `designs/provincial/factions_personal_v30_infill.md` | `systems/factions/reference/factions_personal_v30_infill.md` |
| `designs/provincial/fail_forward_pp177.md` | `systems/factions/reference/fail_forward_pp177.md` |
| `designs/provincial/fractional_province_ownership_v30.md` | `systems/factions/reference/fractional_province_ownership_v30.md` |
| `designs/provincial/fractional_province_ownership_v30_index.md` | `systems/factions/reference/fractional_province_ownership_v30_index.md` |
| `designs/provincial/franchise_v30.md` | `systems/factions/reference/franchise_v30.md` |
| `designs/provincial/parliamentary_transfer_v30.md` | `systems/factions/reference/parliamentary_transfer_v30.md` |
| `designs/provincial/political_dynamics_keys_migration_v30.md` | `systems/factions/reference/political_dynamics_keys_migration_v30.md` |
| `designs/provincial/treaty_expiration_v30.md` | `systems/factions/reference/treaty_expiration_v30.md` |
| `designs/provincial/varfell_path_b_v30.md` | `systems/factions/reference/varfell_path_b_v30.md` |
| `designs/provincial/varfell_path_b_v30_infill.md` | `systems/factions/reference/varfell_path_b_v30_infill.md` |
...
| `designs/scene/derived_stats_v30.md` | `systems/_architecture/reference/derived_stats_v30.md` |
| `designs/scene/derived_stats_v30_index.md` | `systems/_architecture/reference/derived_stats_v30_index.md` |
| `designs/personal/character_generation_questionnaire_v30.md` | `systems/characters/reference/character_generation_questionnaire_v30.md` |
| `systems/world/character_histories_v30.md` | `systems/characters/reference/character_histories_v30.md` |
| `systems/world/character_histories_v30_index.md` | `systems/characters/reference/character_histories_v30_index.md` |
| `systems/world/character_histories_v30_infill.md` | `systems/characters/reference/character_histories_v30_infill.md` |
| `designs/personal/conviction_axis_matrix_v30.md` | `systems/characters/reference/conviction_axis_matrix_v30.md` |
| `designs/personal/conviction_migration_roster_v30.md` | `systems/characters/reference/conviction_migration_roster_v30.md` |
| `designs/personal/conviction_taxonomy_v30.md` | `systems/characters/reference/conviction_taxonomy_v30.md` |
| `designs/personal/conviction_track_v1.md` | `systems/characters/reference/conviction_track_v1.md` |
| `designs/personal/conviction_track_v1_pp718_vetting.md` | `systems/characters/reference/conviction_track_v1_pp718_vetting.md` |
| `designs/scene/conviction_track_v30.md` | `systems/characters/reference/conviction_track_v30.md` |
| `designs/scene/conviction_track_v30_index.md` | `systems/characters/reference/conviction_track_v30_index.md` |
| `designs/scene/conviction_track_v30_infill.md` | `systems/characters/reference/conviction_track_v30_infill.md` |
| `systems/combat/scene_combat_v1/scene_combat_design_v1.md` | `systems/combat/reference/scene_combat_design_v1.md` |
| `designs/provincial/clock_registry_v30.md` | `systems/overview/reference/clock_registry_v30.md` |
| `designs/provincial/clock_registry_v30_infill.md` | `systems/overview/reference/clock_registry_v30_infill.md` |
| `designs/provincial/peninsular_strain_v30.md` | `systems/overview/reference/peninsular_strain_v30.md` |
| `designs/provincial/peninsular_strain_v30_index.md` | `systems/overview/reference/peninsular_strain_v30_index.md` |
| `designs/provincial/victory_v30.md` | `systems/victory/reference/victory_v30.md` |
| `designs/provincial/victory_v30_index.md` | `systems/victory/reference/victory_v30_index.md` |
| `designs/provincial/victory_v30_infill.md` | `systems/victory/reference/victory_v30_infill.md` |
| `designs/scene/miraculous_event_v30.md` | `systems/world/reference/miraculous_event_v30.md` |
| `designs/conviction_track/conviction_track_v30.md` | `systems/characters/reference/conviction_track_v30.md` |
| `designs/conviction_track/conviction_track_v30_index.md` | `systems/characters/reference/conviction_track_v30_index.md` |
| `designs/conviction_track/conviction_track_v30_infill.md` | `systems/characters/reference/conviction_track_v30_infill.md` |
...
| `references/ms_budget.md` | `systems/overview/reference/ms_budget.md` |
| `references/wc_survival_spine.md` | `systems/overview/reference/wc_survival_spine.md` |
...
<!-- ⚠ PARTIAL, corrected 2026-08-21: one file under this directory is STILL ON DISK and is cited
     by live design docs — audit/2026-08-06-vector-audit/structure_audit/data/structure_metrics.json,
     referenced from systems/factions/factions_flow_skeleton_v1.md and
     systems/_architecture/engine_atlas_v1.md. The row above is correct for everything ELSE under
     that directory. Do not "complete" the fork by deleting that file without re-pointing its two
     citers first; a prefix row that contradicts the tree is how a resolver starts lying. -->
...
| old | new | STATUS |
|---|---|---|
| `systems/combat/combat_v30.md` | `systems/combat/reference/combat_reference_v1.md` | CONSOLIDATED |
| `systems/combat/combat_v30_index.md` | `systems/combat/reference/combat_reference_v1.md` | CONSOLIDATED |
| `systems/combat/combat_v30_infill.md` | `systems/combat/reference/combat_reference_v1.md` | CONSOLIDATED |
| `systems/combat/combat_design_v1.md` | `systems/combat/reference/combat_reference_v1.md` | CONSOLIDATED |
| `systems/combat/combat_design_v1_index.md` | `systems/combat/reference/combat_reference_v1.md` | CONSOLIDATED |
| `designs/combat/combat_v30.md` | `systems/combat/reference/combat_reference_v1.md` | CONSOLIDATED |
| `designs/combat/combat_v30_index.md` | `systems/combat/reference/combat_reference_v1.md` | CONSOLIDATED |
| `designs/combat/combat_v30_infill.md` | `systems/combat/reference/combat_reference_v1.md` | CONSOLIDATED |
| `designs/combat/combat_design_v1.md` | `systems/combat/reference/combat_reference_v1.md` | CONSOLIDATED |
| `designs/combat/combat_design_v1_index.md` | `systems/combat/reference/combat_reference_v1.md` | CONSOLIDATED |
...
| `references/throughlines_complete.md` | `systems/_architecture/reference/throughlines_complete.md` | RELOCATED |
...
### `systems/` design prose relocated under `reference/` (2026-09-09, ED-IN-0179)
...
| Old Path | New Path | Status |
|----------|----------|--------|
| `systems/_architecture/_architecture_flow_skeleton_v1.md` | `systems/_architecture/reference/_architecture_flow_skeleton_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/auto_manual_resolution_duality_v1.md` | `systems/_architecture/reference/auto_manual_resolution_duality_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/campaign_architecture_v30.md` | `systems/_architecture/reference/campaign_architecture_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/campaign_architecture_v30_index.md` | `systems/_architecture/reference/campaign_architecture_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/campaign_modes_v30.md` | `systems/_architecture/reference/campaign_modes_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/campaign_modes_v30_infill.md` | `systems/_architecture/reference/campaign_modes_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/canonical_registry.md` | `systems/_architecture/reference/canonical_registry.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/cogload_moderate_target.md` | `systems/_architecture/reference/cogload_moderate_target.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/cogload_moderate_target_index.md` | `systems/_architecture/reference/cogload_moderate_target_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/companion_app_design_note.md` | `systems/_architecture/reference/companion_app_design_note.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/complete_systems_reference.md` | `systems/_architecture/reference/complete_systems_reference.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/conflict_architecture_proposal.md` | `systems/_architecture/reference/conflict_architecture_proposal.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/decision_policy_v1.md` | `systems/_architecture/reference/decision_policy_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/derived_stats_v30.md` | `systems/_architecture/reference/derived_stats_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/derived_stats_v30_index.md` | `systems/_architecture/reference/derived_stats_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/early_game_ignition_analysis.md` | `systems/_architecture/reference/early_game_ignition_analysis.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/engine_atlas_v1.md` | `systems/_architecture/reference/engine_atlas_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/generational_transition_v30.md` | `systems/_architecture/reference/generational_transition_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/governance_consolidation_v1.md` | `systems/_architecture/reference/governance_consolidation_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/governance_ripple_substrate_v1.md` | `systems/_architecture/reference/governance_ripple_substrate_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/governance_type_registry_v1.md` | `systems/_architecture/reference/governance_type_registry_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/holonic_container_doctrine_v1.md` | `systems/_architecture/reference/holonic_container_doctrine_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/hybrid_gaps_v30.md` | `systems/_architecture/reference/hybrid_gaps_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/hybrid_gaps_v30_infill.md` | `systems/_architecture/reference/hybrid_gaps_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/integration_proposal_v30.md` | `systems/_architecture/reference/integration_proposal_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/integration_proposal_v30_index.md` | `systems/_architecture/reference/integration_proposal_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/key_echo_armature_v1.md` | `systems/_architecture/reference/key_echo_armature_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/key_substrate_v30.md` | `systems/_architecture/reference/key_substrate_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/key_type_registry_v30.md` | `systems/_architecture/reference/key_type_registry_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/ners_vsg_reconciliation_v1.md` | `systems/_architecture/reference/ners_vsg_reconciliation_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/player_agency_v30.md` | `systems/_architecture/reference/player_agency_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/player_agency_v30_index.md` | `systems/_architecture/reference/player_agency_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/propagation_spec_v1.md` | `systems/_architecture/reference/propagation_spec_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/repo_state_armature_v1.md` | `systems/_architecture/reference/repo_state_armature_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/repository_keep_set_v1.md` | `systems/_architecture/reference/repository_keep_set_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/scale_transitions_v30.md` | `systems/_architecture/reference/scale_transitions_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/scale_transitions_v30_index.md` | `systems/_architecture/reference/scale_transitions_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/scale_transitions_v30_infill.md` | `systems/_architecture/reference/scale_transitions_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/session_a_spec_patches.md` | `systems/_architecture/reference/session_a_spec_patches.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/subsystem_flow_skeletons_v1.md` | `systems/_architecture/reference/subsystem_flow_skeletons_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/tensions_pair_validation.md` | `systems/_architecture/reference/tensions_pair_validation.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/throughlines_complete.md` | `systems/_architecture/reference/throughlines_complete.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/videogame_mode_spec.md` | `systems/_architecture/reference/videogame_mode_spec.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/_architecture/videogame_mode_spec_index.md` | `systems/_architecture/reference/videogame_mode_spec_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/articulation/articulation_flow_skeleton_v1.md` | `systems/articulation/reference/articulation_flow_skeleton_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/articulation/articulation_layer_v30.md` | `systems/articulation/reference/articulation_layer_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/characters/character_generation_questionnaire_v30.md` | `systems/characters/reference/character_generation_questionnaire_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/characters/character_histories_v30.md` | `systems/characters/reference/character_histories_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/characters/character_histories_v30_index.md` | `systems/characters/reference/character_histories_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/characters/character_histories_v30_infill.md` | `systems/characters/reference/character_histories_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/characters/characters_flow_skeleton_v1.md` | `systems/characters/reference/characters_flow_skeleton_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/characters/conviction_axis_matrix_v30.md` | `systems/characters/reference/conviction_axis_matrix_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/characters/conviction_migration_roster_v30.md` | `systems/characters/reference/conviction_migration_roster_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/characters/conviction_taxonomy_v30.md` | `systems/characters/reference/conviction_taxonomy_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/characters/conviction_track_v1.md` | `systems/characters/reference/conviction_track_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/characters/conviction_track_v1_pp718_vetting.md` | `systems/characters/reference/conviction_track_v1_pp718_vetting.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/characters/conviction_track_v30.md` | `systems/characters/reference/conviction_track_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/characters/conviction_track_v30_index.md` | `systems/characters/reference/conviction_track_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/characters/conviction_track_v30_infill.md` | `systems/characters/reference/conviction_track_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/combat/combat_c4_draft_v0.md` | `systems/combat/reference/combat_c4_draft_v0.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/combat/combat_currency_v1.md` | `systems/combat/reference/combat_currency_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/combat/combat_engine_v1/README.md` | `systems/combat/combat_engine_v1/reference/README.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/combat/combat_engine_v1/REARCHITECTURE_v1.md` | `systems/combat/combat_engine_v1/reference/REARCHITECTURE_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/combat/combat_engine_v1/ability_armature.md` | `systems/combat/combat_engine_v1/reference/ability_armature.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/combat/combat_engine_v1/combat_balancing_methodology.md` | `systems/combat/combat_engine_v1/reference/combat_balancing_methodology.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/combat/combat_engine_v1/combat_throughlines_v1.md` | `systems/combat/combat_engine_v1/reference/combat_throughlines_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/combat/combat_engine_v1/engagement_psychology_recovered.md` | `systems/combat/combat_engine_v1/reference/engagement_psychology_recovered.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/combat/combat_engine_v1/phase4_5_plan_v1.md` | `systems/combat/combat_engine_v1/reference/phase4_5_plan_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/combat/combat_engine_v1/tradition_decomposition_v1.md` | `systems/combat/combat_engine_v1/reference/tradition_decomposition_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/combat/combat_flow_skeleton_v1.md` | `systems/combat/reference/combat_flow_skeleton_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/combat/combat_reference_v1.md` | `systems/combat/reference/combat_reference_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/combat/scene_combat_design_v1.md` | `systems/combat/reference/scene_combat_design_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/baralta_crown_claim_v30.md` | `systems/factions/reference/baralta_crown_claim_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/baralta_crown_claim_v30_infill.md` | `systems/factions/reference/baralta_crown_claim_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/ci_political_v30.md` | `systems/factions/reference/ci_political_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/ci_political_v30_index.md` | `systems/factions/reference/ci_political_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/faction_behavior_v30.md` | `systems/factions/reference/faction_behavior_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/faction_canon_v30.md` | `systems/factions/reference/faction_canon_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/faction_layer_v30.md` | `systems/factions/reference/faction_layer_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/faction_layer_v30_index.md` | `systems/factions/reference/faction_layer_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/faction_layer_v30_infill.md` | `systems/factions/reference/faction_layer_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/faction_politics_v30.md` | `systems/factions/reference/faction_politics_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/faction_politics_v30_index.md` | `systems/factions/reference/faction_politics_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/faction_state_authoring_v30.md` | `systems/factions/reference/faction_state_authoring_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/faction_succession_split_v30.md` | `systems/factions/reference/faction_succession_split_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/faction_succession_split_v30_index.md` | `systems/factions/reference/faction_succession_split_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/faction_systems_overview_v30.md` | `systems/factions/reference/faction_systems_overview_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/factions_flow_skeleton_v1.md` | `systems/factions/reference/factions_flow_skeleton_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/factions_personal_v30.md` | `systems/factions/reference/factions_personal_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/factions_personal_v30_index.md` | `systems/factions/reference/factions_personal_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/factions_personal_v30_infill.md` | `systems/factions/reference/factions_personal_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/fail_forward_pp177.md` | `systems/factions/reference/fail_forward_pp177.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/fractional_province_ownership_v30.md` | `systems/factions/reference/fractional_province_ownership_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/fractional_province_ownership_v30_index.md` | `systems/factions/reference/fractional_province_ownership_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/franchise_v30.md` | `systems/factions/reference/franchise_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/parliamentary_transfer_v30.md` | `systems/factions/reference/parliamentary_transfer_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/political_dynamics_keys_migration_v30.md` | `systems/factions/reference/political_dynamics_keys_migration_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/treaty_expiration_v30.md` | `systems/factions/reference/treaty_expiration_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/varfell_path_b_v30.md` | `systems/factions/reference/varfell_path_b_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/factions/varfell_path_b_v30_infill.md` | `systems/factions/reference/varfell_path_b_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/fieldwork/fieldwork_bg_v30.md` | `systems/fieldwork/reference/fieldwork_bg_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/fieldwork/fieldwork_bg_v30_infill.md` | `systems/fieldwork/reference/fieldwork_bg_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/fieldwork/fieldwork_editorial.md` | `systems/fieldwork/reference/fieldwork_editorial.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/fieldwork/fieldwork_exploration.md` | `systems/fieldwork/reference/fieldwork_exploration.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/fieldwork/fieldwork_exposure.md` | `systems/fieldwork/reference/fieldwork_exposure.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/fieldwork/fieldwork_flow_skeleton_v1.md` | `systems/fieldwork/reference/fieldwork_flow_skeleton_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/fieldwork/fieldwork_godot.md` | `systems/fieldwork/reference/fieldwork_godot.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/fieldwork/fieldwork_hybrid_v30.md` | `systems/fieldwork/reference/fieldwork_hybrid_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/fieldwork/fieldwork_hybrid_v30_infill.md` | `systems/fieldwork/reference/fieldwork_hybrid_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/fieldwork/fieldwork_investigation.md` | `systems/fieldwork/reference/fieldwork_investigation.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/fieldwork/fieldwork_rationale.md` | `systems/fieldwork/reference/fieldwork_rationale.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/fieldwork/fieldwork_socializing.md` | `systems/fieldwork/reference/fieldwork_socializing.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/fieldwork/fieldwork_summary.md` | `systems/fieldwork/reference/fieldwork_summary.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/fieldwork/fieldwork_v30.md` | `systems/fieldwork/reference/fieldwork_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/fieldwork/fieldwork_v30_index.md` | `systems/fieldwork/reference/fieldwork_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/fieldwork/fieldwork_v30_infill.md` | `systems/fieldwork/reference/fieldwork_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/fieldwork/investigation_systems_v30.md` | `systems/fieldwork/reference/investigation_systems_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/fieldwork/investigation_systems_v30_index.md` | `systems/fieldwork/reference/investigation_systems_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/fieldwork/knots_v30.md` | `systems/fieldwork/reference/knots_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/mass_battle/mass_battle_flow_skeleton_v1.md` | `systems/mass_battle/reference/mass_battle_flow_skeleton_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/mass_battle/mass_battle_integration_v30.md` | `systems/mass_battle/reference/mass_battle_integration_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/mass_battle/mass_battle_v30.md` | `systems/mass_battle/reference/mass_battle_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/mass_battle/mass_battle_v30_index.md` | `systems/mass_battle/reference/mass_battle_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/mass_battle/mass_battle_v30_infill.md` | `systems/mass_battle/reference/mass_battle_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/mass_battle/military_layer_v30.md` | `systems/mass_battle/reference/military_layer_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/mass_battle/military_layer_v30_index.md` | `systems/mass_battle/reference/military_layer_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/npcs/baralta_v30.md` | `systems/npcs/reference/baralta_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/npcs/character_canon_v30.md` | `systems/npcs/reference/character_canon_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/npcs/companion_specification_v30.md` | `systems/npcs/reference/companion_specification_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/npcs/edeyja_npc.md` | `systems/npcs/reference/edeyja_npc.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/npcs/npc_behavior_system_v1.md` | `systems/npcs/reference/npc_behavior_system_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/npcs/npc_behavior_system_v1_index.md` | `systems/npcs/reference/npc_behavior_system_v1_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/npcs/npc_behavior_v30.md` | `systems/npcs/reference/npc_behavior_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/npcs/npc_behavior_v30_index.md` | `systems/npcs/reference/npc_behavior_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/npcs/npc_behavior_v30_infill.md` | `systems/npcs/reference/npc_behavior_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/npcs/npc_character_analyses_v30.md` | `systems/npcs/reference/npc_character_analyses_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/npcs/npc_character_analyses_v30_index.md` | `systems/npcs/reference/npc_character_analyses_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/npcs/npc_character_analyses_v30_infill.md` | `systems/npcs/reference/npc_character_analyses_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/npcs/npc_foils_v30.md` | `systems/npcs/reference/npc_foils_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/npcs/npc_foils_v30_infill.md` | `systems/npcs/reference/npc_foils_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/npcs/npc_relational_graph_v30.md` | `systems/npcs/reference/npc_relational_graph_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/npcs/npc_roster_v30.md` | `systems/npcs/reference/npc_roster_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/npcs/npc_roster_v30_index.md` | `systems/npcs/reference/npc_roster_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/npcs/npc_roster_v30_infill.md` | `systems/npcs/reference/npc_roster_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/npcs/npcs_flow_skeleton_v1.md` | `systems/npcs/reference/npcs_flow_skeleton_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/overview/clock_registry_v30.md` | `systems/overview/reference/clock_registry_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/overview/clock_registry_v30_infill.md` | `systems/overview/reference/clock_registry_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/overview/ms_budget.md` | `systems/overview/reference/ms_budget.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/overview/overview_flow_skeleton_v1.md` | `systems/overview/reference/overview_flow_skeleton_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/overview/peninsular_strain_v30.md` | `systems/overview/reference/peninsular_strain_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/overview/peninsular_strain_v30_index.md` | `systems/overview/reference/peninsular_strain_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/overview/wc_survival_spine.md` | `systems/overview/reference/wc_survival_spine.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/settlements/generation_sourcebook_v1.md` | `systems/settlements/reference/generation_sourcebook_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/settlements/goldenfurt_slice/README.md` | `systems/settlements/goldenfurt_slice/reference/README.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/settlements/goldenfurt_slice/event_deck.md` | `systems/settlements/goldenfurt_slice/reference/event_deck.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/settlements/goldenfurt_slice/generation_methodology.md` | `systems/settlements/goldenfurt_slice/reference/generation_methodology.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/settlements/goldenfurt_slice/npc_cast.md` | `systems/settlements/goldenfurt_slice/reference/npc_cast.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/settlements/goldenfurt_slice/sim_build_spec.md` | `systems/settlements/goldenfurt_slice/reference/sim_build_spec.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/settlements/goldenfurt_slice/verification_findings.md` | `systems/settlements/goldenfurt_slice/reference/verification_findings.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/settlements/governance_play_redesign_v1.md` | `systems/settlements/reference/governance_play_redesign_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/settlements/lps_wiring_v1.md` | `systems/settlements/reference/lps_wiring_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/settlements/march_layer_v30.md` | `systems/settlements/reference/march_layer_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/settlements/scale_hierarchy_v1.md` | `systems/settlements/reference/scale_hierarchy_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/settlements/settlement_adjacency_v30.md` | `systems/settlements/reference/settlement_adjacency_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/settlements/settlement_adjacency_v30_index.md` | `systems/settlements/reference/settlement_adjacency_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/settlements/settlement_generator_v1.md` | `systems/settlements/reference/settlement_generator_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/settlements/settlement_layer_v30.md` | `systems/settlements/reference/settlement_layer_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/settlements/settlement_layer_v30_index.md` | `systems/settlements/reference/settlement_layer_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/settlements/settlements_currency_v1.md` | `systems/settlements/reference/settlements_currency_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/settlements/settlements_flow_skeleton_v1.md` | `systems/settlements/reference/settlements_flow_skeleton_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/settlements/territory_temperaments_v30.md` | `systems/settlements/reference/territory_temperaments_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/settlements/valoria_political_hierarchy_v30.md` | `systems/settlements/reference/valoria_political_hierarchy_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/social_contest/social_contest_currency_v1.md` | `systems/social_contest/reference/social_contest_currency_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/social_contest/social_contest_flow_skeleton_v1.md` | `systems/social_contest/reference/social_contest_flow_skeleton_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/social_contest/social_contest_system_v2.md` | `systems/social_contest/reference/social_contest_system_v2.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/social_contest/social_contest_system_v2_index.md` | `systems/social_contest/reference/social_contest_system_v2_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/social_contest/social_contest_v30.md` | `systems/social_contest/reference/social_contest_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/social_contest/social_contest_v30_index.md` | `systems/social_contest/reference/social_contest_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/social_contest/social_contest_v30_infill.md` | `systems/social_contest/reference/social_contest_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/threadwork/thread_horizontal_integration_spec.md` | `systems/threadwork/reference/thread_horizontal_integration_spec.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/threadwork/thread_horizontal_integration_spec_index.md` | `systems/threadwork/reference/thread_horizontal_integration_spec_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/threadwork/threadwork_flow_skeleton_v1.md` | `systems/threadwork/reference/threadwork_flow_skeleton_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/threadwork/threadwork_philosophical_reference_v30.md` | `systems/threadwork/reference/threadwork_philosophical_reference_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/threadwork/threadwork_philosophical_reference_v30_infill.md` | `systems/threadwork/reference/threadwork_philosophical_reference_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/threadwork/threadwork_v25_historical.md` | `systems/threadwork/reference/threadwork_v25_historical.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/threadwork/threadwork_v25_historical_index.md` | `systems/threadwork/reference/threadwork_v25_historical_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/threadwork/threadwork_v30.md` | `systems/threadwork/reference/threadwork_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/threadwork/threadwork_v30_index.md` | `systems/threadwork/reference/threadwork_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/threadwork/threadwork_v30_infill.md` | `systems/threadwork/reference/threadwork_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/ui/ui_flow_skeleton_v1.md` | `systems/ui/reference/ui_flow_skeleton_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/ui/valoria_ui_ux_supplement_derived_settlement.md` | `systems/ui/reference/valoria_ui_ux_supplement_derived_settlement.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/ui/valoria_ui_ux_v4.md` | `systems/ui/reference/valoria_ui_ux_v4.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/ui/valoria_ui_ux_v4_1.md` | `systems/ui/reference/valoria_ui_ux_v4_1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/ui/valoria_ui_ux_v4_1_index.md` | `systems/ui/reference/valoria_ui_ux_v4_1_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/ui/valoria_ui_ux_v4_1_max_audit.md` | `systems/ui/reference/valoria_ui_ux_v4_1_max_audit.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/ui/valoria_ui_ux_v4_1_max_audit_index.md` | `systems/ui/reference/valoria_ui_ux_v4_1_max_audit_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/ui/valoria_ui_ux_v4_2_workplan.md` | `systems/ui/reference/valoria_ui_ux_v4_2_workplan.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/ui/valoria_ui_ux_v4_2_workplan_index.md` | `systems/ui/reference/valoria_ui_ux_v4_2_workplan_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/ui/valoria_ui_ux_v4_index.md` | `systems/ui/reference/valoria_ui_ux_v4_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/victory/victory_flow_skeleton_v1.md` | `systems/victory/reference/victory_flow_skeleton_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/victory/victory_v30.md` | `systems/victory/reference/victory_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/victory/victory_v30_index.md` | `systems/victory/reference/victory_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/victory/victory_v30_infill.md` | `systems/victory/reference/victory_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/world/calamity_radiation_v30.md` | `systems/world/reference/calamity_radiation_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/world/calamity_radiation_v30_infill.md` | `systems/world/reference/calamity_radiation_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/world/geography_v30.md` | `systems/world/reference/geography_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/world/geography_v30_infill.md` | `systems/world/reference/geography_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/world/insurgency_pipeline_v30.md` | `systems/world/reference/insurgency_pipeline_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/world/miraculous_event_v30.md` | `systems/world/reference/miraculous_event_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/world/ms_trajectory_v1.md` | `systems/world/reference/ms_trajectory_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/world/narrative_voice_canon_v30.md` | `systems/world/reference/narrative_voice_canon_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/world/solmund_artifacts_v30.md` | `systems/world/reference/solmund_artifacts_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/world/solmund_master_document.md` | `systems/world/reference/solmund_master_document.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/world/solmund_philosophy_v30.md` | `systems/world/reference/solmund_philosophy_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/world/solmund_v30.md` | `systems/world/reference/solmund_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/world/solmund_voice_v30.md` | `systems/world/reference/solmund_voice_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/world/southernmost_v30.md` | `systems/world/reference/southernmost_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/world/southernmost_v30_infill.md` | `systems/world/reference/southernmost_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/world/world_flow_skeleton_v1.md` | `systems/world/reference/world_flow_skeleton_v1.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/world/worldbuilding_canon_audit_v30.md` | `systems/world/reference/worldbuilding_canon_audit_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/world/worldbuilding_canon_audit_v30_infill.md` | `systems/world/reference/worldbuilding_canon_audit_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/world/worldbuilding_v30.md` | `systems/world/reference/worldbuilding_v30.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/world/worldbuilding_v30_index.md` | `systems/world/reference/worldbuilding_v30_index.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |
| `systems/world/worldbuilding_v30_infill.md` | `systems/world/reference/worldbuilding_v30_infill.md` | DONE (2026-09-09, ED-IN-0179 — design prose moved under `reference/` so LOCATION signals status rather than a banner; CORRECTED 2026-09-09: an earlier note here claimed no code opens these. FALSE — `tools/export_key_types.py` and other builders read them; openers were repointed in this same change) |

### Prefix-resolved prose repointed under `reference/` (2026-09-09, ED-IN-0179)

| Old Path | New Path | Status |
|----------|----------|--------|
| `designs/architecture/conflict_architecture_proposal.md` | `systems/_architecture/reference/conflict_architecture_proposal.md` | DONE (2026-09-09, ED-IN-0179 — explicit row: the dir-prefix alias for this tree still resolves for code, but the `.md` moved under `reference/`, so the prose needs its own row) |
| `designs/architecture/governance_consolidation_v1.md` | `systems/_architecture/reference/governance_consolidation_v1.md` | DONE (2026-09-09, ED-IN-0179 — explicit row: the dir-prefix alias for this tree still resolves for code, but the `.md` moved under `reference/`, so the prose needs its own row) |
| `designs/architecture/governance_ripple_substrate_v1.md` | `systems/_architecture/reference/governance_ripple_substrate_v1.md` | DONE (2026-09-09, ED-IN-0179 — explicit row: the dir-prefix alias for this tree still resolves for code, but the `.md` moved under `reference/`, so the prose needs its own row) |
| `designs/architecture/governance_type_registry_v1.md` | `systems/_architecture/reference/governance_type_registry_v1.md` | DONE (2026-09-09, ED-IN-0179 — explicit row: the dir-prefix alias for this tree still resolves for code, but the `.md` moved under `reference/`, so the prose needs its own row) |
| `designs/architecture/key_echo_armature_v1.md` | `systems/_architecture/reference/key_echo_armature_v1.md` | DONE (2026-09-09, ED-IN-0179 — explicit row: the dir-prefix alias for this tree still resolves for code, but the `.md` moved under `reference/`, so the prose needs its own row) |
| `designs/territory/lps_wiring_v1.md` | `systems/settlements/reference/lps_wiring_v1.md` | DONE (2026-09-09, ED-IN-0179 — explicit row: the dir-prefix alias for this tree still resolves for code, but the `.md` moved under `reference/`, so the prose needs its own row) |
| `designs/territory/scale_hierarchy_v1.md` | `systems/settlements/reference/scale_hierarchy_v1.md` | DONE (2026-09-09, ED-IN-0179 — explicit row: the dir-prefix alias for this tree still resolves for code, but the `.md` moved under `reference/`, so the prose needs its own row) |
| `skills/valoria-resolution-diagnostic/` | `skills/ners/` | DONE (2026-09-10 — RENAME, Jordan-directed; no ED allocated, because the rename is a decision already taken rather than a question to queue. Directory-prefix row, so every `SKILL.md:<line>` citation in the dated proposal sets, `audit/` and the archived IN ledger still resolves; those were deliberately NOT rewritten, since a historical document records the path that was true when it was written and this ledger is where such a path resolves. The skill's frontmatter `name:` moved with it, so the slash command is `/ners`. Live surfaces WERE rewritten: `CLAUDE.md` §0.06 + §9, `skills/valoria-module-adjudicator/SKILL.md`, `registers/handoffs/HANDOFF_IN.md`, `engine/sigma_leverage_engine_armature.md`, `systems/_architecture/reference/governance_ripple_substrate_v1.md`, `research/provenance/2026-08-28-systems-integration-harvest/HARVEST_CONTRACT.md`, and `proposals/2026-09-10-settlements-factions-populations/04_EVALUATION.md`. The name now matches what the file has always called itself — its own H1 is `# NERS` and its charter lives at `CLAUDE.md` §0.06 — which is CLAUDE.md §4's word-choice rule applied to the skill roster: a reader meeting `/ners` cold lands on the right meaning, where `resolution-diagnostic` named only the second of the skill's two instruments.) |
| `skills/valoria-resolution-diagnostic/SKILL.md` | `skills/resolution-diagnostic/SKILL.md` | DONE (2026-09-10 — SPLIT, ED-IN-0207, Jordan-directed. THE ENGINE HALF — old §11.x: the stack, the μ-shift, fractional pool/Ob, the pool floor, P-i…P-v, Phases 0–6. The row above is a DIRECTORY-PREFIX row and resolves the METHOD half only; after the split it sends every engine-side `SKILL.md:<line>` citation in the dated proposal sets and `audit/` to `skills/ners/`, which no longer holds that content — `ners` §11 is now GUARDRAILS, not the σ stack. ⚠ A PRE-SPLIT `SKILL.md:<line>` CITATION IS AMBIGUOUS BY CONSTRUCTION — that one file held both halves, and no row can disambiguate per line. This exact row resolves the ENGINE half because the directory row above cannot reach it at all; a citation about the METHOD (the cut test, the false N-line, `a fix that adds a system has failed`) is at `skills/ners/SKILL.md` and this row will send you to the wrong file. Read the cited text and pick the half; the ledger cannot. Known affected and deliberately NOT rewritten, since a historical document records the path that was true when it was written: `proposals/2026-09-05-proceedings-subsystem/06_RESOLUTION.md`, that set's `relay/A_FABLE_INTERROGATION.md`, `proposals/2026-09-04-social-contest-branches/11_FOUR_GAMES_AUDIT_AND_PLAN.md`, `proposals/2026-08-25-throughlines-and-precedent/06_ch3*`.) |

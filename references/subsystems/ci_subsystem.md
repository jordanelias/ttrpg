...
- `ci_editorial_checker.py` — commits touching editorial paths (`systems/npcs/`, `systems/world/`, `arcs/simulated/`, `canon/03_`) must carry `[EDITORIAL:` / `[PROVISIONAL:` / `[EDITORIAL GATE]` markers for substantive content (>200 chars; `_skeleton.md` exempt).

...
Source: `systems/_architecture/reference/throughlines_complete.md`.
...
- `systems/_architecture/reference/throughlines_complete.md`: М-tag annotations per infill §3.1.

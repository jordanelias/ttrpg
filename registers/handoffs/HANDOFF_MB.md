...
| Dead-primitive dispositions unexecuted (`_octagon_dmg_mod`/`_SHAPE_BUILD`, `provenance.py`, `resolve_internal_collisions`) | `ED-MB-0057` | execute or re-adjudicate each disposition |

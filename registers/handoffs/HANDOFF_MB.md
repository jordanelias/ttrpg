...
| Squad-engagement concept v5: build slate (Part A) + all six Part C items ruled by Jordan 2026-09-25 | `ED-MB-0067` (3rd row) / `proposals/2026-09-25-squad-engagement-synthesis.md` | change `engine.py:344-347`'s morale-start formula (PP-711) to read faction Stability — `mass_battle_v30.md` is reference, not the fix; work out the C2/C3 coupling formula and C4's roll |

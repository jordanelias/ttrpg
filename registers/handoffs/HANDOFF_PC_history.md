# HANDOFF_PC — history (frozen; grows by archival, not editing)

## Pre-pointer body of HANDOFF_PC.md, moved verbatim 2026-09-22
...
## ⚠ CLOSED WORK LIVES IN `HANDOFF_PC_closed.md` — index, 2026-09-13 (`ED-IN-0221`)

**15 units · 11,223 tokens of finished narrative moved out of this file**, verbatim and in
...
| | tokens | unit |
|---|---|---|
|  | 3,533 | Pending :: - **R3 consolidation plan-of-record — `designs/audit/2026-07-04-weapon-morphology-granularity/consol |
| **!** | 1,622 | Pending :: - **▶ JORDAN RULED THE CARRY-CONTEXT FORK AND GROUNDED THE CURVATURE MODEL (2026-07-29, live). READ |
| **!** | 1,285 | Pending :: - **FOUR-DIMENSION AUDIT + REMEDIATION (ED-PC-0034..0040) — batches 1–5.2 landed, batch 6 pending. |
| **!** | 941 | 2026-08-27 — the 40% covert-plate-killer ceiling is ABOLISHED (ED-PC-0057) |
|  | 675 | Pending :: - **OPEN (Jordan-flagged on PR #231): off-plate reach re-baseline — turn the lever down.** Fixing th |
|  | 570 | Pending :: - **'BUILD ALL' PASS DONE (ED-PC-0026/0027/0028, 2026-07-23) — Phases 1-4, all committed & pushed to |
|  | 515 | Pending :: - **COMBAT FIAT / BROKEN-LOGIC AUDIT DONE (ED-PC-0023, 2026-07-23) — 4 independent adversarial passe |
|  | 430 | Pending :: - **▶ Background (2026-07-30): `audit/2026-07-26-combat-balance-customization-state/session_retrospe |
|  | 385 | Pending :: - **IMPOSITION FIAT RETIRED (Jordan ruling 2026-07-23, ED-PC-0023) + design principle recorded.** `i |
|  | 349 | Pending :: - **ADVERSARIAL REVIEW of U10 + fiat-audit DONE (2026-07-23) — 4 independent critics + pessimistic N |
|  | 326 | Pending :: - **E0 BATCH EXECUTED + I4 DELIVERED (2026-07-29, ED-PC-0041..0044) — PRs #259/#269 MERGED. |
|  | 246 | Pending :: - **OPEN (matrix quirks, pre-existing — NOT from the reach arc; PC-lane roster calibration): |
|  | 166 | Pending :: - **REACH-ARC (ED-PC-0029..0033) LANDED on PR #231 (2026-07-24) — full suite green (656).** arrest-i |
|  | 107 | Pending :: - **ED-1050 (combat parity oracle) — RESOLVED 2026-06-30, residual open.** ADEF_THRESHOLD monotonici |
|  | 73 | Next actions :: - **ED-1051 residual affecting this lane:** `engine_clock`'s doc:null grade now has a candidate home |

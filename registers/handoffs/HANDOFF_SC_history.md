# HANDOFF_SC — history (frozen; grows by archival, not editing)

## Pre-pointer body of HANDOFF_SC.md, moved verbatim 2026-09-22
...
## ⚠ CLOSED WORK LIVES IN `HANDOFF_SC_closed.md` — index, 2026-09-13 (`ED-IN-0221`)

**19 units · 10,086 tokens of finished narrative moved out of this file**, verbatim and in
...
| | tokens | unit |
|---|---|---|
|  | 2,099 | Pending :: - **Social-contest staged rebuild (`claude/happy-shaw-da0f1d`, IN PROGRESS).** Agonist/antagonist ga |
|  | 1,855 | ⭐ WHAT TO DO NEXT, in order, and the first one is the only one that matters |
|  | 1,134 | ⚠ CURRENT — 2026-09-07 · the proceedings subsystem was STRESS-TESTED |
|  | 815 | ⚠ 2026-09-07, LATER — THE REVIEW, AND PHASE 0 EXECUTED |
|  | 796 | Pending :: - **Three-lens pessimistic NERS audit + upload delta FILED 2026-08-06 (ED-SC-0017..0022). |
|  | 523 | Next actions :: - **ED-SC-0027 (2026-08-06) — TRACK ARCHITECTURE + STATE GRAPH, organised by Jordan's requirements.* |
|  | 485 | 2026-08-27 (later) — the seam landed, and the instrument it broke (ED-SC-0032) |
|  | 407 | Next actions :: - **ED-SC-0029 (2026-08-06) — PROPOSAL REWRITTEN (v2). |
|  | 380 | Next actions :: - **ED-SC-0028 (2026-08-06) — ADVERSARIAL AUDIT OF ED-SC-0027 + CORRECTIONS. |
|  | 354 | Next actions :: - **ED-SC-0030 (2026-08-06) — KEYS, KNOTS, NPCs AND THE COMBAT MODEL. |
|  | 317 | Pending :: - **Auto/Manual Resolution Duality doctrine RULED 2026-07-08 (ED-SC-0013 → resolved). |
|  | 231 | What is genuinely open, and it is not much |
|  | 215 | ⚠ Two method lessons this session paid for, worth more than any single finding |
|  | 140 | The state in one paragraph |
|  | 133 | What is DONE and needs nobody |
|  | 59 | Next actions :: - **ED-SC-0006 + ED-SC-0007 DONE (2026-07-08)** — kernel routing, party-derivation bridge, the |
|  | 57 | Next actions :: - **contest_rebuild Stage 1+ gates** — each stage ratified individually (Gate 0 ratified |
|  | 46 | Next actions :: - **JORDAN RULING NEEDED: ED-SC-0015** (Parliamentary total-victory Mandate stacking, −2 vs −1) — |
|  | 40 | Next actions :: - **`contest.py` fabrication-debt triage** — 19 uncited constants block the J-31 terminology |

...
# MOVED FROM root `HANDOFF.md` — 2026-09-17 (`ED-IN-0240`)

Jordan: *"TRIM THE HANDOFFS"*, and *"why wouldn't you rely on the markers themselves instead of the body for a handoff"*. Dated narrative, verbatim and in original order; every marker indexed in root `HANDOFF.md`.
...
# THE LANE-SPLIT RATIONALE, moved from root `HANDOFF.md` — 2026-09-17 (`ED-IN-0242`)
...
## Pre-pointer body of root HANDOFF.md, moved verbatim 2026-09-22

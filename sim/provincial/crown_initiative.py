...
def attempt_royal_progress(crown, world, rng) -> InitiativeResult:
    ...
    """
    # Historical grounding (annotation only, ED-FA-0016 CP-5, 2026-07-08): itinerant kingship —
...
def attempt_great_work(crown, world, rng) -> InitiativeResult:
    ...
    """
    # Historical grounding (annotation only, ED-FA-0016 CP-5, 2026-07-08): cathedral/civic-works
...
def attempt_coronation_renewal(crown, world, rng) -> InitiativeResult:
    ...
    """
    # Historical grounding (annotation only, ED-FA-0016 CP-5, 2026-07-08): Festkronungen — ritual

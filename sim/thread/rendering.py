"""
sim/thread/rendering.py — Rendering Stability world-track and strain mechanics (P-07 — Calamity = rendered-side)
...
def apply_rs_strain(delta: int, source: str, world: GameState):
    raise NotImplementedError("sim/thread/rendering.py — Pass 2l armature stub")

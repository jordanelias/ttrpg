...
- **Fix:** At C4 and below, Spirit determines whether the will continues to grip — but in both cases, the prose renders primarily through **exteriority** (what the character does, how they move, what their body enacts) because the interior has moved beyond the domain the narrative can adequately access. **High Spirit** = Beckett continuation through action. The will is visible in the body — the character walks, works, holds, continues. The prose describes what they do with precision and is opaque about why. The reader infers the will from the behavior, not from the prose declaring it. The narrative describes AROUND the interior through its exteriority. Closing: the act ("she walks"). **Low Spirit** = Lispector dissolution through yielding. Agency recedes from the body — the feet move but the agent does not direct them. Predication of self breaks ("Vael was — she was on the path"). The body continues; the self does not own the continuation. Closing: the noun ("the feet move").

...
| Lem | Extended clinical-register sentences with precise technical terminology. Footnote-adjacent parenthetical qualifications. Taxonomy constructions with categorical precision applied to uncategorizable content. |
...
| Lem | Clinical incommensurability | The scholarly apparatus is applied with flawless precision. The terminology is exact. The methodology is correct. The object does not yield. The reader perceives the gap between the precision and the resistance. The apparatus may document the gap formally ("the measurements are consistent; the phenomenon is not") but does not confess inadequacy — the inadequacy is structural, not acknowledged. |

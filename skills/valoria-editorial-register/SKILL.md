...
`designs/npcs/`, `designs/world/`, `designs/arcs/gm_ref/`, or `canon/03_canonical_timeline.md`:
...
2. Extract all `[EDITORIAL: ...]` / `[PROVISIONAL: ...]` flags from those files (see
   ...
   `designs/npcs/`, `designs/world/`, `designs/arcs/gm_ref/`, `canon/03_canonical_timeline.md`

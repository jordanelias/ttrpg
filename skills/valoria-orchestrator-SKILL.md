...
1. Read all skills from GitHub `skills/` directory (6 files). This is mandatory — `/mnt/skills/user/` copies may be stale.
...
**Anti-pattern:** Doing skill work inline. If about to chunk, formula-check, or assemble inline — STOP and route to the skill.
...
User retains exclusive authority over: setting, worldbuilding, characters, narrative, tone, faction behavior, ambiguous design intent. Flag: `[EDITORIAL: requires user approval — description]`. Claude may execute without approval: formula corrections, consistency fixes, formatting, audits, simulations.

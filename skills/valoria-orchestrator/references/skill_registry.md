...
- Model: Sonnet 4.6
- Triggers: mechanical audit, audit for mechanics, consistency check, mechanic check, gap detection, redundancy, formula check, what's broken, what's missing  (bare "audit" → nothing)
...
- Triggers: engine audit, resolution diagnostic audit, resolution audit, is this rolling engine NERS compliant, diagnose this resolver, stress test this roll, is this sigma-leverage or deterministic+stochastic, does this resolution scale, leverage non-uniformity, clamp/Ob-floor conflict
...
- Leverage-axis note (2026-06-19): Instance A now documents the **μ-shift ≡ Ob-shift dual** and the **flat-shift trap** — advantage must be σ_N-scaled on either axis; a flat "+X to net"/"−X Ob" bonus re-imports 1/√Pool non-uniformity (P-ii).
...
| "mechanical audit" / "audit for mechanics" | valoria-mechanic-audit | Modes A-G  (bare "audit" → nothing) |
...
| "engine audit" / "resolution audit" / "resolution diagnostic audit" | valoria-resolution-diagnostic | Full Stage 1–5 pipeline |

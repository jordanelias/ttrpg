...
| **Mechanics** — how any resolver decides an outcome · **design intent** | the subsystem's head doc, via `CURRENT.md` and the head's own `## Status:` line; philosophy in `canon/` (P-01..P-14) |

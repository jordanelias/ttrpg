...
(`references/module_contracts.yaml:988` `sim_module`), per standing rule 1.
...
| `subscribe_all(scheduler)` | `engine/cross_scale/articulation.py:152 subscribe_all` | `engine/mc_v18.py:266 subscribe_all` (production); `engine/tests/test_pipeline_reach.py:649 subscribe_all` and `:681 run_campaign` (test reach probes); `tests/valoria/test_articulation_subscriber.py:233 subscribe_all` (unit tests) |

...
| `propose_censure(proposer, world, rng)` | `systems/factions/sim/parliamentary_action.py:96 propose_censure` | `systems/factions/sim/faction_action.py:272 propose_censure` |
...
| `world.territories`, `ADJACENCY` | world-state | `systems/settlements/sim/adjacency.py` | `systems/factions/sim/faction_action.py:131-136 ADJACENCY` |
...
|---|---|---|---|
| `Faction.L` | RW | `engine/autoload/game_state.py` | `systems/factions/sim/faction_action.py:473 adjust` |
| `Faction.Sta` | RW | `engine/autoload/game_state.py` | `systems/factions/sim/faction_action.py:568 adjust` |
| `Faction.W` | RW | `engine/autoload/game_state.py` | `systems/factions/sim/faction_action.py:529-532 adjust` |

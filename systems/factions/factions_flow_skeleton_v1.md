...
| `Faction.reset_arc()` | `engine/autoload/game_state.py:138 reset_arc` | `engine/autoload/season_manager.py:39 reset_arc` |
| `Faction.reset_seasonal()` | `engine/autoload/game_state.py:134 reset_seasonal` | `engine/autoload/season_manager.py:42 reset_seasonal` |
...
| `TreatyRecord.from_dict(...)` | `systems/factions/sim/treaty.py:76-82 from_dict` (dataclass, module-level) | `engine/autoload/game_state.py:403 TreatyRecord` (`restore_world`, deserialization only) |
...
| `faction.Mil`, `.L`, `.I`, `.Sta`, `.W`, `.standing` | world-state | `Faction` dataclass fields | `engine/autoload/game_state.py:101-117 Faction` |
...
| `Faction.L/Sta/W/Mil/standing` mutation | world-state write | read by this subsystem's own next-season signals only (no cross-subsystem reader found) | `engine/autoload/game_state.py:127-132 adjust` |
...
| `world.treaties` | RW (declared; live writers are all unreached production paths) | `engine/autoload/game_state.py` | `engine/autoload/game_state.py:211 treaties` |
...
| `Faction.consul_used` | W | `engine/autoload/game_state.py` | `engine/autoload/game_state.py:136 consul_used` |

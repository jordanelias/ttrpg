...
| `Faction.reset_arc()` | `engine/autoload/game_state.py:198 reset_arc` | `engine/autoload/season_manager.py:39 reset_arc` |
| `Faction.reset_seasonal()` | `engine/autoload/game_state.py:194 reset_seasonal` | `engine/autoload/season_manager.py:42 reset_seasonal` |
...
| `TreatyRecord.from_dict(...)` | `systems/factions/sim/treaty.py:76-82 from_dict` (dataclass, module-level) | `engine/autoload/game_state.py:275 TreatyRecord` (`restore_world`, deserialization only) |
...
| `world.treaties` | RW (declared; live writers are all unreached production paths) | `engine/autoload/game_state.py` | `engine/autoload/game_state.py:275 treaties` |

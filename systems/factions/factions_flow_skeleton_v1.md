...
| `Faction.reset_arc()` | `engine/autoload/game_state.py:136 reset_arc` | `engine/autoload/season_manager.py:39 reset_arc` |
| `Faction.reset_seasonal()` | `engine/autoload/game_state.py:132 reset_seasonal` | `engine/autoload/season_manager.py:42 reset_seasonal` |
...
| `faction.Mil`, `.L`, `.I`, `.Sta`, `.W`, `.standing` | world-state | `Faction` dataclass fields | `engine/autoload/game_state.py:99-115 Faction` |
...
| `Faction.L/Sta/W/Mil/standing` mutation | world-state write | read by this subsystem's own next-season signals only (no cross-subsystem reader found) | `engine/autoload/game_state.py:125-130 adjust` |
...
| `world.treaties` | RW (declared; live writers are all unreached production paths) | `engine/autoload/game_state.py` | `engine/autoload/game_state.py:209 treaties` |
...
| `Faction.consul_used` | W | `engine/autoload/game_state.py` | `engine/autoload/game_state.py:134 consul_used` |

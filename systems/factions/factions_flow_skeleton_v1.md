...
| `Faction.L/Sta/W/Mil/standing` mutation | world-state write | read by this subsystem's own next-season signals only (no cross-subsystem reader found) | `engine/autoload/game_state.py:128-174 adjust` |

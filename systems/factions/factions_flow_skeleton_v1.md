...
|---|---|---|
| `faction_take_action(faction, world, rng)` | `systems/factions/sim/faction_action.py:197 faction_take_action` | `engine/mc_v18.py:130 faction_take_action` (inside `_faction_actions_callback`) |

...
| `run_parliamentary_scene(world, rng)` | `engine/cross_scale/parliamentary_bridge.py:180 run_parliamentary_scene` | `engine/mc_v18.py:158 run_parliamentary_scene` (gated on `world.echo_scheduler`) |

...
Canon source:
  ...
  - FORK: tests/sim/v17-integration/m6_faction_actions.py (M6_ASSUMPTION_ONE — Pool=I, Ob=3)
    — that tree was evacuated 2026-08-05 (ED-IN-0145); resolves at ref c451bcb, not on `main`.

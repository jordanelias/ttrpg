"""systems.mass_battle.sim.core.exchange — combat-pool assembly primitives.
...
orchestration via `from systems.mass_battle.sim.core.exchange import *` so every call site is unchanged.

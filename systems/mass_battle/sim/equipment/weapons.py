"""systems.mass_battle.sim.equipment.weapons — the WEAPONS module: a standalone, adaptable weapon catalogue.
...
"""
from systems.mass_battle.sim.equipment._base import Registry

"""systems.mass_battle.sim.troop_types.registry — troop-type stat presets + gated role menus.
...
# into resolution" per its own docstring: systems.mass_battle.sim.equipment.loadout_for(troop_type) returns

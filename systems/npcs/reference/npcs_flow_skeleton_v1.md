...
| lateral | `engine/mc_v18` | honest-deferral `stubwire.stub_resolve('generate_npc(world-gen|season-tick)', ...)` fired once per season instead of calling `generate_npc` | `engine/mc_v18.py:194-202 stub_resolve` |

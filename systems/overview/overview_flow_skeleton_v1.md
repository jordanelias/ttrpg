...
| `create_world(seed=None) -> World` | `engine/autoload/game_state.py:300 create_world` | `engine/mc_v18.py:232 run_campaign` |
...
| `world.clocks` seed values (`CI`, `MS`, `IP`, `PI`, `Strain`, `Turmoil`) | world-state | `create_world` | `engine/autoload/game_state.py:300 create_world` |
...
| `world.rng` | world-state | `create_world` | `engine/autoload/game_state.py:252 World` |
...
| `Faction.senator_inward_used`, `.consul_used` | W | `engine/autoload/game_state.py:194 reset_seasonal` (called every season via `advance_season`) | `engine/autoload/game_state.py:177-179` |
| `Faction.council_used_this_arc`, `.parl_transfer_used_this_arc` | W | `engine/autoload/game_state.py:198 reset_arc` (called on arc boundary via `advance_season`) | `engine/autoload/game_state.py:181-184` |

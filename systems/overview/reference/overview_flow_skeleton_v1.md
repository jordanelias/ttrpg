...
| `create_world(seed=None) -> World` | `engine/autoload/game_state.py:304 create_world` | `engine/mc_v18.py:232 run_campaign` |
...
| `world.npcs`, `world.npc_counter` | world-state (write) | `systems/world/sim/npe.py` own readers; `CampaignResult.npcs_generated` | `systems/world/sim/npe.py:110-126`; `engine/mc_v18.py:299` |
...
| `world.battle_count` | R | write-owner `systems/factions/sim/faction_action.py:525` | `engine/mc_v18.py:296` |
...
| out | `systems.factions.sim.faction_action` | `faction_take_action(faction, world, rng)`, writes `world.battle_count` | `engine/mc_v18.py:130`; `systems/factions/sim/faction_action.py:207`, `systems/factions/sim/faction_action.py:525` |

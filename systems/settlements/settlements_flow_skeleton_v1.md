...
| `province_accord(province_id, world=None)` | `systems/settlements/sim/registry.py:184 province_accord` | `systems/overview/sim/accounting.py:87 province_accord` (the only production caller — read-only probe); `province_accord` (RETIRED 2026-08-21 → `FORK:421cff2`, culling plan v1 wave 1/3; was tools/sim_harness/adapters/pr119_governance/pr119_integrated_campaign.py:222) (prototype harness) |
| `province_effective_prosperity(province_id, world=None)` | `systems/settlements/sim/registry.py:193 province_effective_prosperity` | `—` (no production caller; `province_effective_prosperity` (RETIRED 2026-08-21 → `FORK:421cff2`, culling plan v1 wave 1/3; was tools/sim_harness/adapters/pr119_governance/pr119_integrated_campaign.py:262) only) |
| `succeed_governor(sid, new_governor, world=None, season=0)` | `systems/settlements/sim/registry.py:198 succeed_governor` | `—` (no production caller; `succeed_governor` (RETIRED 2026-08-21 → `FORK:421cff2`, culling plan v1 wave 1/3; was tools/sim_harness/adapters/pr119_governance/pr119_promote_ready_oversight.py:84) only) |
...
| `build_infrastructure(territory_id, infra_type, world=None)` | `systems/settlements/sim/infrastructure.py:139 build_infrastructure` | `—` (no importer found in `engine/`, `systems/`, `tests/`; `build_infrastructure` (RETIRED 2026-08-21 → `FORK:421cff2`, culling plan v1 wave 1/3; was tools/sim_harness/adapters/pr119_governance/pr119_integrated_campaign.py:198-199) and `build_infrastructure` (RETIRED 2026-08-21 → `FORK:421cff2`, culling plan v1 wave 1/3; was tools/sim_harness/adapters/pr119_governance/pr119_subnational_factions.py:98) (prototype harness, not wired to CI)) |

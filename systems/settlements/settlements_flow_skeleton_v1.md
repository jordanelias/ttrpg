...
- **S2.1 Adjacency reads** `[branch]` — `faction_action._conquest_targets`/`_threat_signal` union `ADJACENCY.get(tid, set())` over a faction's held territories to find conquest targets / proximate military threats (`systems/factions/sim/faction_action.py:133`, `systems/factions/sim/faction_action.py:182`).
...
| `Territory.accord` | `RW` | `engine/autoload/game_state.py` (dataclass); written directly by `systems/factions/sim/parliamentary_transfer.py:278` and `systems/factions/sim/mass_seizure.py:293`, bypassing `Settlement.order` entirely; read (never written) by the S5 drift probe | `engine/autoload/game_state.py:145 accord` |
...
| `lateral` | `systems/factions/sim/faction_action.py` | Reads `ADJACENCY` for conquest-target and threat-signal derivation | `systems/factions/sim/faction_action.py:42`, `systems/factions/sim/faction_action.py:133`, `systems/factions/sim/faction_action.py:182` |

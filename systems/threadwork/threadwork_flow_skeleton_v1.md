...
| `scene.thread_operation`, `meta.thread_woven` (declared Key types) | `key` | **none — declared in contract, never constructed anywhere in the tree** | `references/module_contracts.yaml:376-377`; see §7 |
...
| `Thread Fatigue` (contract-declared clock) | — (unimplemented) | none — declared in contract only, no owning module | `references/module_contracts.yaml:380`; see §7 |

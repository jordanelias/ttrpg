...
| SIM-X-26 | Personal Combat, Momentum, Wound penalty, weapon TN differential | TTRPG | PRES | Health, Wounds, Stamina, Momentum | None | Davan Rekk, Solmund Vael | Aggressive over-committer vs Momentum hoarder | COMPLETE | F-26-01 to F-26-05; GAP-SIM-X26-01/02 |
| SIM-X-27 | Domain Actions, faction stats, PC social intervention, TC threshold, cascade check | Hybrid | PRES | RS, TC, IP, Faction stats | Crown, Church, Varfell, Guilds | Baralta, Torben, Vael, Mira Sondhal | Risk-averse faction players, PC misread | COMPLETE | F-27-01 to F-27-05; GAP-SIM-X27-01/02 |
| SIM-X-28 | BG faction stats, BG action economy, coalition pact, accounting cascade | BG | PRES | All faction stats, TC, RS, Standing | Crown, Church, Hafenmark, Varfell, Guilds | None | Local-optima bias, coalition-ignorant | COMPLETE | F-28-01 to F-28-08; GAP-SIM-X28-01/02 |

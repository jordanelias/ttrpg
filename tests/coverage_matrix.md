...
| BAL-BG-01 | Victory conditions (all 6 factions), Intel advancement, Mandate recovery, Guild Favour, win probability parity | BG | PRES | TC, RS, IP, PI, faction stats, Intel tracks, Mandate, Guild Favour | Crown, Church, Hafenmark, Varfell, Guilds, Niflhel | Generic faction archetypes | Military, Religious, Economic, Intelligence, Criminal, Constitutional | COMPLETE | Church Deed4 P1->PP-171; Crown Deed4 P1->PP-172; Intel advancement P2->PP-173; Mandate recovery P2->PP-174; Guild Favour P2->PP-175; Varfell Deed1 P2->PP-176. Post-patch all factions MEDIUM win index. |
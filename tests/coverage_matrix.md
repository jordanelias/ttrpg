...
| SIM-ARC-04 | Certainty track (PP-289), Composure/Rattled (PP-266), Community Weaving (PP-296), Discipline asymmetry (PP-297), Binding Ops (PP-293), Diverge (PP-271), Contest forced resolution (PP-282) | TTRPG primary; ARC 19 Hybrid-applicable | Multi-season + single-scene + single-battle | Certainty, Composure, RS, Discipline, Conviction Track, Diverge counter | Crown, Church, Hafenmark, Löwenritter | Himlensendt, Parliamentary Moderator, Löwenritter commander | NG-M–NG-R structural misreader archetypes | Complete | F-ARC4-01–F-ARC4-20; 1 systemic finding |
| SIM-X-33 | Personal Combat, Ranged (HP crossbow), melee close, weapon switch | TTRPG | PRES | Health, Wounds, Stamina | None | Tora, Mund | Reload-rigid archer, optimal charger | COMPLETE | F-33-01 to F-33-05; GAP-SIM-X33-01/02; PP-304 |
| SIM-X-34 | Thread Partial Ob stacking, Memory re-citation exploit, Leap contact | TTRPG | PRES | RS, Composure, Ob stack | None | Rhen, Solt | Ob-stacking over-extender, re-citation exploiter | COMPLETE | F-34-01 to F-34-05; GAP-SIM-X34-01/02; PP-303 PP-304 |
| SIM-X-35 | BG Parliamentary Vote, card over-commitment, passive abstain | BG | PRES | Standing, Mandate, Wealth, Influence | Crown, Church, Hafenmark, Varfell, Guilds | None | Card over-committer, passive abstainer | COMPLETE | F-35-01 to F-35-05; GAP-SIM-X35-01 |
| SIM-X-36 | Domain Echo, misattribution, Domain Action wasted, social pool | Hybrid | PRES | Influence, Military, IP, RS | Crown, Varfell, Guilds | Almud, Torben, Vael | Misattributing leader, wasted Domain Action | COMPLETE | F-36-01 to F-36-05; GAP-SIM-X36-01/02 |

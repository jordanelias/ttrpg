...
## → CONTINUED IN `tests/coverage_matrix_archive_part2.md`

Split 2026-07-29 (ED-MB-0051) when this file crossed the 50,000-token compliance ceiling.
Sequential parts in reading order, per CLAUDE.md §4 — **not** an index/infill pair. Part 2 carries
everything from `2026-07-02 — mass_battle Stage D` onward. Nothing was condensed or dropped: the
split is positional only.

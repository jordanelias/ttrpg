# Coverage Matrix Archive — Pre-2026-04-20

Archived from `tests/coverage_matrix.md` per ED-786 archival sweep 2026-05-02.

This file contains historical sim batches and findings from 2026-04-17 to 2026-04-19 (inclusive). All findings recorded here have been triaged: resolved findings have ED references in the original active file's "Open Findings" table (now pruned to unresolved-only).

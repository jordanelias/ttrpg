# BAL-BG-02 — Balance Analysis
## Date: 2026-04-02
## Status: COMPLETE — 5 P1 findings, 3 P2 findings, 1 P3 finding

## Stale References Fixed (PP-202)
- Crown Deed 2: T1/T6 → T12 (Valorsplatz) + T9 (Arcansheld)
- Hafenmark Path C Deed 3: T6 → T5 (Gransol, duchy capital)
- Varfell Path B: T12 → T4 (Vargstad) in starting control block
- Starting Control block: updated to PP-199 assignments
...
## P3 Findings
BAL-03: Hafenmark Military 3 leaves no military deterrent. Correct by design (Parliamentary faction).

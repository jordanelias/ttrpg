# SIM-MB-06 v10 — Bottom-up shape advantages (remove top-down SHAPE_OFF_MOD)
# Session: 2026-05-12 | Iteration v9 -> v10
# [canonical: Jordan handoff — bottom-up granular, no top-down fudge]
#
...
# [canonical: v10 design — top-down per-shape flat dice modifiers REMOVED.
#  Shape advantages must emerge from geometric mechanisms below. Dict structure
#  retained for shape-detection logic; all return 0. Gap role keeps -99 sentinel
#  because the gap is structurally non-engageable (no cell there, not a balance choice).]
SHAPE_OFF_MOD = {
    "Line":        lambda role: 0,
    "Arrowhead":   lambda role: 0,
    "Horseshoe":   lambda role: 0,
    "GappedLine":  lambda role: -99 if role == "gap" else 0,

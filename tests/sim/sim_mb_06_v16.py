# SIM-MB-06 v16 — Continuous TroopCount + G-3 lethality recalibration
# Session: 2026-05-13 | Iteration v15 -> v16
...
def morale_check_phase(unit_a, unit_b, phase_idx):  # noqa: ARG001
    """G-2+G-3: phase-boundary morale check.
    Exhausted units take additional morale hits at phase boundary.
    Floor drops when exhausted + casualties reach MORALE_LOSS_PCT_THRESHOLD.

...
def discipline_check_phase(unit_a, unit_b, phase_idx):  # noqa: ARG001
    ...
    a_loss = (unit_a.hp_max - unit_a.hp) / unit_a.h_per_size if unit_a.h_per_size else 0  # RATIO-RESTORE
    b_loss = (unit_b.hp_max - unit_b.hp) / unit_b.h_per_size if unit_b.h_per_size else 0  # RATIO-RESTORE
...
class Unit:
    ...
    def __post_init__(self):
        ...
        self.hp_max = self.size_max * self.h_per_size  # RATIO-RESTORE: revert v19 BLOCK_SIZE inflation
    ...
    def recalc_size(self):
        ...
        self.effective_size = self.hp / self.h_per_size if self.h_per_size > 0 else 0.0  # RATIO-RESTORE

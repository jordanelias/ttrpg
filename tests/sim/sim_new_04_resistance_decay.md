...
| Pair | Conditions |
|------|-----------|
| Crown + Hafenmark | Crown TCV ≥ 12 AND Hafenmark TCV ≥ 9 AND PI ≥ 5 AND CI < 50 |
...
- Church: plays Assert (CI +2 → CI 38). Still < 50. CI condition holds.
...
**Crown + Hafenmark co-victory is the most achievable win condition for those two factions combined.** The conditions (TCV thresholds both factions can hit by S6–8, PI ≥ 5 which is the starting value, CI < 50 which holds for at least 11 seasons from start) create a low-difficulty joint win.
...
- Co-victory: TCV 12 (Crown already starts here) + TCV 9 (Hafenmark starts at 8, needs 1 more territory) + PI ≥ 5 + CI < 50.

**Finding P1 — Crown + Hafenmark co-victory is potentially achievable from Season 2.** Hafenmark starts at TCV 8 and needs TCV 9 — one additional territory (any TCV 1 territory via uncontested March). Crown starts at TCV 12. PI starts at 7. CI starts at 28 (< 50). All conditions potentially met by S2 if Hafenmark takes one territory. The only gate is the 2-season hold requirement.
...
**Church counter-play:** Church can disrupt co-victory by raising CI ≥ 50 before the 2-season hold completes. CI starts at 28. CI 50 requires 22 seasons at +1/season or 11 at +2/season (Assert). Church cannot rush CI 50 fast enough to stop an early co-victory. Assert raises CI by 1 per season (replaces passive). From CI 28 to 50 = 22 seasons minimum. Co-victory fires at S2–S3.

**Finding P2 — Church has no counter to early Crown/Hafenmark co-victory.** At CI 28, Church cannot reach CI 50 in time to block a S2–S3 co-victory. This is structurally unbalanced: Church's primary disruptive lever (CI threshold effects at 50+) is 20+ seasons away when co-victory is available from S2.

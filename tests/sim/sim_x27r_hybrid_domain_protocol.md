...
## 7-Dimension Tag:
## Mechanics: Domain Actions, Faction Stats, CI | Mode: Hybrid | Temporal: PRES
## Tracks: CI, Mandate, Intel, Public Instability | Factions: Crown, Church, Hafenmark
## NPCs: PC (generic) | Archetypes: RITUAL, FACTION-LOYAL, FACTION-OPPORTUNIST, BELIEF-FIXED

## Protocol Assignments
- Church: RITUAL (Phase 1: Mandate, Phase 2: Suppress Crown Intel, Phase 3: CI trigger)
- Crown: FACTION-OPPORTUNIST
- PC: BELIEF-FIXED ("will not act to increase Church power")

## Starting State: CI=0, Church M5 I6 W5 Mil4 Sta5, Crown M5 I5 W4 Mil4 Sta4
...
## Season 3
Church [RITUAL]: Phase 2 impossible (Ob 5, pool 6D, P<10%). Skip (PP-257 gate). Phase 3: CI trigger.
CI: 0 → 0+increment [GAP-SIM-X-27R-G02: CI per-action increment not in params]
Crown [FACTION-OPPORTUNIST]: Church committed to CI action — Mandate exposed. Opportunity: suppress Church M6. Ob6. Pool5D. P(≥6)<1%. UNVIABLE (PP-258 gate). Crown passes.
PC: Hafenmark trade. Success.

---
## Findings

F01 [OK]: RITUAL correctly models Church institutional delay of CI. Design confirmed.
...
- GAP-SIM-X-27R-G02: CI per-action increment value missing from params_factions (carried from SIM-X-27)

...
Status: Pass 2n authoring 2026-05-18
...
|---|---|---|---|---|
| P7-1 | `sim/provincial/units.py` | massbattle (late-bind for constants/utils) | `designs/provincial/mass_battle_v30.md §A.3–A.4`; `designs/scene/derived_stats_v30.md` (TroopCount / block_size); v22 dataclass surface | pending |
...
| P7-3 | `sim/provincial/massbattle.py` | `units`, `tactic_cards`; `params/mass_combat.md`; `params/core.md` | `designs/provincial/mass_battle_v30.md` (full); `designs/provincial/military_layer_v30.md`; `designs/provincial/mass_battle_integration_v30.md`; v22 source | pending |
| P7-4 | `sim/provincial/faction_action.py` | `massbattle.resolve_mass_battle`; `sim/territory/adjacency`; `sim/autoload/game_state` | `mass_battle_integration_v30.md §4.10 step 3` (faction_action invokes resolve_mass_battle for Military Conquest, HR-8 / §B GD-1) | pending — rewires `_try_conquest` from single-roll to engine call |

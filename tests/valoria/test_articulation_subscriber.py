...
every §3.1 trigger type_id (.designs/systems/articulation/reference/articulation_layer_v30.md §3.1: the original
...
REGISTRY_PATH = ".designs/systems/_architecture/reference/key_type_registry_v30.md"
ARTICULATION_DOC_PATH = ".designs/systems/articulation/reference/articulation_layer_v30.md"

...
def test_m5_bind_sigma_pin_dagger_staerke_vs_poleaxe():
    ...
    assert base.hex() == '-0x1.3597d503dc6dcp+1', (
...
# ⚠ THE BIND COLUMN WAS RE-RECORDED 2026-07-29 for channel 5 (ED-PC-0052), which adds the
# displacement-resistance term `BIND_MOMENT_K*contact_moment_edge(...)` to bind_sigma. That is an
# INTENDED change to one of the two functions these pins watch, so the pins fired exactly as designed
# and were re-recorded rather than relaxed. The REACH columns are untouched (the term does not enter
...
DEFAULT_SIGMA_PINS = {
    ...
    'bear_spear': ('0x1.c57592d86e353p-1', '-0x1.59b96d610dd65p+0', '-0x1.be188d22646f7p-2'),
    'bec_de_corbin': ('0x1.44df288d12855p+0', '-0x1.29dfcf54afb93p-1', '-0x1.805a97e924cdfp-3'),
    'changdao': ('0x1.853bd41fdf176p-1', '-0x1.b47e70c681213p-1', '-0x1.199be5a95b915p-2'),
    'cinquedea': ('-0x1.61abbf9f0679bp-1', '0x1.14707fc4dc3d9p-1', '0x1.64b2314013ec6p-3'),
    'dagger': ('-0x1.cb41dcbc3df37p-1', '0x1.fdede474893f3p-2', '0x1.48fc9363f5732p-3'),
    'dangpa': ('0x1.150031d109436p+0', '-0x1.84fbfbfeb0760p+0', '-0x1.f5ea4d69a9e2ap-2'),
    'estoc': ('0x1.ee1d5929a618ep-1', '-0x1.74e2fed14d832p-1', '-0x1.e124e5b33ab9cp-3'),
    'estoc_halfsword': ('0x1.df7dac8bdb3b5p+0', '-0x1.0a7154e2a0951p-2', '-0x1.57cc0a6ebeafdp-4'),
    'falchion': ('0x1.0466afede8597p-3', '-0x1.0996ef7a89a46p-3', '-0x1.56b23d43463f8p-5'),
    'fauchard': ('0x1.acb2f40c58a61p-1', '-0x1.6b21ff323c758p+0', '-0x1.d48ef6b46f0b4p-2'),
    'flamberge': ('0x1.dc904b88355f1p-1', '-0x1.7a4fbcba30c1ep-1', '-0x1.e824d27ca2027p-3'),
    'glaive': ('0x1.140b6c23cee63p+0', '-0x1.ce6521088d93fp-1', '-0x1.2a51c2bb320cep-2'),
    'goedendag': ('0x1.163074d4d7d47p-1', '-0x1.c0c080f22c7a8p-2', '-0x1.2184743924f43p-3'),
    'greatsword': ('0x1.7058d5a65381cp-1', '-0x1.8c7d7c5794664p-1', '-0x1.ff99a8b312105p-3'),
    'guandao': ('0x1.26fbe7503c98ap+0', '-0x1.9dd8820cb51a1p+0', '-0x1.0aff4ba51a005p-1'),
    'guisarme': ('0x1.31ce1aee721b0p-1', '-0x1.b2dd39eafcf56p-1', '-0x1.188eba02f5c7ap-2'),
    'hook_sword': ('0x1.dc604c29fd9e8p-5', '0x1.91a4e5fdf63acp-2', '0x1.03201040bfe3ep-3'),
    'ji': ('0x1.70378e73b5fd8p-1', '-0x1.0df55076a96c4p+0', '-0x1.5c554f0cb9940p-2'),
    'jian': ('-0x1.7d93d44fece7ep-5', '0x1.087732668496cp-6', '0x1.553ef6b5d45f8p-8'),
    'kama_yari': ('0x1.caace28a61fc4p-1', '-0x1.3626ec94428bbp+0', '-0x1.903239857f27ep-2'),
    'katana': ('0x1.4f38828a757dcp-2', '-0x1.bfdf7874a8974p-4', '-0x1.20f345748dccfp-5'),
    'longsword': ('0x1.67364b38a0a99p-2', '-0x1.28b0dbaa8b2e3p-2', '-0x1.7ed3b015dce0dp-4'),
    'longsword_halfsword': ('0x1.fca62f5f98788p-1', '-0x1.05223e435ca10p-4', '-0x1.50f260db0c2a9p-6'),
    'lucerne_hammer': ('0x1.f22d7835b2137p-1', '-0x1.29d093a06d32ap-1', '-0x1.8046f008cef70p-3'),
    'mace': ('0x1.e1b54811f83a7p-3', '0x1.2493fe4f25d8ap-3', '0x1.7985271bcdbccp-5'),
    'main_gauche': ('-0x1.f17af1b0e43c4p-3', '0x1.016fff6c5c49ep-1', '0x1.4c2d6a9c560ccp-3'),
    'misericorde': ('-0x1.5bdf0a4eae5d7p-1', '0x1.9ac1318e1785ap-2', '0x1.0900c521dda09p-3'),
    'naginata': ('0x1.ccdd83088dc00p-1', '-0x1.c12cd0c37c6bcp-1', '-0x1.21ca552348037p-2'),
    ...
    'ranseur': ('0x1.01eef2cd49cbcp+0', '-0x1.65263647a923ap+0', '-0x1.ccd6779645995p-2'),
    'rapier': ('0x1.9344379ffe905p-6', '-0x1.8a9db303cdeaep-2', '-0x1.fd2e946801712p-4'),
    'rondel': ('-0x1.4f2baa785622bp-1', '0x1.dcdefe27b8abdp-2', '0x1.33a8a3f8982cdp-3'),
    'sabre': ('0x1.a1c4e8ada7f1ep-6', '-0x1.087732668498dp-4', '-0x1.553ef6b5d4622p-6'),
    'scimitar': ('0x1.a1768276fd6a7p-4', '-0x1.fe78c39057085p-4', '-0x1.49562b96edd3dp-5'),
    'shamshir': ('0x1.ce9cd3ac11250p-6', '-0x1.66fc6d1240e43p-5', '-0x1.cf3531e601267p-7'),
    'sparr_axe': ('0x1.3fdc61eb214b0p-1', '-0x1.741cee225cf71p-1', '-0x1.e025544d5f2e5p-3'),
    'spear': ('0x1.5fa49afb573f7p-1', '-0x1.34e2cd3f387a0p+0', '-0x1.8e900093a3b64p-2'),
    'spetum': ('0x1.177bea2a286e2p+0', '-0x1.5be57249405f2p+0', '-0x1.c0e5fed221830p-2'),
    'staff': ('0x1.cf06f69446739p-2', '-0x1.1545bccda63b9p-1', '-0x1.65c556b6c5fa4p-3'),
    'stiletto': ('-0x1.8e8054ab09786p-1', '0x1.bbd017dae8188p-2', '0x1.1e54b48d3ae68p-3'),
    'szabla': ('-0x1.cad5e639ccda0p-8', '-0x1.7a80de61caa06p-3', '-0x1.e86437b7fd320p-5'),
    'tachi': ('0x1.8aee79f7264cap-2', '-0x1.c529820005130p-3', '-0x1.245cd80003461p-4'),
    'tsurugi': ('-0x1.1f8b34bd427ebp-3', '0x1.17db4f4847006p-5', '0x1.691afaf1e8008p-7'),
    'voulge': ('0x1.7ee49425a8f10p-1', '-0x1.54d84f58750f9p+0', '-0x1.b7ccc97a657f7p-2'),
    'yari': ('0x1.2eedd0144bb33p-1', '-0x1.675e129591f6bp+0', '-0x1.cfb330c0fe67ap-2'),
}

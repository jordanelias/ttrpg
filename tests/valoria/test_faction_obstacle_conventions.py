...
def test_parliamentary_transfer_still_uses_the_full_score():
    ...
    overwrites `.designs/systems/factions/reference/parliamentary_transfer_v30.md:30`, which states the number in its
    ...
    doc = os.path.join(ROOT, '.designs', 'systems', 'factions', 'reference', 'parliamentary_transfer_v30.md')

...
def test_the_2026_07_30_walkback_actually_moved_something():
    ...
    """
    nf = _next_free()
    # PIN UPDATED 2026-08-06: SC 17 -> 23 -> 25 -> 26, across three allocations in one session.
    ...
    # consolidation programme (proposals/social_contest_consolidation_integration_v1.md); ED-SC-0025 from
    # the docs-4/5 adjudication. All nine entries exist in registers/editorial_ledger_sc.jsonl. This is
    # the update-the-pin-and-say-so path the assertion message below prescribes, not a revert of the
    # walk-back: the frozen pre-walk-back SC pointer was 21, so 26 cannot be reached by reverting
    # ED-IN-0098.
    released = {'SC': 26, 'FA': 37, 'WR': 10, 'SE': 50}
    checked = 0

...
SURFACES = (
    ".designs/systems/_architecture/reference/derived_stats_v30.md",
    ".designs/systems/fieldwork/reference/knots_v30.md",
    ".designs/systems/fieldwork/reference/fieldwork_editorial.md",
)
...
def test_bonds_count_cap_preserved():
    ...
    for rel in (".designs/systems/fieldwork/reference/knots_v30.md", ".designs/systems/fieldwork/reference/fieldwork_editorial.md"):
        body = open(os.path.join(REPO, rel), encoding="utf-8").read()

...
YAML; `.designs/systems/_architecture/reference/key_type_registry_v30.md` is 1,295 lines of prose-flavoured registry;
...
REGISTRY = os.path.join(ROOT, '.designs', 'systems', '_architecture', 'reference', 'key_type_registry_v30.md')
...
BANNER = ('> **GENERATED** by `tools/build_contract_index.py`. Do not hand-edit — every fact below '
          ...
          '> Fix a fact at its source: keys in `.designs/systems/_architecture/reference/key_type_registry_v30.md`, '
...
def render_keys(graph, contracts) -> str:
    ...
    L += ['**Sources joined:** `references/key_graph.json` (generated) ← '
          '`.designs/systems/_architecture/reference/key_type_registry_v30.md` + `references/module_contracts.yaml`. '

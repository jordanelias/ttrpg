...
currently authored TWICE, independently, and the two views disagree:
  ...
  * `.designs/systems/_architecture/reference/key_type_registry_v30.md` — 55 key types, each with a payload schema
...
def build():
    ...
    return {
        '_generated': ('GENERATED by tools/build_key_graph.py from '
                       '.designs/systems/_architecture/reference/key_type_registry_v30.md + '

...
# (`import yaml` removed 2026-08-12, ED-IN-0165: zero `yaml.` references remained after
# the load moved to ci_common.load_yaml, and ci_common imports PyYAML lazily precisely so
# stdlib-only blocking gates like this one do not acquire it. Leaving it defeated the
# rationale at the exact site that motivated it.)

...
def build_actions():
    ...
    subsystems = [
        ...
        S("Mass battle", "yes", "systems/mass_battle/mass_battle_v30.md",
          [("Tactics", "Envelopment · Feigned Retreat · Ambush · Concentration · Refused Flank · Hammer & Anvil", "systems/mass_battle/mass_battle_v30.md §A.8"),
           ("General's turn action", "Rally · Reinforce Discipline · Support Threadweave · Personal combat · Stabilise general", "systems/mass_battle/mass_battle_v30.md §A.7"),
           ("Formations", "Line · Shield Wall · Wedge · Skirmish · Column · Feigned Retreat · Reserve", "systems/mass_battle/mass_battle_v30.md §A.6")]),
        S("Faction / domain actions", "yes (across 3 layers)", "engine/params/factions/stats_1_7_scale.md",
          [("Domain Actions", "Assert · Reconstitute · Govern · Claim Masterless · Suppress · Parliamentary Rebuttal · Treaty · Accounting Stability Check", "engine/params/factions/stats_1_7_scale.md"),
           ...
           ("Parliamentary motions", "Censure · Embargo · Blockade · Outlawry · Subsidy · War Authorisation · Treaty Ratification · Recognition Challenge · Succession Endorsement", "systems/factions/faction_layer_v30.md §5.4")],
          caveat="The live sim (systems/factions/sim/faction_action.py) dispatches unique → Conquest → Muster → Govern each season; some code verbs (Crown Royal Progress/Great Work) are PROVISIONAL and differ from the ratified Royal Decree."),

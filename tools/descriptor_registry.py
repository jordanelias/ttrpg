...
Live replacement (2026-07-08, OPT-AV-7) for the module of the same name formerly imported from the
retired deprecated/skills/valoria-orchestrator/scripts/ -- that import path is dead; this copy has
no dependency on deprecated/.
"""
import os
import yaml

_PATHS = ('references/descriptor_registry.yaml',)

...
`.designs/systems/_architecture/reference/key_type_registry_v30.md` WAS a **registry parsed at runtime** — until this
...
def build() -> dict:
    ...
    return {
        "_generated": (
            ...
            ".designs/systems/_architecture/reference/key_type_registry_v30.md via engine.substrate.keys.TypeRegistry. "

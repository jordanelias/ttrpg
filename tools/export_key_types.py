...
`systems/_architecture/reference/key_type_registry_v30.md` WAS a **registry parsed at runtime** — until this
...
SOURCE = os.path.join('systems', '_architecture', 'reference', 'key_type_registry_v30.md')
...
def build() -> dict:
    ...
    return {
        "_generated": (
            ...
            "systems/_architecture/reference/key_type_registry_v30.md via engine.substrate.keys.TypeRegistry. "

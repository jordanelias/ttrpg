...
**255 open items** across 467 files · P1 78 · P2 27 · P3 150 · 25 already settled (supersessions).
...
| **WR** — World | 0 | 0 | 12 | 12 |
| **IN** — Infrastructure / cross-cutting | 5 | 1 | 14 | 20 |
| **GO** — Godot | 9 | 2 | 10 | 21 |
...
## P1 — decide first (the real rulings you owe)  (78)
...
- | `systems/ui/_identifier_census.yaml` (generated, `tools/build_identifier_census.py`) reports 24 identifiers as `disposition: BUILT` against the UI docs' vocabulary, but every `built_in:` pointer for those rows resolves into **other** subsystems' code (e.g. `systems/combat/combat_engine_v1/combatant.py`, `systems/s…  
...
- | [`campaign_architecture`](CONTRACT_INDEX.md#campaign_architecture) | RECLASSIFIED 2026-06-10: doc is the 2026-04-17 victory-revision CONSOLIDATION (Church infra, RM identity, MS/Coherence reform, Thread revelation, IP escalation, Warden, Portrait/Lineage) — a cross-cutting design doc, not a runtime module; its con…  
  ↳ `references/CONTRACT_INDEX.md:87`
- W-GAP [faction_state]: registry system name faction_layer vs module faction_state — vocabulary unification [OPEN — Jordan]  
  ↳ `references/CONTRACT_INDEX.md:96`
- W-GAP [piety_track]: NAME COLLISION (3-way) [OPEN — Jordan]: substrate §8.4 "Piety Track" (this personal scar system, registry system conviction_track, home systems/characters/conviction_track_v1.md) vs systems/characters/conviction_track_v30.md which is the TERRITORIAL "Piety Track & Church Victory Redesign" (PP-40…  
  ↳ `references/CONTRACT_INDEX.md:104`
- W-GAP [territorial_piety]: name collision with personal piety_track — see piety_track gap_note [OPEN — Jordan]  
  ↳ `references/CONTRACT_INDEX.md:106`
...
- W-GAP [settlement_economy]: registry-derived; relationship to settlement_layer §1.3 Local Economy derived value unestablished — possibly the same system [OPEN — Jordan]; home doc [GAP]  
  ↳ `references/CONTRACT_INDEX.md:122`
- W-GAP [faction_politics]: registry-derived; distinct system from faction_layer per registry vocabulary (emits succession/coup/standing/investigation) — boundary vs faction_state unestablished [OPEN — Jordan]; home doc [GAP]  
  ↳ `references/CONTRACT_INDEX.md:135`
- W-GAP [miraculous_event]: registry-derived; system-vs-event-source classification [OPEN — Jordan] (godot_conversion_strategy_v1.md register item #23, unresolved). Home doc RESOLVED (verification P6): systems/world/miraculous_event_v30.md, ## Status: CANONICAL — the prior 'home doc [GAP]' clause was stale and contrad…  
  ↳ `references/CONTRACT_INDEX.md:138`
- _…and more in this category — see `decisions.json`._
...
## P3 — cleanup backlog (150)  — summarized

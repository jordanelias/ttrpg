...
**226 open items** across 447 files · P1 64 · P2 23 · P3 139 · 25 already settled (supersessions).
...
| **WR** — World | 0 | 0 | 8 | 8 |
| **IN** — Infrastructure / cross-cutting | 2 | 1 | 14 | 17 |
| **GO** — Godot | 9 | 2 | 10 | 21 |
| **SE** — Settlements | 0 | 0 | 3 | 3 |
| _unassigned_ (`lane: null`) | 44 | 20 | 69 | 133 |

## By category

- **Documented gaps** — 64
- **Flagged assumptions** — 62
- **Naming & collisions** — 31
- **Open rulings** — 31
- **Ratifications** — 13
- **Mechanical wiring** — 12
- **TODO / FIXME** — 9
- **Stubs** — 4
...
- "registry-derived; relationship to settlement_layer §1.3 Local Economy derived value unestablished — possibly the same system [OPEN — Jordan]; home doc [GAP]"  
  ↳ `references/module_contracts.yaml:786`
- "registry-derived; distinct system from faction_layer per registry vocabulary (emits succession/coup/standing/investigation) — boundary vs faction_state unestablished [OPEN — Jordan]; home doc [GAP]"  
  ↳ `references/module_contracts.yaml:914`
- _…and more in this category — see `decisions.json`._

---

## P2 — decide soon (structural & naming)  (23)
...
## P3 — cleanup backlog (139)  — summarized

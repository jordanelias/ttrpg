...
**983 open items** across 1375 files · P1 325 · P2 36 · P3 622 · 25 already settled (supersessions).
...
| _unassigned_ (`lane: null`) | 282 | 32 | 389 | 703 |
...
- HRE-5 · Guild Uprising (Compact-vs-Suppression) · `ED-SE-0033`** — Final REFINE (confirmed). N clean (crisis-triggered constitutional rupture, distinct register from Ordenanza's routine paperwork); Omega-d holds; Concord's seat+veto is genuinely new (not a restatement of Ratify's Influence-tick). Two source-confirme…  
  ↳ `designs/audit/2026-07-11-comparative-governance-pessimist-ners-audit/pessimist_ners_audit_v1.md:140`
...
- Status:** **RATIFICATION CANDIDATE — validated, NERS-compliant, STAGED (not committed).** Jordan-vetoable.  
  ↳ `designs/audit/2026-06-29-combat-corpus-recovery/unified_damage_model_NERS_and_ratification_candidate_2026-05-31.md:7`
- Two tiers of fix, by layer.** (A) Correct the analysis to its own engine — pure factual repair. (B) Extend the engine's tradition axes along the three missing efficacy-bearing dimensions — **mechanical-tier**, built bottom-up on the engine's existing lever/channel machinery, validated top-down against documented mar…  
  ↳ `designs/audit/2026-06-29-combat-corpus-recovery/combat_traditions_morphology_critique.md:19`
- grapple is not the gap I flagged last turn — it is a built module awaiting ratification.  
  ↳ `designs/audit/2026-06-29-combat-corpus-recovery/reconciliation_session_calibration_vs_ratified_armature_2026-06-01.md:48`
- _…and more in this category — see `decisions.json`._
...
## P3 — cleanup backlog (622)  — summarized
